...
- assets/images/salinas-1.jpg — salón comedor, letras "HESTÍA VERA" en la pared dorada; apertura de marca.
- assets/images/salinas-13.jpg — terraza chill-out, vistas a la urbanización.
- assets/images/salinas-27.jpg — terraza principal, nubes encendidas al atardecer; clímax dorado.
- assets/images/salinas-31.jpg — piscina comunitaria con palmeras.
- assets/images/salinas-19.jpg — terraza pérgola, desayuno sin reloj.
- assets/images/salinas-32.jpg — piscina comunitaria, rosa de atardecer en el agua; cierre de marca.
- assets/images/salinas-20.jpg, salinas-25.jpg, salinas-2.jpg — reserva, sin usar en esta versión.
- assets/images/salinas-23.jpg — descartada: artefactos visibles de una edición anterior en las paredes.
- assets/audio/salinas-walkthrough-music.m4a — pista de música del vídeo de recorrido oficial (81 s, -6,9 dB medio); sin usar (el reel sigue sin música: la pone Instagram).
...
- Gradación de color (`hyperframes media-treatment`, preset warm-daylight a intensidad 0.5) + viñeta y grano finos en los seis planos: da profundidad cinematográfica sin perder el color real de la urbanización.
- Cámara con intención en cada plano: empuje o retirada de escala real (no solo paneo), más marcado en el plano del detalle de las Salinas de Puerto Rey (clímax visual).
...
- Hechos permitidos: solo los de strategy/redes/hechos-y-ventajas.md y la ficha real de docs/salinas.html. Nada de precios ni disponibilidad.
...
- Segunda ronda de Alex: la carta no decía nada y "te lo enseñamos en persona" no es cierto. Texto reescrito solo con la ficha de Salinas de la web. La H del logo es la real (logo-teal-transparent.png) recoloreada a albero, en la cabecera y en el cierre.
...
- Tercera ronda de Alex: "mucho más refinado, efecto wow, profesional y premium". La carta ahora presenta la marca ("somos Alex y Fran, esto es Hestía") y da el detalle propio de Salinas verificado en docs/salinas.html (Parque Natural de las Salinas de Puerto Rey, flamencos, amaneceres dorados), no solo ambiente. Duración 24s → 30s por el contenido más denso; cada corte de foto coincide con el arranque de una frase nueva.
