...
const Compare = ({ lang }) => {
  const rows = lang === 'es' ? [
    ...
    { label: 'Extra ⭑',     vm: 'Jacuzzi temporada', vt: 'SPA aromaterapia', vs: 'Parque Natural Salinas' },
    ...
    { label: 'Extra ⭑',     vm: 'Seasonal jacuzzi', vt: 'SPA aromatherapy', vs: 'Salt-flat nature park' },
