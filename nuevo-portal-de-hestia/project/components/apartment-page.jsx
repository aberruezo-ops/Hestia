...
const APT_DATA = {
  ...
  vt: {
    ...
    es: {
      ...
      desc: 'Hestía Thalassa es el apartamento ático, donde el naranja del Desierto de Tabernas entra por la terraza panorámica de 360°. Una experiencia sensorial única: SPA con aromaterapia, amanecer sobre el mar, atardecer sobre el desierto.',
      desc2: 'El ático dispone de dos plantas de vida y una terraza envolvente con vistas simultáneas al Mediterráneo y al Parque Natural de Cabo de Gata. El SPA privado con aromaterapia convierte cada tarde en un ritual.',
      features: ['6 plazas + bebé · 2 habitaciones', 'Terraza panorámica 360°', 'Ático — vistas al mar y al desierto', 'Piscina comunitaria + pistas de pádel', 'SPA privado: aromaterapia', '1,5 km de la playa', 'Mascotas permitidas · aviso previo', 'Aire acondicionado frío/calor', 'Smart TV · WiFi fibra óptica', 'Cocina totalmente equipada', 'Ropa de cama y toallas incluidas'],
      gallery_captions: ['Terraza panorámica 360°', 'Salón duplex', 'SPA con aromaterapia', 'Dormitorio principal', 'Vistas al desierto de Tabernas', 'Atardecer desde el ático'],
    },
    en: {
      name: 'Hestía Thalassa',
      concept: 'Orange from the Tabernas desert.',
      desc: 'Hestía Thalassa is the penthouse apartment, where the orange of the Tabernas Desert enters through the 360° panoramic terrace. A unique sensory experience: SPA with aromatherapy, sunrise over the sea, sunset over the desert.',
      desc2: 'The penthouse spans two living floors and a wraparound terrace with simultaneous views of the Mediterranean and the Cabo de Gata Natural Park. The private SPA with aromatherapy turns every afternoon into a ritual.',
      features: ['6 guests + baby · 2 bedrooms', '360° panoramic terrace', 'Penthouse — sea & desert views', 'Shared pool + padel courts', 'Private SPA: aromatherapy', '1.5 km from the beach', 'A/C heating & cooling', 'Smart TV · Fibre WiFi', 'Fully equipped kitchen', 'Bed linen & towels included'],
      gallery_captions: ['360° panoramic terrace', 'Duplex living room', 'SPA with aromatherapy', 'Master bedroom', 'Tabernas desert views', 'Sunset from the penthouse'],
    },
  },
  vs: {
