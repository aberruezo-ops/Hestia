  ...
  nosotros: {
    es: [
      { q: '¿Desde cuándo lo hacéis vosotros mismos?',
        a: <>Desde 2016. En diez años hemos recibido a más de 600 familias. Nunca hemos externalizado la gestión: seguimos limpiando, respondiendo y eligiendo las toallas nosotros. <a href="nosotros.html">Conoce nuestra historia.</a></> },
      ...
      { q: '¿Qué pasa si algo falla durante mi estancia?',
        a: <>Fran se encarga de tu estancia: está aquí mientras estás aquí. Responde rápido, va en persona y resuelve sin esperar a que abra ninguna oficina. Su número: <a href="https://wa.me/34654138251" target="_blank" rel="noopener">WhatsApp Fran</a>.</> },
    ],
    en: [
  ...
  opiniones: {
    es: [
      ...
      { q: '¿Qué es lo que más valoran los huéspedes?',
        a: <>La atención personal de Alex y Fran, la limpieza y el estado de cada Hestía, y la ubicación. Y que cuando algo falla, se resuelve de verdad — no se pone una excusa.</> },
  ...
  const handleDayClick = (ds) => {
    ...
    if (nights < effMin) {
      ...
      setDrMsg({
        type: 'error',
        es: isCrit
          ? `Temporada crítica: estancia mínima ${effMin} noches. Excepción: si rellenas exactamente un hueco entre dos reservas o si el check-in es esta semana (≤${imminentD} días), bastarían 2 noches.`
          : `Estancia mínima ${effMin} noches. Selecciona una fecha de salida más adelante.`,
        en: isCrit
          ? `Critical season: minimum stay ${effMin} nights. Exception: if you exactly fill a gap between two bookings or check-in is this week (≤${imminentD} days), 2 nights would suffice.`
