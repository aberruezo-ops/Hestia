...
const T = {
  es: {
    ...
    numSoporte: 'Número de soporte',
    soporteHelp: '¿Dónde está?',
  ...
  en: {
    ...
    numSoporte: 'Support number',
    soporteHelp: 'Where is it?',
...
const TravelerCard = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "reg-card-hdr"
  }, /*#__PURE__*/React.createElement("h3", null, /*#__PURE__*/React.createElement(HiIcon, {
    name: "key",
    size: 16,
    className: "reg-card-ic"
  }), " ", isTitular ? t.titular : `${t.traveler} ${idx + 1}`), !isTitular && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "reg-remove",
    onClick: () => onRemove(idx)
  }, t.remove)), /*#__PURE__*/React.createElement("div", {
    className: "reg-grid"
  }, field('nombre', t.nombre, {
    req: true,
    autoComplete: 'given-name',
    autoCapitalize: 'words'
  }), field('apellido1', t.apellido1, {
    req: true,
    ...
    value: "H"
  }, t.hombre), /*#__PURE__*/React.createElement("option", {
    value: "M"
  }, t.mujer)), err('sexo') && /*#__PURE__*/React.createElement("span", {
    className: "reg-err-msg"
    ...
    key: d.code,
    value: d.code
  }, lang === 'es' ? d.es : d.en)))), field('numDoc', t.numDoc, {
    req: true,
    upper: true,
    ...
    className: "reg-help-box"
  }, t.soporteExpl), err('numSoporte') && /*#__PURE__*/React.createElement("span", {
    className: "reg-err-msg"
    ...
    key: c.code,
    value: c.code
  }, lang === 'es' ? c.es : c.en)), /*#__PURE__*/React.createElement("option", {
    value: "OTRO"
  }, lang === 'es' ? 'Otro' : 'Other'))), field('fechaNacimiento', t.nacimiento, {
    req: true,
    type: 'date',
    max: todayIso,
    autoComplete: 'bday',
  ...
  }), err('parentesco') && /*#__PURE__*/React.createElement("span", {
    className: "reg-err-msg"
  }, err('parentesco')))), /*#__PURE__*/React.createElement("div", {
    className: "reg-sub"
  }, lang === 'es' ? 'Residencia y contacto' : 'Residence & contact', !isTitular && /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    value: "OTRO"
  }, lang === 'es' ? 'Otro' : 'Other'))), field('direccion', t.direccion, {
    req: true,
    wide: true,
    autoComplete: 'street-address'
  }), field('municipio', t.municipio, {
    req: true,
    autoComplete: 'address-level2',
    autoCapitalize: 'words'
  }), field('cp', t.cp, {
    req: true,
    inputMode: tr.pais === 'ESP' ? 'numeric' : 'text',
    autoComplete: 'postal-code'
  }), field('telefono', t.telefono, {
    req: isTitular,
    type: 'tel',
    inputMode: 'tel',
    autoComplete: 'tel'
...
const RegistroPage = () => {
  const [lang, setLang] = React.useState(() => {
    try {
      return localStorage.getItem('hestia-lang') || 'es';
    } catch (_) {
      return 'es';
    }
  });
  ...
  React.useEffect(() => {
    ...
    if (r && r.length >= 16 && !TRAVELER_WORKER_URL.includes('SUSTITUIR')) {
      fetch(`${TRAVELER_WORKER_URL}/prefill?token=${encodeURIComponent(r)}`).then(res => res.ok ? res.json() : null).then(j => {
        if (j && j.prefill) applyPf(j.prefill);
      }).catch(() => {});
    }
  }, []);
  ...
  return /*#__PURE__*/React.createElement("main", {
    ...
    size: 16
  })), phase === 'ok' ? /*#__PURE__*/React.createElement("div", {
    className: "reg-done"
  }, /*#__PURE__*/React.createElement(HiIcon, {
    name: "check",
    size: 54,
    className: "reg-done-ic"
  }), /*#__PURE__*/React.createElement("h1", null, t.okTitle), /*#__PURE__*/React.createElement("p", null, t.okBody)) : !token ? /*#__PURE__*/React.createElement("div", {
    className: "reg-done"
  }, /*#__PURE__*/React.createElement(HiIcon, {
    name: "alert",
    size: 48,
    className: "reg-done-ic"
  }), /*#__PURE__*/React.createElement("p", null, t.noToken), /*#__PURE__*/React.createElement("a", {
    className: "btn btn-primary",
    href: "https://wa.me/34620316370",
    target: "_blank",
    rel: "noopener"
  }, "WhatsApp")) : /*#__PURE__*/React.createElement("form", {
    onSubmit: submit,
    noValidate: true
  }, /*#__PURE__*/React.createElement("span", {
    className: "reg-eyebrow"
  ...
  }, phase === 'sending' ? t.sending : t.submit, " ", phase !== 'sending' && /*#__PURE__*/React.createElement("span", {
    className: "arrow"
  }, "→")))));
};
ReactDOM.createRoot(document.getElementById('root')).render(/*#__PURE__*/React.createElement(RegistroPage, null));
