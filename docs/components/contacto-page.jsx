...
const CONTACTO_COPY = {
  es: {
    ...
    book_sub: '¿Quieres reservar un Hestía?',
    ...
    faqs: [
      ...
      { q: '¿Cómo hago una reserva?',
        a: (<>Rellena el formulario en nuestra <a href="reservas.html">página de reservas</a> o escríbenos directamente por WhatsApp con las fechas y el Hestía que te interesa.</>),
      },
      ...
      { q: '¿Quiénes sois Alex y Fran?',
        a: (<><a href="nosotros.html">Somos los propietarios de Hestía</a>, no una agencia. Gestionamos los tres Hestías en persona desde 2016.</>),
      },
    ],
  },
  en: {
