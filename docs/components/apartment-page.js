...
const APT_EQUIP = {
  vm: {
    ...
    en: {
      ...
      icons: [['🌊', 'Beach 300m away'], ['☀️', '20m² corner terrace'], ['🏊', 'Pool + Jacuzzi'], ['🌿', 'Gardens'], ['🛋', 'Chill-out'], ['🛗', 'Lift'], ['📺', '55" Smart TV'], ['🎬', 'Prime · HBO · Sky · Pluto'], ['📶', 'Fibre WIFI'], ['❄️', 'Ducted A/C'], ['🍳', 'Full premium kitchen'], ['🍽', 'Dishwasher'], ['🧺', 'Washer'], ['🛁', 'Bath + hydro-massage'], ['🚿', 'Shower'], ['🚗', 'Covered garage'], ['🩹', 'First-aid kit'], ['🎁', 'Welcome kit'], ['☂️', 'Beach umbrella'], ['👶', 'Cot · Highchair'], ['🛏', '200-thread combed cotton sheets · extra set for the sofa-bed'], ['🧴', 'Bath towels 600g/m²'], ['🌺', 'Down duvet'], ['🪔', 'Chromotherapy · aromas'], ['🧻', 'Drying rack']]
    }
  },
  vt: {
    area: 85,
