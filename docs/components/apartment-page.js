...
const APT_DATA = {
  vm: {
    ...
    video_upload: '2026-05-30T12:00:00+02:00',
    accent: '#6B7A3A',
    accent2: '#8B9A52',
    accent_dk: '#4A5628',
    ...
    gallery_imgs: ['assets/apt-vm-gallery-1.jpg', 'assets/apt-vm-gallery-2.jpg', 'assets/apt-vm-gallery-3.jpg', 'assets/apt-vm-gallery-21.jpg', 'assets/apt-vm-gallery-22.jpg', 'assets/apt-vm-gallery-5.jpg', 'assets/apt-vm-gallery-23.jpg', 'assets/apt-vm-gallery-24.jpg', 'assets/apt-vm-gallery-6.jpg', 'assets/apt-vm-gallery-7.jpg', 'assets/apt-vm-gallery-8.jpg', 'assets/apt-vm-gallery-26.jpg', 'assets/apt-vm-gallery-10.jpg', 'assets/apt-vm-gallery-25.jpg', 'assets/apt-vm-gallery-9.jpg', 'assets/apt-vm-gallery-11.jpg', 'assets/apt-vm-gallery-15.jpg', 'assets/apt-vm-gallery-29.jpg', 'assets/apt-vm-gallery-16.jpg', 'assets/apt-vm-gallery-17.jpg', 'assets/apt-vm-gallery-30.jpg', 'assets/apt-vm-gallery-13.jpg', 'assets/apt-vm-gallery-14.jpg', 'assets/apt-vm-gallery-28.jpg', 'assets/apt-vm-gallery-4.jpg', 'assets/apt-vm-gallery-27.jpg', 'assets/apt-vm-gallery-18.jpg', 'assets/apt-vm-gallery-19.jpg', 'assets/apt-vm-gallery-20.jpg'],
    es: {
      name: 'Hestía Mar',
  ...
  vt: {
    ...
    gallery_imgs: ['assets/apt-vt-gallery-08.jpg', 'assets/apt-vt-gallery-20.jpg', 'assets/apt-vt-gallery-34.jpg', 'assets/apt-vt-gallery-10.jpg', 'assets/apt-vt-gallery-05.jpg', 'assets/apt-vt-gallery-06.jpg', 'assets/apt-vt-gallery-19.jpg', 'assets/apt-vt-gallery-33.jpg', 'assets/apt-vt-gallery-24.jpg', 'assets/apt-vt-gallery-23.jpg', 'assets/apt-vt-gallery-35.jpg', 'assets/apt-vt-gallery-03.jpg', 'assets/apt-vt-gallery-21.jpg', 'assets/apt-vt-gallery-04.jpg', 'assets/apt-vt-gallery-12.jpg', 'assets/apt-vt-gallery-32.jpg', 'assets/apt-vt-gallery-07.jpg', 'assets/apt-vt-gallery-14.jpg', 'assets/apt-vt-gallery-16.jpg', 'assets/apt-vt-gallery-17.jpg', 'assets/apt-vt-gallery-11.jpg', 'assets/apt-vt-gallery-01.jpg', 'assets/apt-vt-gallery-09.jpg', 'assets/apt-vt-gallery-31.jpg', 'assets/apt-vt-gallery-30.jpg', 'assets/apt-vt-gallery-18.jpg', 'assets/apt-vt-gallery-25.jpg', 'assets/apt-vt-gallery-26.jpg', 'assets/apt-vt-gallery-27.jpg', 'assets/apt-vt-gallery-28.jpg', 'assets/apt-vt-gallery-29.jpg'],
    es: {
  ...
  vs: {
    ...
    // cocina
    'assets/apt-vs-gallery-16.jpg', 'assets/apt-vs-gallery-17.jpg', 'assets/apt-vs-gallery-18.jpg', 'assets/apt-vs-gallery-33.jpg',
    // dormitorio 1 · mural de olas (foto de referencia)
    'assets/apt-vs-gallery-21.jpg',
    // dormitorio 1
    'assets/apt-vs-gallery-23.jpg', 'assets/apt-vs-gallery-29.jpg',
    // dormitorio 2 · camas + espejos
    'assets/apt-vs-gallery-30.jpg',
    // dormitorio 2 · simétrico
    ...
    // segunda terraza
    'assets/apt-vs-gallery-28.jpg',
    // rincón lucecitas
    'assets/apt-vs-gallery-31.jpg',
    // piscina · día
...
const APT_EQUIP = {
  vm: {
    ...
    es: {
      ...
      icons: [['🌊', 'Playa a 300m'], ['☀️', 'Terraza 20m² · esquina'], ['🏊', 'Piscina + Jacuzzi'], ['🌿', 'Jardines'], ['🛋', 'Chill out'], ['🛗', 'Ascensor'], ['📺', 'Smart TV 55"'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Disney+'], ['📶', 'WIFI fibra'], ['❄️', 'A/C por conductos'], ['🍳', 'Cocina completa · alto standing'], ['🍽', 'Lavavajillas'], ['🧺', 'Lavadora'], ['🛁', 'Bañera + hidromasaje'], ['🚿', 'Ducha'], ['🚗', 'Garaje cubierto'], ['🩹', 'Botiquín'], ['🎁', 'Kit de bienvenida'], ['☂️', 'Sombrilla playa'], ['👶', 'Cuna · Trona'], ['🛏', 'Sábanas 200 hilos · algodón peinado · juego extra para el sofá-cama'], ['🧴', 'Toallas 600g/m²'], ['🌺', 'Nórdico de plumas'], ['🪔', 'Cromoterapia · aromas'], ['🧻', 'Tendedero']]
    },
    en: {
      terrace: '20m² corner terrace',
      icons: [['🌊', 'Beach 300m away'], ['☀️', '20m² corner terrace'], ['🏊', 'Pool + Jacuzzi'], ['🌿', 'Gardens'], ['🛋', 'Chill-out'], ['🛗', 'Lift'], ['📺', '55" Smart TV'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Disney+'], ['📶', 'Fibre WIFI'], ['❄️', 'Ducted A/C'], ['🍳', 'Full premium kitchen'], ['🍽', 'Dishwasher'], ['🧺', 'Washer'], ['🛁', 'Bath + hydro-massage'], ['🚿', 'Shower'], ['🚗', 'Covered garage'], ['🩹', 'First-aid kit'], ['🎁', 'Welcome kit'], ['☂️', 'Beach umbrella'], ['👶', 'Cot · Highchair'], ['🛏', '200-thread combed cotton sheets · extra set for the sofa-bed'], ['🧴', 'Bath towels 600g/m²'], ['🌺', 'Down duvet'], ['🪔', 'Chromotherapy · aromas'], ['🧻', 'Drying rack']]
    }
  },
  vt: {
    area: 85,
    ...
    es: {
      ...
      icons: [['🌊', 'Mar · Laguna · Pueblo'], ['☀️', 'Terraza delantera 18m² · vistas al mar'], ['🌅', 'Terraza trasera'], ['🏊', '3 Piscinas'], ['🌡', 'Piscina climatizada'], ['♨️', 'Jacuzzi'], ['💪', 'Gimnasio'], ['🧖', 'Sauna'], ['🎾', 'Pista de tenis'], ['🌿', 'Jardines · Columpios'], ['📺', 'Smart TV 55"'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Movistar Plus · Disney+'], ['📶', 'WIFI fibra'], ['❄️', 'A/C salón y dormitorios'], ['🍳', 'Cocina completa · alto standing'], ['🍽', 'Lavavajillas'], ['🧺', 'Lavadora · alta gama'], ['☕', 'Nespresso + cafetera goteo'], ['🛁', 'Dos baños · en suite'], ['🚿', 'Columnas de hidromasaje'], ['🚗', 'Garaje interior'], ['🩹', 'Botiquín'], ['🎁', 'Kit de bienvenida'], ['☂️', 'Sombrilla playa'], ['🛏', 'Sábanas 200 hilos · algodón peinado · juego extra para el sofá-cama'], ['🧴', 'Toallas 600g/m²'], ['🌺', 'Nórdicos de plumas'], ['🪔', 'Hidroterapia · aromas'], ['🧻', 'Tendedero']]
    },
    en: {
      terrace: '2 terraces · front 18m² + rear',
      icons: [['🌊', 'Sea · Lagoon · Village'], ['☀️', 'Front terrace 18m² · sea views'], ['🌅', 'Rear terrace'], ['🏊', '3 Swimming pools'], ['🌡', 'Heated pool (autumn–spring)'], ['♨️', 'Jacuzzi'], ['💪', 'Gym'], ['🧖', 'Sauna'], ['🎾', 'Tennis court'], ['🌿', 'Gardens · Swings'], ['📺', '55" Smart TV'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Movistar Plus · Disney+'], ['📶', 'Fibre WIFI'], ['❄️', 'A/C lounge & bedrooms'], ['🍳', 'Full premium kitchen'], ['🍽', 'Dishwasher'], ['🧺', 'Washing machine · premium'], ['☕', 'Nespresso + drip coffee maker'], ['🛁', 'Two en-suite bathrooms'], ['🚿', 'Hydro-massage columns'], ['🚗', 'Indoor garage'], ['🩹', 'First-aid kit'], ['🎁', 'Welcome kit'], ['☂️', 'Beach umbrella'], ['🛏', '200-thread combed cotton sheets · extra set for the sofa-bed'], ['🧴', 'Bath towels 600g/m²'], ['🌺', 'Down duvets'], ['🪔', 'Hydrotherapy · aromas'], ['🧻', 'Drying rack']]
    }
  },
  vs: {
    area: 80,
    ...
    es: {
      ...
      icons: [['🌊', 'Playa a 5 min en coche'], ['☀️', 'Terraza 18m² · sol y luna'], ['🌅', 'Terraza 14m² · atardecer'], ['🏊', 'Piscina'], ['🌿', 'Jardines · Riachuelos'], ['💪', 'Gimnasio'], ['🎾', 'Pista de tenis'], ['🛋', 'Chill out'], ['🏞', 'Salinas de Puerto Rey'], ['📺', 'Smart TV 55" · Ambilight'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Disney+'], ['📶', 'WIFI fibra'], ['❄️', 'A/C frío y calor'], ['🍳', 'Cocina completa · alto standing'], ['🍽', 'Lavavajillas'], ['🧺', 'Lavadora · alta gama'], ['☕', 'Nespresso + cafetera goteo'], ['🛁', 'Bañera + hidromasaje'], ['🚿', 'Cabina ducha + hidromasaje'], ['🚗', 'Garaje techado'], ['🩹', 'Botiquín'], ['🎁', 'Kit de bienvenida'], ['☂️', 'Sombrilla playa'], ['👶', 'Cuna · Trona'], ['🛏', 'Sábanas 200 hilos · algodón peinado · juego extra para el sofá-cama'], ['🧴', 'Toallas 600g/m²'], ['🌺', 'Nórdicos plumas + acrílicos (antialérgicos)'], ['🪔', 'Aromas'], ['🧻', 'Tendedero']]
    },
    en: {
      terrace: '2 terraces 18m² + 14m²',
      icons: [['🌊', 'Beach 5 min by car'], ['☀️', '18m² terrace · sun & moon'], ['🌅', '14m² terrace · sunsets'], ['🏊', 'Pool'], ['🌿', 'Gardens · Streams'], ['💪', 'Gym'], ['🎾', 'Tennis court'], ['🛋', 'Chill-out'], ['🏞', 'Puerto Rey Salt Flats'], ['📺', '55" Smart TV · Ambilight'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Disney+'], ['📶', 'Fibre WIFI'], ['❄️', 'A/C heat & cool'], ['🍳', 'Full premium kitchen'], ['🍽', 'Dishwasher'], ['🧺', 'Washing machine · premium'], ['☕', 'Nespresso + drip coffee maker'], ['🛁', 'Bath + hydro-massage'], ['🚿', 'Shower cabin + hydro-massage'], ['🚗', 'Covered garage'], ['🩹', 'First-aid kit'], ['🎁', 'Welcome kit'], ['☂️', 'Beach umbrella'], ['👶', 'Cot · Highchair'], ['🛏', '200-thread combed cotton sheets · extra set for the sofa-bed'], ['🧴', 'Bath towels 600g/m²'], ['🌺', 'Down & hypoallergenic duvets'], ['🪔', 'Aromas'], ['🧻', 'Drying rack']]
    }
  }
};
const AptEquipamiento = ({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "aei-icon",
    "aria-hidden": "true"
  }, amenityHi(icon) ? /*#__PURE__*/React.createElement(HiIcon, {
    name: amenityHi(icon),
    size: 20
...
const AptPageHero = ({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    srcSet: apt.hero_img.replace(/\.(jpg|jpeg|png)(\?.*)?$/i, '.webp$2'),
    type: "image/webp"
  }), /*#__PURE__*/React.createElement(BlurImg, {
    src: apt.hero_img,
    alt: d.name,
    imgClassName: "apt-page-hero-img",
    loading: "eager",
    fill: true,
    webp: false
    ...
    className: "app-match"
  }, lang === 'es' ? '· Mejor precio garantizado: si lo ves más barato, no solo te lo igualamos, te lo mejoramos.' : '· Best price guaranteed: find it cheaper and we don\'t just match it, we beat it.')), /*#__PURE__*/React.createElement("div", {
...
const GalleryCarousel = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    srcSet: gv(src).replace(/\.(jpg|jpeg|png)(\?.*)?$/i, '.webp$2'),
    type: "image/webp"
  }), /*#__PURE__*/React.createElement("img", {
    decoding: "async",
    src: gv(src),
    ...
    srcSet: gv(imgs[cur]).replace(/\.(jpg|jpeg|png)(\?.*)?$/i, '.webp$2'),
    type: "image/webp"
  }), /*#__PURE__*/React.createElement("img", {
    decoding: "async",
    className: "gc-lb-img",
...
const AptPageOthers = ({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return /*#__PURE__*/React.createElement("a", {
      ...
      srcSet: o.hero_img.replace(/\.(jpg|jpeg|png)(\?.*)?$/i, '.webp$2'),
      type: "image/webp"
    }), /*#__PURE__*/React.createElement(BlurImg, {
      src: o.hero_img,
      alt: d.name,
      imgClassName: "apt-other-img",
      fill: true,
      loading: "lazy",
      webp: false
    })), /*#__PURE__*/React.createElement(WatermarkBadge, {
...
const AptPriceTeaser = ({
  ...
  const seasons = [{
    ...
    return {
      ...s,
      price: Math.round(base * def.multiplier)
    };
  }).filter(Boolean);
  const waMsg = encodeURIComponent(lang === 'es' ? `Hola, me interesa reservar ${apt.es.name}. ¿Podéis indicarme el precio para mis fechas?` : `Hello, I'm interested in ${apt.en.name}. Could you give me a price for my dates?`);
  const waHref = `https://wa.me/34620316370?text=${waMsg}`;
  return /*#__PURE__*/React.createElement("section", {
    className: "apt-price-teaser",
    style: {
      '--apt-accent': apt.accent,
      '--apt-accent2': apt.accent2
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "apt-pt-inner"
  }, /*#__PURE__*/React.createElement("div", {
    className: "apt-pt-copy"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    key: s.key,
    className: `apt-pt-row apt-pt-${s.key}`
  }, /*#__PURE__*/React.createElement("span", {
...
const AptStickyBar = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "asb-match",
    "aria-hidden": "true"
  }, lang === 'es' ? '✓ mejor precio garantizado' : '✓ best price guaranteed'))), /*#__PURE__*/React.createElement("a", {
    href: reservasHref,
...
const ApartmentPageApp = () => {
  ...
  React.useEffect(() => {
    ...
    document.head.appendChild(el);
    return () => {
      const s = document.getElementById('apt-video-schema');
      if (s) s.remove();
    };
  }, [apt.id]);
