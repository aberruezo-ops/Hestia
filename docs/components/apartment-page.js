...
const APT_DATA = {
  vm: {
    ...
    others: ['vt', 'vs'],
    gallery_imgs: ['assets/apt-vm-gallery-1.jpg', 'assets/apt-vm-gallery-2.jpg', 'assets/apt-vm-gallery-3.jpg', 'assets/apt-vm-gallery-4.jpg', 'assets/apt-vm-gallery-5.jpg', 'assets/apt-vm-gallery-6.jpg', 'assets/apt-vm-gallery-7.jpg', 'assets/apt-vm-gallery-8.jpg', 'assets/apt-vm-gallery-9.jpg', 'assets/apt-vm-gallery-10.jpg', 'assets/apt-vm-gallery-11.jpg', 'assets/apt-vm-gallery-12.jpg', 'assets/apt-vm-gallery-13.jpg', 'assets/apt-vm-gallery-14.jpg', 'assets/apt-vm-gallery-15.jpg', 'assets/apt-vm-gallery-16.jpg', 'assets/apt-vm-gallery-17.jpg', 'assets/apt-vm-gallery-18.jpg', 'assets/apt-vm-gallery-19.jpg', 'assets/apt-vm-gallery-20.jpg', 'assets/apt-vm-gallery-21.jpg', 'assets/apt-vm-gallery-22.jpg', 'assets/apt-vm-gallery-23.jpg', 'assets/apt-vm-gallery-24.jpg', 'assets/apt-vm-gallery-25.jpg'],
    es: {
      name: 'Hestía Mar',
  ...
  vt: {
    ...
    others: ['vm', 'vs'],
    gallery_imgs: ['assets/apt-vt-gallery-01.jpg', 'assets/apt-vt-gallery-02.jpg', 'assets/apt-vt-gallery-03.jpg', 'assets/apt-vt-gallery-04.jpg', 'assets/apt-vt-gallery-05.jpg', 'assets/apt-vt-gallery-06.jpg', 'assets/apt-vt-gallery-07.jpg', 'assets/apt-vt-gallery-08.jpg', 'assets/apt-vt-gallery-09.jpg', 'assets/apt-vt-gallery-10.jpg', 'assets/apt-vt-gallery-11.jpg', 'assets/apt-vt-gallery-12.jpg', 'assets/apt-vt-gallery-13.jpg', 'assets/apt-vt-gallery-14.jpg', 'assets/apt-vt-gallery-15.jpg', 'assets/apt-vt-gallery-16.jpg'],
    es: {
  ...
  vs: {
    ...
    // dormitorio 1
    'assets/apt-vs-gallery-23.jpg', 'assets/apt-vs-gallery-22.jpg',
    // dormitorio 2
    'assets/apt-vs-gallery-9.jpg',
    // baño 1
    'assets/apt-vs-gallery-10.jpg', 'assets/apt-vs-gallery-11.jpg',
    // baño principal
    'assets/apt-vs-gallery-12.jpg', 'assets/apt-vs-gallery-13.jpg',
    // terraza principal
    ...
    // segunda terraza
    'assets/apt-vs-gallery-26.jpg', 'assets/apt-vs-gallery-28.jpg' // nuevo: rincón lucecitas
    ],
    es: {
      name: 'Hestía Salinas',
...
const APT_EQUIP = {
  vm: {
    ...
    en: {
      ...
      icons: [['🌊', 'Beach 300m away'], ['☀️', '20m² corner terrace'], ['🏊', 'Pool + Jacuzzi'], ['🌿', 'Gardens'], ['🛋', 'Chill-out'], ['🛗', 'Lift'], ['📺', '55" Smart TV'], ['🎬', 'Prime · HBO · Sky · Pluto'], ['📶', 'Fibre WIFI'], ['❄️', 'Ducted A/C'], ['🍳', 'Full premium kitchen'], ['🍽', 'Dishwasher'], ['🧺', 'Washer · dryer'], ['🛁', 'Bath + hydro-massage'], ['🚿', 'Shower + chromotherapy'], ['🚗', 'Covered garage'], ['🩹', 'First-aid kit'], ['🎁', 'Welcome kit'], ['☂️', 'Beach umbrella'], ['👶', 'Cot · Highchair'], ['🛏', '200-thread combed cotton sheets'], ['🧴', 'Bath & beach towels 600g/m²'], ['🌺', 'Down duvet'], ['🪔', 'Chromotherapy · aromas'], ['🧻', 'Drying rack']]
    }
  },
  vt: {
    area: 85,
    ...
    en: {
      ...
      icons: [['🌊', 'Sea · Lagoon · Village'], ['☀️', '18m² sea-view terrace'], ['🏊', '3 Swimming pools'], ['🌡', 'Heated pool (year-round)'], ['♨️', 'Jacuzzi'], ['💪', 'Gym'], ['🧖', 'Sauna'], ['🎾', 'Tennis court'], ['🌿', 'Gardens · Swings'], ['📺', '55" Smart TV'], ['🎬', 'Prime · HBO · Sky · Pluto'], ['📶', 'Fibre WIFI'], ['❄️', 'A/C lounge & bedrooms'], ['🍳', 'Full premium kitchen'], ['🍽', 'Dishwasher'], ['🧺', 'Washing machine · premium'], ['☕', 'Nespresso + drip coffee maker'], ['🛁', 'Two en-suite bathrooms'], ['🚿', 'Hydro-massage columns'], ['🚗', 'Indoor garage'], ['🩹', 'First-aid kit'], ['🎁', 'Welcome kit'], ['☂️', 'Beach umbrella'], ['🛏', '200-thread combed cotton sheets'], ['🧴', 'Bath & beach towels 600g/m²'], ['🌺', 'Down duvets'], ['🪔', 'Hydrotherapy · aromas'], ['🧻', 'Drying rack']]
    }
  },
  vs: {
    area: 80,
    ...
    en: {
      ...
      icons: [['🌊', 'Beach 2 min away'], ['☀️', '18m² terrace · sun & moon'], ['🌅', '14m² terrace · sunsets'], ['🏊', 'Pool'], ['🌿', 'Gardens · Streams'], ['💪', 'Gym'], ['🎾', 'Tennis court'], ['🛋', 'Chill-out'], ['🏞', 'Puerto Rey Salt Flats'], ['📺', '55" Smart TV · Ambilight'], ['🎬', 'Prime · HBO · Sky · Pluto'], ['📶', 'Fibre WIFI'], ['❄️', 'A/C heat & cool'], ['🍳', 'Full premium kitchen'], ['🍽', 'Dishwasher'], ['🧺', 'Washing machine · premium'], ['☕', 'Nespresso + drip coffee maker'], ['🛁', 'Bath + hydro-massage'], ['🚿', 'Shower cabin + hydro-massage'], ['🚗', 'Covered garage'], ['🩹', 'First-aid kit'], ['🎁', 'Welcome kit'], ['☂️', 'Beach umbrella'], ['👶', 'Cot · Highchair'], ['🛏', '200-thread combed cotton sheets'], ['🧴', 'Bath & beach towels 600g/m²'], ['🌺', 'Down & hypoallergenic duvets'], ['🪔', 'Aromas'], ['🧻', 'Drying rack']]
    }
  }
};
