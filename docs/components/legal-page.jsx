    ...
    es: {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            { name: 'hestia-lang', type: 'Preferencia · Técnica', duration: 'Permanente', desc: 'Recuerda el idioma que elegiste (ES/EN). Necesaria para mostrar el contenido en tu idioma.' },
            { name: 'hestia-cookies', type: 'Consentimiento · Técnica', duration: 'Permanente', desc: 'Guarda tu elección sobre esta política de cookies.' },
            { name: 'Cloudflare Analytics (beacon.min.js)', type: 'Analítica', duration: 'Sin cookie propia', desc: 'Script de medición de visitas de forma agregada y anónima. Solo se carga si aceptas las cookies analíticas. No recoge IPs ni datos personales identificables.' },
          ],
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          h: 'Cookies we use',
          items: [
            { name: 'hestia-lang', type: 'Preference · Technical', duration: 'Permanent', desc: 'Remembers the language you chose (ES/EN). Required to display content in your language.' },
            { name: 'hestia-cookies', type: 'Consent · Technical', duration: 'Permanent', desc: 'Stores your choice about this cookie policy.' },
            { name: 'Cloudflare Analytics (beacon.min.js)', type: 'Analytics', duration: 'No cookie', desc: 'Aggregated and anonymous visit measurement script. Only loads if you accept analytics cookies. Does not collect IPs or personally identifiable data.' },
          ],
        },
        {
