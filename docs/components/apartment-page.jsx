...
const APT_DATA = {
  vm: {
    ...
    es: {
      ...
      features: ['6 plazas + bebé · 2 habitaciones', 'Terraza esquina 20m² · orientada al amanecer', 'Piscina comunitaria', 'Mascotas · petición previa · suplemento', 'Jacuzzi comunitario · temporada verano', '300 m de la playa · 5 min a pie', 'Aire acondicionado centralizado', 'Smart TV · WiFi fibra óptica', 'Cocina totalmente equipada', 'Ropa de cama y toallas incluidas'],
    ...
    en: {
      ...
      features: ['6 guests + baby · 2 bedrooms', 'Corner terrace 20m² · faces sunrise', 'Shared pool', 'Pets · on request · supplement', 'Shared jacuzzi · summer season', '300 m from the beach · 5 min walk', 'Centralised A/C', 'Smart TV · Fibre WiFi', 'Fully equipped kitchen', 'Bed linen & towels included'],
  ...
  vt: {
    ...
    es: {
      ...
      features: ['6 plazas + bebé · 2 habitaciones', 'Terraza panorámica · vistas al mar y al Salar de los Canos', 'Ático — el piso más alto de la urbanización', 'Piscina comunitaria + pistas de pádel', 'SPA comunitario · sauna · gimnasio', '1,5 km de la playa', 'Mascotas · petición previa · suplemento', 'Aire acondicionado frío/calor', 'Smart TV · WiFi fibra óptica', 'Cocina totalmente equipada', 'Ropa de cama y toallas incluidas'],
    ...
    en: {
      ...
      features: ['6 guests + baby · 2 bedrooms', 'Panoramic terrace · sea & Salar de los Canos views', 'Penthouse — highest floor in the complex', 'Shared pool + padel courts', 'Shared SPA · sauna · gym', '1.5 km from the beach', 'Pets · on request · supplement', 'A/C heating & cooling', 'Smart TV · Fibre WiFi', 'Fully equipped kitchen', 'Bed linen & towels included'],
