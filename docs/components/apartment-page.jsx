  ...
  vt: {
    ...
    es: {
      ...
      icons: [
        ...
        ['📺', 'Smart TV 55"'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Movistar Plus · Netflix · Disney+'], ['📶', 'WIFI fibra'],
    ...
    en: {
      ...
      icons: [
        ...
        ['📺', '55" Smart TV'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Movistar Plus · Netflix · Disney+'], ['📶', 'Fibre WIFI'],
