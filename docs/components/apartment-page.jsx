...
const APT_DATA = {
  ...
  vs: {
    ...
    es: {
      ...
      desc2: 'A 900 metros del mar y a un paseo corto del Parque Natural de las Salinas de Puerto Rey. La luz dorada de la tarde llena cada habitación, el privilegio de tener la naturaleza tan cerca.',
