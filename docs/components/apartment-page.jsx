...
const APT_DATA = {
  ...
  vt: {
    ...
    en: {
      ...
      gallery_captions: ['Living room · warm light, terrace steps away', 'Terrace · warm nights worth stretching', 'Kitchen · grey counter, ochre warmth', 'Living room · sofa corner, evening light', 'Master bedroom · soft throw and horizon', 'Bathroom · black vanity, moon-round mirror', 'Master bedroom · warm light on teal', 'Heated pool · mini-spa with views', 'Heated pool · the indoor spa', 'Jacuzzi and heated pool', 'Community gym', 'Sauna and steam room', 'Outdoor community pool · the wooden bridge', 'Dining area · the table grows, light follows', 'Pool · from above, the Mediterranean beyond', 'Terrace · the whole horizon, golden hour', 'Terrace · the Mediterranean turns to gold', 'Master bedroom · embroidered cushions, touch of home', 'Living room · sunset pouring through the window', 'Terrace · under the awning, unhurried', 'Bedroom 2 · red headboards, colourful dreams', 'Bedroom 2 · burgundy warmth as night falls', 'Bedroom 2 · indigo cushions · an invitation to rest', 'Bathroom 1 · mosaic blue underfoot', 'Bathroom 2 · walk-in shower, yellow that wakes', 'Bathroom 2 · matte black, one quiet flower', "Entrance · artisan cabinet, a mirror's welcome", 'Terrace · first light of dawn over the complex'],
    },
  },
  vs: {
