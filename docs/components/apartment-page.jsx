...
const APT_DATA = {
  ...
  vt: {
    ...
    es: {
      ...
      gallery_captions: ['Entrada · mueble artesano, espejo que recibe', 'Salón · luz cálida, terraza a un paso', 'Salón · rincón de sofá, luz de tarde', 'Salón · el atardecer entra por la ventana', 'Comedor · mesa que crece, luz que acompaña', 'Cocina · encimera gris, ocres que abrigan', 'Dormitorio principal · pared turquesa, cojines de damasco', 'Dormitorio principal · manta suave y horizonte', 'Dormitorio principal · luz cálida sobre turquesa', 'Dormitorio principal · bordados con tacto de hogar', 'Baño · lavabo en negro, espejo de luna', 'Dormitorio 2 · mantas de lana, cojines en índigo', 'Dormitorio 2 · el mar, visto desde la cama', 'Dormitorio 2 · ropa de cama blanca, cojines de color', 'Baño 1 · azul de mosaico bajo los pies', 'Baño 2 · ducha de obra, amarillo que despierta', 'Baño 2 · negro mate y una flor serena', 'Terraza · noches cálidas que apetece alargar', 'Terraza · el horizonte entero al atardecer', 'Terraza · el Mediterráneo se tiñe de oro', 'Terraza · bajo el toldo, sin prisa', 'Terraza · primera luz del amanecer sobre la urbanización', 'Piscina exterior comunitaria · el puente de madera', 'Piscina · desde arriba, el Mediterráneo espera', 'Piscina climatizada · minispa con vistas', 'Piscina climatizada · spa cubierto', 'Jacuzzi y piscina climatizada', 'Gimnasio comunitario', 'Sauna y baño de vapor'],
    },
    en: {
      name: 'Hestía Thalassa',
      ...
      gallery_captions: ["Entrance · artisan cabinet, a mirror's welcome", 'Living room · warm light, terrace steps away', 'Living room · sofa corner, evening light', 'Living room · sunset pouring through the window', 'Dining area · the table grows, light follows', 'Kitchen · grey counter, ochre warmth', 'Master bedroom · turquoise wall, damask cushions', 'Master bedroom · soft throw and horizon', 'Master bedroom · warm light on teal', 'Master bedroom · embroidered cushions, touch of home', 'Bathroom · black vanity, moon-round mirror', 'Bedroom 2 · wool throws, indigo cushions', 'Bedroom 2 · the sea, glimpsed from bed', 'Bedroom 2 · crisp white linen, a wall of colour', 'Bathroom 1 · mosaic blue underfoot', 'Bathroom 2 · walk-in shower, yellow that wakes', 'Bathroom 2 · matte black, one quiet flower', 'Terrace · warm nights worth stretching', 'Terrace · the whole horizon, golden hour', 'Terrace · the Mediterranean turns to gold', 'Terrace · under the awning, unhurried', 'Terrace · first light of dawn over the complex', 'Outdoor community pool · the wooden bridge', 'Pool · from above, the Mediterranean beyond', 'Heated pool · mini-spa with views', 'Heated pool · the indoor spa', 'Jacuzzi and heated pool', 'Community gym', 'Sauna and steam room'],
    },
  },
  vs: {
