...
const APT_DATA = {
  vm: {
    ...
    video_duration: 'PT1M14S', video_upload: '2026-05-30T12:00:00+02:00',
    ...
    es: {
      name: 'Hestía Mar',
      concept: 'El verde distinto de una tierra entre el mar y el desierto.',
      desc: 'Hestía Mar vive en un paisaje distinto, donde el verde agreste de Almería se encuentra con el Mediterráneo. Desde la terraza esquinera de 20m² orientada al amanecer, el mar aparece entre los eucaliptos de Vera Playa. Al ser esquinera, da a tres calles y permite ventilación cruzada natural en todas las estancias.',
      ...
      gallery_captions: ['Salón · sobremesas de madera, cocina a mano', 'Salón · sofá bajo un sol de espejo', 'Salón · a vista de pájaro, todo tuyo', 'Salón · lámpara y sofá, tarde en calma', 'Salón · el sofá entero para ti', 'Detalle · jarrón y textiles que abrigan', 'Detalle · el sol dorado del espejo', 'Detalle · suelo hidráulico de otra época', 'Cocina · mañanas que empiezan despacio', 'Cocina · copa en la encimera, sin prisa', 'Cocina · campana a punto, guisos lentos', 'Dormitorio principal · verde profundo, cojines granate', 'Dormitorio principal · armario espejo, luz doblada', 'Dormitorio principal · un globo de luz suave', 'Dormitorio 2 · sueños en turquesa', 'Dormitorio 2 · dos camas, mismo descanso', 'Baño 1 · un resplandor verde y sereno', 'Baño 1 · bañera y ducha, flores rojas de bienvenida', 'Baño 2 · ducha lista, toallas esperando', 'Baño 2 · lavabo y aromas suaves', 'Baño 2 · cabina de ducha y velas, agua caliente al momento', 'Terraza · veladas de verano que se alargan', 'Terraza · sofás para charlas de noche', 'Terraza · copa de vino y velas, la luna de testigo', 'Piscina comunitaria · el agua brilla de noche', 'Piscina comunitaria · el jacuzzi, luces encendidas al anochecer', 'Piscina · jardines alrededor, verano lento', 'Piscina comunitaria · azul de mediodía', 'Zona duchas · mosaico azul tras el baño'],
    },
    en: {
      name: 'Hestía Mar',
      concept: 'The distinct green of a land between the sea and the desert.',
      desc: 'Hestía Mar sits in a distinct landscape, where the wild green of Almería meets the Mediterranean. From the 20m² corner terrace facing the sunrise, the sea appears between the eucalyptus trees of Vera Playa. As a corner unit, Mar faces three streets and benefits from natural cross-ventilation throughout.',
      ...
      gallery_captions: ['Living & dining · wood made for lingering', 'Living room · sofa under a mirrored sun', 'Living room · from above, all yours', 'Living room · lamp glow, evening ease', 'Living room · the whole sofa, yours', 'Detail · vase & textiles, gentle touches', "Detail · the mirror's golden sun", 'Detail · hydraulic tiles from another era', 'Kitchen · mornings that start slow', 'Kitchen · wine on the counter, unhurried', 'Kitchen · hood ready, slow cooking ahead', 'Master bedroom · deep green, burgundy cushions', 'Master bedroom · mirrored wardrobe doubling the light', 'Master bedroom · a globe of soft light', 'Bedroom 2 · dreams in teal', 'Bedroom 2 · two beds, one calm', 'Bathroom 1 · a serene green glow', 'Bathroom 1 · bathtub and shower, red flowers to welcome you', 'Bathroom 2 · shower ready, towels waiting', 'Bathroom 2 · vessel sink & soft scents', 'Bathroom 2 · shower cabin and candles, instant hot water', 'Terrace · summer evenings that stretch on', 'Terrace · sofas for late-night talks', 'Terrace · a glass of wine, candlelight, moon as witness', 'Community pool · water glowing at night', 'Community pool · the jacuzzi lit up at dusk', 'Pool · gardens around, summer slowed', 'Community pool · the blue of midday', 'Pool showers · blue mosaic after the swim'],
    },
  },
  vt: {
    ...
    video_duration: 'PT1M6S', video_upload: '2026-05-30T12:00:00+02:00',
    ...
    gallery_imgs: [
      ...
      'assets/apt-vt-gallery-31.jpg',
      'assets/apt-vt-gallery-30.jpg',
    ...
    es: {
      ...
      desc2: 'El ático tiene una planta abierta y una terraza con vistas al mar. La urbanización, Al Andalus Thalassa, cuenta con piscina comunitaria con jacuzzi, minigim, y un minispa con piscina climatizada abierto en otoño, invierno y primavera.',
      ...
      gallery_captions: ['Entrada · mueble artesano, espejo que recibe', 'Salón · luz cálida, terraza a un paso', 'Salón · rincón de sofá, luz de tarde', 'Salón · el atardecer entra por la ventana', 'Comedor · mesa que crece, luz que acompaña', 'Cocina · encimera gris, ocres que abrigan', 'Cocina · nevera y campana en acero, tulipanes en la encimera', 'Dormitorio principal · manta suave y horizonte', 'Dormitorio principal · pared turquesa, cojines de damasco', 'Baño · lavabo en negro, espejo de luna', 'Baño · el mismo rincón, más cerca', 'Dormitorio 2 · mantas de lana, cojines en índigo', 'Dormitorio 2 · el mar, visto desde la cama', 'Dormitorio 2 · ropa de cama blanca, cojines de color', 'Baño 1 · azul de mosaico bajo los pies', 'Baño 2 · ducha de obra, amarillo que despierta', 'Baño 2 · negro mate y una flor serena', 'Terraza · noches cálidas que apetece alargar', 'Terraza · el horizonte entero al atardecer', 'Terraza · el Mediterráneo se tiñe de oro', 'Terraza · bajo el toldo, sin prisa', 'Terraza · primera luz del amanecer sobre la urbanización', 'Piscina exterior comunitaria · el puente de madera', 'Piscina · desde arriba, el Mediterráneo espera', 'Piscina climatizada · minispa con vistas', 'Piscina climatizada · spa cubierto', 'Piscina climatizada · luz de palmeras tras el cristal', 'Piscina climatizada · el punto de encuentro, todo el año', 'Jacuzzi y piscina climatizada', 'Gimnasio comunitario', 'Sauna y baño de vapor'],
    },
    en: {
      name: 'Hestía Thalassa',
      ...
      desc2: 'The penthouse is laid out as a single open floor with a terrace and sea views. The complex, Al Andalus Thalassa, has a shared pool with jacuzzi, a mini-gym, and a mini-spa with heated pool open in autumn, winter and spring.',
      ...
      gallery_captions: ["Entrance · artisan cabinet, a mirror's welcome", 'Living room · warm light, terrace steps away', 'Living room · sofa corner, evening light', 'Living room · sunset pouring through the window', 'Dining area · the table grows, light follows', 'Kitchen · grey counter, ochre warmth', 'Kitchen · steel fridge and hood, tulips on the counter', 'Master bedroom · soft throw and horizon', 'Master bedroom · turquoise wall, damask cushions', 'Bathroom · black vanity, moon-round mirror', 'Bathroom · the same corner, a closer look', 'Bedroom 2 · wool throws, indigo cushions', 'Bedroom 2 · the sea, glimpsed from bed', 'Bedroom 2 · crisp white linen, a wall of colour', 'Bathroom 1 · mosaic blue underfoot', 'Bathroom 2 · walk-in shower, yellow that wakes', 'Bathroom 2 · matte black, one quiet flower', 'Terrace · warm nights worth stretching', 'Terrace · the whole horizon, golden hour', 'Terrace · the Mediterranean turns to gold', 'Terrace · under the awning, unhurried', 'Terrace · first light of dawn over the complex', 'Outdoor community pool · the wooden bridge', 'Pool · from above, the Mediterranean beyond', 'Heated pool · mini-spa with views', 'Heated pool · the indoor spa', 'Heated pool · palm-tree light through the glass', 'Heated pool · the year-round gathering spot', 'Jacuzzi and heated pool', 'Community gym', 'Sauna and steam room'],
    },
  },
  vs: {
    ...
    video_duration: 'PT1M21S', video_upload: '2026-05-30T12:00:00+02:00',
    ...
    gallery_imgs: [
      ...
      'assets/apt-vs-gallery-33.jpg',   // dormitorio 1 · mural de olas (foto de referencia)
    ...
    es: {
      name: 'Hestía Salinas',
      concept: 'El amarillo albero del amanecer, cerca de las salinas.',
      desc: 'Hestía Salinas vive en el color albero del amanecer almeriense. Tres piscinas, dos terrazas y el Parque Natural de las Salinas de Puerto Rey a un paseo corto.',
      desc2: 'A 900 metros del mar y a un paseo corto del Parque Natural de las Salinas de Puerto Rey, dentro de la urbanización Pueblo Salinas. La luz dorada de la tarde llena cada habitación, el privilegio de tener la naturaleza tan cerca.',
      features: ['El más grande de los tres · el que más desconexión da · el mejor centro de operaciones para conocer toda la zona', '6 plazas + bebé · 2 habitaciones', 'Dos terrazas', '3 piscinas comunitarias · pistas de pádel', 'Gimnasio + sauna comunitarios', 'Parque Natural Salinas de Puerto Rey · a un paseo corto', '900 m de la playa', 'Mascotas · petición previa · suplemento', 'Aire acondicionado frío/calor', 'Smart TV 55" · Prime Video · HBO Max · Skyshowtime', 'WiFi fibra óptica · Amazon Alexa', 'Lavadora · lavavajillas · nevera · microondas', 'Cafetera de cápsulas + espresso · batidora · plancha', 'Cama matrimonial 150 cm · colchón viscoelástico', 'Toallas 100% algodón 200 hilos · nórdicos de plumas'],
      gallery_captions: ['Entrada · espejo y amarillo de bienvenida', 'Salón-comedor · luz de día sobre albero', 'Salón · sofá mostaza, tarde de película', 'Salón · sofá y turquesa para conversar', 'Sofá · con un cuadro de compañía', 'Salón · el conjunto desde arriba', 'Salón nocturno · sesión de cine en casa', 'Comedor · la lámpara teal reúne la mesa', 'Cocina · bajo la campana, encimera lista', 'Cocina · encimera de madera · tacto cálido', 'Cocina · blanca, con todo pensado', 'Cocina · de frente, lista para ti', 'Dormitorio principal · el mural de olas, nada más entrar', 'Dormitorio principal · olas para arroparte', 'Dormitorio principal · de la cama a la terraza', 'Dormitorio 2 · dos camas · espejos gemelos', 'Dormitorio 2 · mantas gruesas, espejos redondos', 'Baño 1 · azul fresco junto al lavabo', 'Baño 1 · mosaico bajo la ducha', 'Baño principal · bañera y bidé, tiempo para ti', 'Terraza principal · sofás de cara a las vistas', 'Terraza pérgola · desayunos sin reloj', 'Terraza · desayuno Hestía, primer regalo del día', 'Terraza principal · cena para dos, luz de velas', 'Terraza principal · noche · la urbanización se enciende', 'Terraza principal · nubes encendidas al atardecer', 'Segunda terraza · velada para dos', 'Terraza · un rincón entre lucecitas', 'Piscina comunitaria · palmeras arriba, casa al lado', 'Piscina comunitaria · rosa de atardecer en el agua'],
    },
    en: {
      name: 'Hestía Salinas',
      concept: 'Ochre yellow, sunrise near the salt flats.',
      desc: 'Hestía Salinas lives in the ochre colour of the Almería sunrise. Three pools, two terraces and the Puerto Rey salt-flat nature park a short walk away.',
      desc2: '900 metres from the sea and a short walk from the Puerto Rey Salt-flat Nature Park. Golden afternoon light fills every room, the privilege of having nature so close by.',
      features: ['The largest of the three · the most disconnecting · the best base of operations to explore the whole area', '6 guests + baby · 2 bedrooms', 'Two terraces', '3 shared pools · padel courts', 'Communal gym + sauna', 'Puerto Rey Salt-flat Nature Park · a short walk away', '900 m from the beach', 'Pets · on request · supplement', 'A/C heating & cooling', 'Smart TV 55" · Prime Video · HBO Max · Skyshowtime', 'Fibre WiFi · Amazon Alexa', 'Washer · dishwasher · fridge · microwave', 'Capsule + espresso coffee maker · blender · iron', 'Double bed 150 cm · memory foam mattress', '100% cotton 200-thread towels · down duvets'],
      gallery_captions: ['Entrance · mirror & a yellow welcome', 'Living & dining · daylight on ochre walls', 'Living room · mustard sofa, movie afternoons', 'Living room · sofa & teal for conversation', 'Sofa · with a painting for company', 'Living room · the whole scene from above', 'Evening living room · home-cinema mood', 'Dining area · teal light gathers the table', 'Kitchen · under the hood, counter ready', 'Kitchen · wooden counter · warm touch', 'Kitchen · all white, nothing missing', 'Kitchen · full view, ready for you', 'Master bedroom · the wave mural, right as you walk in', 'Master bedroom · waves to tuck you in', 'Master bedroom · from bed to terrace', 'Bedroom 2 · twin beds · twin mirrors', 'Bedroom 2 · winter throws, round mirrors', 'Bathroom 1 · cool blue by the sink', 'Bathroom 1 · mosaic under the shower', 'Main bathroom · bathtub & bidet, time for you', 'Main terrace · loungers facing the view', 'Pergola terrace · breakfasts without a clock', "Terrace · Hestía breakfast, the day's first treat", 'Main terrace · dinner for two, candlelight', 'Main terrace · night · the complex lights up', 'Main terrace · clouds catching the sunset', 'Second terrace · an evening for two', 'Terrace · a corner wrapped in fairy lights', 'Community pool · palms above, home steps away', 'Community pool · pink dusk on the water'],
    },
  },
};
...
const APT_EQUIP = {
  ...
  vt: {
    ...
    daily_es: {
      ...
      core: 'Zonas comunes: SPA con sauna y gimnasio (SPA en otoño-invierno-primavera; gimnasio todo el año), piscinas y pista de tenis. En el ático: Smart TV con streaming (SkyShowtime, HBO Max, Prime Video, Movistar Plus y Disney+ siempre activas, además de apps gratuitas), dos baños en suite con columnas de hidromasaje y cocina alto standing.',
    ...
    daily_en: {
      ...
      core: 'Shared areas: spa with sauna and gym (spa open autumn–winter–spring; gym year-round), pools and tennis court. In the penthouse: Smart TV with streaming (SkyShowtime, HBO Max, Prime Video, Movistar Plus and Disney+ always active, plus free apps), two en-suite bathrooms with hydro-massage columns and a high-end kitchen.',
    ...
    es: {
      ...
      icons: [
        ...
        ['📺', 'Smart TV 55"'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Movistar Plus · Disney+'], ['📶', 'WIFI fibra'],
    ...
    en: {
      ...
      icons: [
        ...
        ['📺', '55" Smart TV'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Movistar Plus · Disney+'], ['📶', 'Fibre WIFI'],
  ...
  vs: {
    ...
    daily_es: {
      ...
      core: 'Dos terrazas: la de 18 m² para sol y luna, la de 14 m² para el atardecer. Piscina, gimnasio y pista de tenis en la urbanización. Smart TV 55" con Ambilight y streaming (SkyShowtime, HBO Max, Prime Video y Disney+ siempre activas, además de apps gratuitas), cocina completa y A/C frío-calor.',
    ...
    daily_en: {
      ...
      core: 'Two terraces: the 18 m² for sun and moon, the 14 m² for sunset. Pool, gym and tennis court in the complex. 55" Ambilight Smart TV with streaming (SkyShowtime, HBO Max, Prime Video and Disney+ always active, plus free apps), full kitchen and heat-cool A/C.',
    ...
    es: {
      ...
      icons: [
        ...
        ['📺', 'Smart TV 55" · Ambilight'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Disney+'], ['📶', 'WIFI fibra'],
    ...
    en: {
      ...
      icons: [
        ...
        ['📺', '55" Smart TV · Ambilight'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Disney+'], ['📶', 'Fibre WIFI'],
...
const ApartmentPageApp = () => {
  ...
  React.useEffect(() => {
    ...
    const schema = {
      ...
      'uploadDate': apt.video_upload || '2026-05-30T12:00:00+02:00',
