...
const APT_EQUIP = {
  ...
  vt: {
    ...
    daily_es: {
      ...
      core: 'Zonas comunes: SPA con sauna y gimnasio (SPA en otoño-invierno-primavera; gimnasio todo el año), piscinas y pista de tenis. En el ático: Smart TV con streaming (SkyShowtime, HBO Max y Prime Video siempre activas, más Movistar Plus; estamos sumando pronto Netflix y Disney+, además de apps gratuitas), dos baños en suite con columnas de hidromasaje y cocina alto standing.',
    ...
    daily_en: {
      ...
      core: 'Shared areas: spa with sauna and gym (spa open autumn–winter–spring; gym year-round), pools and tennis court. In the penthouse: Smart TV with streaming (SkyShowtime, HBO Max and Prime Video always active, plus Movistar Plus; we are adding Netflix and Disney+ soon, plus free apps), two en-suite bathrooms with hydro-massage columns and a high-end kitchen.',
    ...
    es: {
      ...
      icons: [
        ...
        ['📺', 'Smart TV 55"'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Movistar Plus (Netflix y Disney+ próximamente)'], ['📶', 'WIFI fibra'],
    ...
    en: {
      ...
      icons: [
        ...
        ['📺', '55" Smart TV'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video · Movistar Plus (Netflix & Disney+ coming soon)'], ['📶', 'Fibre WIFI'],
  ...
  vs: {
    ...
    daily_es: {
      ...
      core: 'Dos terrazas: la de 18 m² para sol y luna, la de 14 m² para el atardecer. Piscina, gimnasio y pista de tenis en la urbanización. Smart TV 55" con Ambilight y streaming (SkyShowtime, HBO Max y Prime Video siempre activas; estamos sumando pronto Disney+, además de apps gratuitas), cocina completa y A/C frío-calor.',
    ...
    daily_en: {
      ...
      core: 'Two terraces: the 18 m² for sun and moon, the 14 m² for sunset. Pool, gym and tennis court in the complex. 55" Ambilight Smart TV with streaming (SkyShowtime, HBO Max and Prime Video always active; we are adding Disney+ soon, plus free apps), full kitchen and heat-cool A/C.',
    ...
    es: {
      ...
      icons: [
        ...
        ['📺', 'Smart TV 55" · Ambilight'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video (Disney+ próximamente)'], ['📶', 'WIFI fibra'],
    ...
    en: {
      ...
      icons: [
        ...
        ['📺', '55" Smart TV · Ambilight'], ['🎬', 'Streaming: SkyShowtime · HBO Max · Prime Video (Disney+ coming soon)'], ['📶', 'Fibre WIFI'],
