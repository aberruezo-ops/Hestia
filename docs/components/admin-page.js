...
const LeilaTab = ({
  ...
  const loadData = React.useCallback(() => {
    setLoading(true);
    setLoadErr(null);
    fetch(`${API}/repos/${DATA_REPO}/contents/${RESERVAS_PATH}?ref=${BRANCH}`, {
      headers: apiHeaders(token),
      cache: 'no-store'
    }).then(r => r.json()).then(j => {
      if (j.message) throw new Error(j.message);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    type: "button",
    className: "pe-btn pe-btn-ghost",
    onClick: () => data && exportReservasCSV((data.reservas || []).filter(r => String(r.year || '') === focusYear), focusYear),
    disabled: !data
  }, "Exportar CSV"), loadedAt && /*#__PURE__*/React.createElement("span", {
...
const ReservasTab = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, error && /*#__PURE__*/React.createElement("div", {
    ...
    type: "button",
    className: "pe-btn pe-btn-ghost",
    onClick: () => data && exportReservasCSV(focusList, focusYear),
    disabled: !data
