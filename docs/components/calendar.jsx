    ...
    <div className="req-panel" style={{ '--req-accent': accent }}>
      ...
      <div className="req-contact-form">
        ...
        <div className="req-form-row">
          ...
          <input id="req-cal-name" className="req-input" type="text" placeholder={lang === 'es' ? 'Nombre' : 'Name'} value={name} onChange={e => setName(e.target.value)} autoComplete="name"/>
          <label htmlFor="req-cal-phone" className="sr-only">{lang === 'es' ? 'Teléfono' : 'Phone'}</label>
          <input id="req-cal-phone" className="req-input" type="tel" placeholder={lang === 'es' ? 'Teléfono' : 'Phone'} value={phone} onChange={e => setPhone(e.target.value)} autoComplete="tel"/>
        </div>
        <label htmlFor="req-cal-email" className="sr-only">Email</label>
        <input id="req-cal-email" className="req-input req-input-full" type="email" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)} autoComplete="email"/>
