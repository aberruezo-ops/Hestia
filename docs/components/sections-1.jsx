...
const Compare = ({ lang }) => {
  const rows = lang === 'es' ? [
    ...
    { label: 'Streaming',     vm: 'SkyShowtime · HBO Max · Prime', vt: '+ Movistar Plus · pronto Netflix y Disney+', vs: 'Pronto + Disney+' },
    ...
    { label: 'Streaming',     vm: 'SkyShowtime · HBO Max · Prime', vt: '+ Movistar Plus · Netflix & Disney+ soon', vs: 'Disney+ soon' },
