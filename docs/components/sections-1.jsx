...
const Hero = ({ lang, onScrollDown }) => {
  ...
  React.useEffect(() => {
    window.dispatchEvent(new CustomEvent('hestia:hero-dates', { detail: { checkin: hcIn, checkout: hcOut } }));
  }, [hcIn, hcOut]);
                ...
                <div className="apt-content">
                  ...
                  {minPrice && (
                    <div className="apt-price-badge">
                      ...
                      <span className="apb-price"><AnimatedPrice value={minPrice} from={0} duration={900} format={v => v.toLocaleString('es-ES')} />€</span>
...
const Compare = ({ lang }) => {
  const rows = lang === 'es' ? [
    ...
    { label: 'Streaming',     vm: 'SkyShowtime · HBO Max · Prime · Disney+', vt: 'SkyShowtime · HBO Max · Prime · Movistar Plus · Disney+', vs: 'SkyShowtime · HBO Max · Prime · Disney+' },
