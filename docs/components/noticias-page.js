...
const NOTICIAS = {
  ...
  territorio: [{
    ...
    articles: [{
      ...
      titulo: {
        es: 'Abren los chiringuitos — la temporada empieza',
        en: 'Beach bars open — the season begins'
      },
      cuerpo: {
      ...
      titulo: {
        es: 'Feria del Jamón de Tíjola — primer fin de semana de mayo',
        en: "Tíjola Ham Fair — first May weekend"
      },
      cuerpo: {
      ...
      titulo: {
        es: 'Bandera Azul 2026 — confirmada para Vera, Garrucha y Mojácar',
        en: 'Blue Flag 2026 — confirmed for Vera, Garrucha and Mojácar'
      },
      cuerpo: {
    ...
    articles: [{
      ...
      titulo: {
        es: 'Cabo de Gata en mayo — el mejor mes del año',
        en: 'Cabo de Gata in May — the best month of the year'
      },
      cuerpo: {
      ...
      titulo: {
        es: 'Festival de Jazz en el Paseo — Almería capital, segunda quincena de mayo',
        en: 'Jazz Festival on the Promenade — Almería city, late May'
      },
      cuerpo: {
    ...
    articles: [{
      ...
      titulo: {
        es: 'Feria del Caballo de Jerez — primera semana de mayo',
        en: 'Jerez Horse Fair — first week of May'
      },
      cuerpo: {
      ...
      titulo: {
        es: 'Mojácar, entre los Pueblos Más Bonitos de España — cuarto año consecutivo',
        en: "Mojácar, among Spain's Most Beautiful Villages — fourth consecutive year"
      },
      cuerpo: {
      ...
      titulo: {
        es: 'AOVE Poniente de Granada — cosecha 2025/26 excepcional',
        en: 'Poniente de Granada olive oil — exceptional 2025/26 harvest'
      },
      cuerpo: {
    ...
    articles: [{
      ...
      titulo: {
        es: 'Cartagena — Semana de la Mar, mayo',
        en: 'Cartagena — Week of the Sea, May'
      },
      cuerpo: {
      ...
      titulo: {
        es: 'Sierra Espuña — mayo en su mejor momento',
        en: 'Sierra Espuña — May at its finest'
      },
      cuerpo: {
      ...
      titulo: {
        es: 'Festival del Cante de las Minas — entradas a la venta (La Unión, julio)',
        en: 'Festival del Cante de las Minas — tickets on sale (La Unión, July)'
      },
      cuerpo: {
