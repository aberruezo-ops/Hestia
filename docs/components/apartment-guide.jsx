  ...
  vm: {
    ...
    es: {
      ...
      rooms: [
        ...
        { id: 'banos', title: 'Mis baños', body: 'Mis dos baños: uno con columna de hidroterapia y espejo de cromoterapia, y otro con ducha y luz de colores. Productos básicos para tus primeros días, aromas, velas, secador, botiquín y más.', recs: [
    ...
    en: {
      ...
      rooms: [
        ...
        { id: 'banos', title: 'My bathrooms', body: 'My two bathrooms: one with a hydrotherapy column and chromotherapy mirror, the other with a shower and colour lighting. Basic products for your first days, plus scents, candles, hairdryer, first-aid kit and more.', recs: [
...
const TAPAS_ROUTES = [
  { id: 'tapas-vera-playa',
    ...
    stops: [
      { name: 'Chiringuito Maruja', what_es: 'Pescaíto frito y sardinas al espeto. Caña + tapa a precio de chiringuito.', what_en: 'Fried fish and espeto sardines. Affordable beachside tapas.' },
      { name: 'Bares del paseo marítimo', what_es: 'Chopitos fritos, boquerones en vinagre, croquetas caseras. Pide siempre lo del día.', what_en: 'Fried squid rings, marinated anchovies, home-made croquettes. Always ask for the daily special.' },
      { name: 'Terraza con vistas al mar', what_es: 'Para acabar: tinto de verano o granizado de limón y disfrutar de la puesta de sol.', what_en: 'To finish: red wine with lemon or granizado, watching the sunset.' },
    ],
  ...
  { id: 'tapas-vera-pueblo',
    ...
    stops: [
      { name: 'Bar Las Vegas', what_es: 'Primera parada: cerveza fría + tapa de chocos fritos o gambas al ajillo. ~3 €.', what_en: 'First stop: cold beer + fried squid or garlic prawns tapa. ~€3.' },
      { name: 'Bodega El Choto', what_es: 'Vinos locales almerienses y murcianos. Tapa de carne (lomo, morcilla). Ambiente de taberna.', what_en: 'Local Almería and Murcia wines. Meat tapa (loin, blood sausage). Tavern atmosphere.' },
      { name: 'Bar Pasaje', what_es: 'Ración para compartir: pulpo a la gallega o jamón ibérico. Mesa fuera en verano.', what_en: 'Sharing platter: Galician octopus or Iberian ham. Outdoor table in summer.' },
      { name: 'Heladería La Ibense', what_es: 'Cierre perfecto: helado artesanal de turrón, chocolate al ron o mantecado.', what_en: 'Perfect ending: artisan turrón, rum chocolate or mantecado ice cream.' },
    ],
  ...
  { id: 'tapas-garrucha',
    ...
    stops: [
      { name: 'Los Lebreros (puerto)', what_es: 'Empezar al caer la tarde: caña, camarones crudos y quisquilla viva. Llegar sobre las 19:00 cuando atracan los barcos.', what_en: 'Start at sundown: beer, raw camarones and live quisquilla prawns. Arrive around 19:00 when the boats dock.' },
      { name: 'Rincón del Puerto', what_es: 'Junto a la lonja. Gamba roja a la plancha — pedirla sin más, no necesita nada. El punto de cocción es clave: vuelta y vuelta.', what_en: 'Next to the fish market. Grilled red prawns — order them plain, they need nothing else. The cooking point is everything: just seared.' },
      { name: 'El Almejero', what_es: 'Si queréis sentaros a cenar: arroz caldoso de bogavante o almejas a la marinera. Bib Gourmand.', what_en: 'If you want a sit-down dinner: caldoso lobster rice or clams marinera. Bib Gourmand.' },
      { name: 'La Trattoria da Marco', what_es: 'Alternativa sin mariscos: pizza calzone auténtica o pasta carbonara italiana.', what_en: 'Non-seafood alternative: authentic pizza calzone or Italian carbonara.' },
    ],
  ...
  { id: 'tapas-mojacar',
    city_es: 'Mojácar', city_en: 'Mojácar',
    ...
    stops: [
      { name: "Tito's (Pueblo)", what_es: 'Primera parada en el pueblo: rabo de toro, croquetas de jamón y atún encebollado. Reserva con antelación en verano.', what_en: 'First village stop: oxtail stew, jamón croquettes and tuna with onion. Book ahead in summer.' },
      { name: 'Cantares (Plaza Nueva)', what_es: 'Terraza con vistas al valle. Vermut con tapa, tabla ibérica. El atardecer aquí vale el viaje.', what_en: 'Terrace with valley views. Vermouth with tapa, Iberian charcuterie board. The sunset view is worth the trip.' },
      { name: 'Mandala (Pueblo)', what_es: 'Coctelería de autor para cerrar: gin tonics premium y mezcales de calidad.', what_en: 'Craft cocktail bar to close: premium gin tonics and quality mezcals.' },
      { name: 'Cabo Norte (Playa)', what_es: 'En la playa: gambas al ajillo imprescindibles, pulpo a la gallega y croquetas caseras. Buena relación calidad-precio.', what_en: 'At the beach: essential garlic prawns, Galician octopus and home-made croquettes. Good value.' },
    ],
  ...
  { id: 'tapas-cabo-gata',
    ...
    stops: [
      { name: 'Bar Sahara (San José)', what_es: 'Ambiente de pueblo pesquero: cervezas artesanas, tapas marineras y música en vivo algunos días.', what_en: 'Fishing-village atmosphere: craft beers, seafood tapas and occasional live music.' },
      { name: 'La Ola (San José)', what_es: 'A pie de mar: pulpo a la brasa, tartar de atún y arroces. Para comer más despacio con vistas al puerto.', what_en: 'Beachfront: grilled octopus, tuna tartare and rice dishes. For a relaxed lunch with port views.' },
  ...
  { id: 'tapas-almeria-capital',
    ...
    stops: [
      { name: 'Casa Puga', what_es: 'Taberna fundada en 1870. Imprescindible: caracoles, ensaladilla y tortilla del Sacromonte. Sin reservas — llega antes de las 13:30 o a las 20:00.', what_en: 'Tavern founded in 1870. Unmissable: snails, ensaladilla and Sacromonte omelette. No bookings — arrive before 13:30 or at 20:00.' },
      { name: 'La Mala', what_es: 'Taberna pequeña con buena rotación de tapas. Famosa por sus croquetas y el jamón en lonchas finas.', what_en: 'Small tavern with a good tapa rotation. Famous for croquettes and thinly sliced jamón.' },
      { name: 'El Quinto Toro', what_es: 'Clásico del centro. Rabo de toro y albóndigas en salsa — tapas de guiso contundente.', what_en: 'Downtown classic. Oxtail and meatballs in sauce — hearty stewed tapas.' },
      { name: 'Los Diamantes', what_es: 'Para los fritos: boquerones, chocos y gambas rebozadas. La fritura almeriense en su versión más pura.', what_en: 'For the fried food: anchovies, squid and battered prawns. Almerían frying at its purest.' },
    ],
  ...
  { id: 'tapas-aguilas',
    ...
    stops: [
      { name: 'Zona del puerto (paseo La Explanada)', what_es: 'La ruta empieza en el paseo del puerto: bares con terraza sobre el agua, mariscos frescos y tapa marinera clásica. Pide quisquilla y langostinos de la costa.', what_en: 'Start at the harbour promenade: terrace bars over the water, fresh shellfish and classic marinera tapa. Order quisquilla and local langostinos.' },
      { name: 'Mercado Municipal de Águilas', what_es: 'Por la mañana: olivas aderezadas, queso fresco de cabra y embutido del campo. El ambiente del mercado ya vale el viaje.', what_en: 'Morning stop: marinated olives, fresh goat\'s cheese and cured meats. The market atmosphere alone is worth the visit.' },
      { name: 'Bares del casco antiguo', what_es: 'Zona de la plaza: bares con tapa incluida en la consumición — herencia murciana. Pide vino DOP Bullas (el más cercano) o un vermut de grifo.', what_en: 'Old town square bars: tapa included with every drink — Murcian tradition. Order DOP Bullas wine (the closest DO) or a draft vermouth.' },
    ],
  ...
  { id: 'tapas-mazarron-cartagena',
    ...
    stops: [
      { name: 'Puerto de Mazarrón · freidurías y marisquerías', what_es: 'Puerto pesquero activo. Pescaíto frito directo de la lonja, caldero del Mar Menor (arroz con pescado de roca) y camarones frescos. Sin pretensiones, todo producto.', what_en: 'Active fishing port. Freshly fried fish from the daily catch, Mar Menor caldero (rock fish rice) and fresh camarones. Unpretentious, all about the produce.' },
      { name: 'Cartagena · La Marquesita', what_es: 'La marinera: boquerón en vinagre sobre rosquilla con oliva — invento 100% cartagenero. La Marquesita es la referencia. ~25 €/persona con vino.', what_en: 'The marinera: marinated anchovy on a rosquilla ring with olive — 100% Cartagena invention. La Marquesita is the benchmark. ~€25/person with wine.' },
      { name: 'Cartagena · Calle Mayor y Barrio del Foro Romano', what_es: 'Paseo entre bares: zona de tapeo de toda la vida con vistas al Teatro Romano. Los Columbares (Plaza San Sebastián) para vermut y marineras adicionales.', what_en: 'Bar-to-bar walk with views of the Roman Theatre. Los Columbares (Plaza San Sebastián) for vermouth and more marineras.' },
    ],
  ...
  { id: 'tapas-murcia-capital',
    ...
    stops: [
      { name: 'Plaza de las Flores y Calle Trapería', what_es: 'El epicentro del tapeo murciano. La plaza tiene terrazas animadas; la Trapería, la calle comercial más antigua, bares de azulejo y madera. Pide zarangollo (huevo revuelto con calabacín y cebolla) y pasteles de carne (empanadillas rellenas de carne picada especiada).',
      ...
      { name: 'Barrio del Carmen · Calle San Nicolás', what_es: 'Zona de bodegas y bares de toda la vida. Marinera, michirones (habas secas guisadas con chorizo) y morcilla con arroz. Vino de Jumilla o Bullas por copas a buen precio.',
      ...
      { name: 'Mercado de Verónicas', what_es: 'El mercado central de Murcia: paradas de queso, fruta de huerta, pimentón murciano (de Espinardo) y longaniza de Pascua. Abre de mañana — ideal para el aperitivo de las 12:00.',
      ...
      { name: 'Bodegón El Corral o El Pasaje', what_es: 'Para cerrar con una ración completa: caldero de Mar Menor (si lo tienen en temporada), paparajotes (hojas de limonero rebozadas en azúcar — postre murciano único) y un chato de Monastrell.',
