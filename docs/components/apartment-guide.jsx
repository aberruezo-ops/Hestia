  ...
  es: {
    ...
    rules: {
      ...
      items: [
        ...
        { icon: '🚼', t: 'Terminantemente prohibido hacer necesidades en la piscina o en cualquier zona común',
  ...
  en: {
    ...
    rules: {
      ...
      items: [
        ...
        { icon: '🚼', t: 'Strictly forbidden to relieve yourself in the pool or any shared area',
