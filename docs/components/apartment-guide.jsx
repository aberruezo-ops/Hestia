  ...
  vm: {
    ...
    es: {
      ...
      rooms: [
        ...
        { id: 'dormitorios', title: 'Tus dormitorios', body: 'Tu dormitorio principal mira al mar y tiene las mejores sábanas y rellenos nórdicos de plumas o sintéticos. Colchones de alta calidad y almohadas de diferentes durezas. En el armario te espera la sombrilla de playa.', recs: [
  ...
  vt: {
    ...
    es: {
      ...
      rooms: [
        ...
        { id: 'dormitorios', title: 'Tus dormitorios', body: 'Tu dormitorio principal mira al mar y a las palmeras de la urbanización. Colchones de alta calidad y almohadas de diferentes durezas. Las mejores sábanas y rellenos nórdicos de plumas o sintéticos.', recs: [
          'Las cremas bronceadoras pueden estropear sábanas, toallas y tapicerías.',
          'Cuidado con el aire acondicionado por la noche y las corrientes de aire.',
  ...
  vs: {
    ...
    es: {
      ...
      rooms: [
        ...
        { id: 'dormitorios', title: 'Tus dormitorios', body: 'Tus dormitorios tienen las mejores sábanas y rellenos nórdicos de plumas. Colchones de alta calidad y almohadas de viscoelástica. En el armario te espera la sombrilla de playa.', recs: [
          'Las cremas bronceadoras pueden estropear sábanas, toallas y tapicerías.',
          'Cuidado con el aire acondicionado por la noche y las corrientes de aire.',
          'Ponte el despertador un día no muy nublado para ver el amanecer.',
        ]},
        { id: 'banos', title: 'Tus baños', body: 'Tus dos baños: uno con bañera, hidromasaje y otro con ducha hidromasaje. Productos básicos para tus primeros días, aromas, velas, secador, botiquín y más.', recs: [
          'Haz un uso prudente y responsable del agua. El agua es vida.',
          'Las toallas del baño no son para la playa ni para la piscina.',
          'Cuidado con las cremas y maquillaje. Estropean los textiles del hogar.',
        ]},
        ...
        { id: 'urbanizacion', title: 'Tu urbanización', body: 'Tu urbanización es textil, por lo que está prohibido el nudismo. Tu plaza de garage es la nº 290. Tienes entrada y salida controladas por código, acceso/barrera a la zona 2 (donde está Hestía), acceso peatonal desde la urbanización, piscina y pistas deportivas. Hestía Vera Salinas está en el bloque 22, planta 1, puerta 7.',
          points: [
          ...
          recs: [
          'La urbanización merece la pena recorrerla para disfrutar de los jardines, los riachuelos, las aves y otros pequeños animales, todo ello con el desierto alrededor. Es un lugar sin igual, para disfrutar con toda la tranquilidad de un recinto cerrado, sobre todo si vas con niños.',
...
const SUBCATS = [
  { id: 'yacimientos', es: 'Yacimientos arqueológicos', en: 'Archaeological sites', icon: '🏺' },
  { id: 'castillos',   es: 'Castillos y fortalezas',     en: 'Castles & fortresses', icon: '🏰' },
  { id: 'islamico',    es: 'Patrimonio islámico',        en: 'Islamic heritage',     icon: '☪' },
  { id: 'romano',      es: 'Patrimonio romano',          en: 'Roman heritage',       icon: '🏛️' },
  { id: 'cuevas',      es: 'Cuevas y geología',          en: 'Caves & geology',      icon: '🕳️' },
  { id: 'faros',       es: 'Faros y miradores',          en: 'Lighthouses & viewpoints', icon: '🗼' },
  { id: 'naturaleza',  es: 'Naturaleza singular',        en: 'Singular nature',      icon: '🌿' },
  { id: 'familia',     es: 'Atracciones familiares',     en: 'Family attractions',   icon: '🎢' },
];
        ...
        return (
          <div key={sc.id} className="ag-poi-cat">
            <h3 className="ag-poi-cat-title">
              <span className="ag-poi-cat-icon" aria-hidden="true">{sc.icon}</span>
                ...
                return (
                  <li key={i} className="ag-poi-row">
                    ...
                    <div className="ag-poi-row-meta">
                      ...
                      <span className="ag-poi-how">{lang === 'es' ? (p.comoLlegar_es || p.comoLlegar_en) : (p.comoLlegar_en || p.comoLlegar_es)}</span>
                      {p.anchor && (
                        <>
                          <span className="ag-poi-sep">·</span>
      ...
      <li key={p.id} className={`ag-place${p.featured ? ' is-featured' : ''}`}>
        ...
        {(p.desc || p.desc_en) && (
          <span className="ag-place-desc">
            {lang === 'en' && p.desc_en ? p.desc_en : p.desc}
              ...
              <div className="ag-before">
                ...
                {s.checkin.packLightBody && (
                  <div className="ag-packlight">
                    <span className="ag-packlight-icon" aria-hidden="true">🧳</span>
