...
const PLACES = [
  ...
  // Restaurantes
  { id: 'riad-cabrera',   name: 'Riad Cabrera',     desc: 'Marroquí en Sierra Cabrera. Carretera de montaña, pero merece muchísimo la pena.', specialty: 'tagine de cordero con ciruelas, pastilla de pichón y té con menta en la terraza al atardecer.', tip: 'Reserva con tiempo y sube con luz: las curvas tienen su gracia, pero de noche cuestan.', tier: '€€€', cat: 'restaurant', lat: 37.1550, lng: -1.8700 , featured: true },
  { id: 'juan-moreno',    name: 'Juan Moreno',       desc: 'Sofisticado. Cocina de autor en Vera pueblo.', specialty: 'menú degustación con producto local, atún rojo de almadraba y arroces secos.', tier: '€€€', cat: 'restaurant', lat: 37.2495, lng: -1.8623 , featured: true },
  { id: 'terraza-carmona',name: 'Terraza Carmona',   desc: 'Cocina española moderna en Vera pueblo. Casa con historia.', specialty: 'gurullos con conejo y caldero de pescado; postres caseros.', tier: '€€',  cat: 'restaurant', lat: 37.2486, lng: -1.8635 },
  { id: 'gateway-india',  name: 'Gateway to India',  desc: 'Hindú. Bueno y barato.',                   specialty: 'cordero rogan josh, pollo tikka masala y pan naan de ajo.', tier: '€',   cat: 'restaurant', lat: 37.2230, lng: -1.8090 },
  { id: 'pomodoro',       name: 'Pizzería Pomodoro', desc: 'A pie de playa.',                          specialty: 'pizza al horno de leña — la diavola y la quattro formaggi salen siempre.', tier: '€€',  cat: 'restaurant', lat: 37.2270, lng: -1.7920 },
  { id: 'trattoria',      name: 'La Trattoria da Marco', desc: 'Garrucha. Las pizzas están geniales.', specialty: 'pizza calzone, pasta a la carbonara auténtica y tiramisú.', tier: '€',   cat: 'restaurant', lat: 37.1810, lng: -1.8230 },
  { id: 'lua',            name: 'Lúa',               desc: 'Sofisticado. Mejor para cena o copa.',     specialty: 'tartar de atún rojo, croquetas de gamba roja y carrillera al PX.', tip: 'Reserva mesa fuera al atardecer; la carta de cócteles está a la altura.', tier: '€€€', cat: 'restaurant', lat: 37.2310, lng: -1.7935 , featured: true },
  { id: 'bistro',         name: 'The Bistro',        desc: 'Bastante bien.',                            specialty: 'entrecot a la parrilla y ensalada de burrata.', tier: '€€',  cat: 'restaurant', lat: 37.2310, lng: -1.7945 },
  { id: 'koa',            name: 'Resto Bar Koa',     desc: 'Frente a Hestía Vera Mar. Bocados pensados, ambiente cercano.', specialty: 'bao de panceta, ceviche del día y poke bowl.', tier: '€€',  cat: 'restaurant', lat: 37.2245, lng: -1.7965 , featured: true },
  { id: 'bbme-rest',      name: 'Restaurante Bbme Palomares', desc: 'En plena playa, a 10 min a pie.',  specialty: 'arroz negro con sepia y all i oli, sardinas a la espalda.', tier: '€€',  cat: 'restaurant', lat: 37.2155, lng: -1.7800 },
  { id: 'playa-azul',     name: 'Hostal Playa Azul', desc: 'Villaricos. Excelente paella con bogavante.', specialty: 'paella con bogavante (encargar al reservar), gambas blancas de Garrucha.', tip: 'Pide la paella al hacer la reserva — la preparan al momento.', tier: '€€', cat: 'restaurant', lat: 37.2460, lng: -1.7660 , featured: true },
  { id: 'tadeo',          name: 'Tadeo',             desc: 'Villaricos. Cocina de mar con producto del día.', specialty: 'arroz con bogavante, tostas de ahumados y pulpo a la brasa.', tier: '€€', cat: 'restaurant', lat: 37.2455, lng: -1.7670 , featured: true },
  ...
  { id: 'turquesa',       name: 'Chiringuito Playa Turquesa', desc: 'Andando desde casa. Ambiente familiar de día, copas al atardecer.', specialty: 'mojito de menta del huerto y tabla de quesos al sol.', cat: 'bar', lat: 37.2260, lng: -1.7935 , featured: true },
  { id: 'paraiso',        name: 'Paraíso Vera Beach', desc: 'Andando desde casa. Música chill desde media tarde.',         specialty: 'gin tonics premium y picoteo de tapeo mediterráneo.', cat: 'bar', lat: 37.2300, lng: -1.7920 },
  { id: 'chumbo',         name: 'Chiringuito El Chumbo', desc: 'Andando desde casa. El más relajado del paseo.',      specialty: 'sangría de cava, sardinas al espeto en verano y arroz del día.', cat: 'bar', lat: 37.2360, lng: -1.7895 },
  { id: 'marau',          name: 'Marau Beach Club',  desc: 'Beach club con DJ y zona de hamacas vista mar.',                                          specialty: 'cócteles de autor y carta asiática (poke, bao, tartar).', tip: 'Mejor reservar hamaca en julio-agosto; los atardeceres con DJ valen la pena.', cat: 'bar', lat: 37.2410, lng: -1.7895 , featured: true },
