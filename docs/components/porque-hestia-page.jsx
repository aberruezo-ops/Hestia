...
const PORQUE_COPY = {
  es: {
    ...
    values: [
      ...
      { letter: 'I', name: 'Integridad',   desc: 'Lo que prometemos al reservar es lo que entregamos al abrir la puerta. Diseñamos cada Hestía como si fuera nuestra propia casa: porque, en cierto modo, lo es. El cojín bien puesto, el café que espera, la toalla doblada.' },
    ...
    travelers: [
      ...
      { icon: '🔄', t: 'Vuelve. Y trae a alguien.', d: 'Cuando encuentra un lugar donde se ha sentido en casa, vuelve. Y convierte a otros en ese mismo tipo de huésped.' },
    ],
  ...
  en: {
    ...
    values: [
      ...
      { letter: 'I', name: 'Integrity',    desc: 'What we promise at booking is what we hand over when the door opens. We design every Hestía as if it were our own home, because in a way it is. The neatly placed cushion, the waiting coffee, the folded towel.' },
