...
const PORQUE_COPY = {
  es: {
    ...
    logo_title: (<>Una H que es hogar.<em> Columnas, hojas y olas.</em></>),
    logo_p1: 'Las dos columnas verticales de la H sostienen tu hogar, tu refugio. Entre ellas, las hojas de los olivos y de la flora que rodea este pintoresco lugar. Y las hojas del mar — esas olas que forman el tejado de tu hogar.',
    logo_p2: 'Tu cobijo está así preparado para ti.',
    logo_sym_1_t: 'Las columnas',
    logo_sym_1_d: 'Dos pilares que sostienen el hogar y el refugio. La estabilidad que espera siempre encendida.',
    logo_sym_2_t: 'Las hojas de olivo',
    logo_sym_2_d: 'La flora que rodea este lugar: el olivar, la naturaleza almeriense, lo que abraza la casa antes de llegar al mar.',
    logo_sym_3_t: 'Las olas — el tejado',
    logo_sym_3_d: 'Las hojas del mar forman el tejado. El Mediterráneo a 300 m cierra y cobija el espacio que es tuyo.',
  ...
  en: {
    ...
    logo_title: (<>An H that is home.<em> Columns, leaves and waves.</em></>),
    logo_p1: 'The two vertical columns of the H hold up your home, your refuge. Between them, the leaves of the olive trees and the flora that surrounds this place. And the leaves of the sea — those waves that form the roof of your home.',
    logo_p2: 'Your shelter is ready and waiting for you.',
    logo_sym_1_t: 'The columns',
    logo_sym_1_d: 'Two pillars that hold up the home and the refuge. The stability that is always there, always lit.',
    logo_sym_2_t: 'The olive leaves',
    logo_sym_2_d: 'The flora that surrounds this place: the olive grove, the Almerian landscape, what embraces the house before you reach the sea.',
    logo_sym_3_t: 'The waves — the roof',
    logo_sym_3_d: 'The leaves of the sea form the roof. The Mediterranean 300 m away closes and shelters the space that is yours.',
