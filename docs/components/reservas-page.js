...
const LsInfoBlock = ({
  ...
  }, /*#__PURE__*/React.createElement("li", null, es ? 'Contrato de arrendamiento de temporada' : 'Seasonal rental agreement'), /*#__PURE__*/React.createElement("li", null, es ? 'Señal del 20% para confirmar · resto a convenir, a la llegada' : '20% deposit to confirm · balance on arrival, to be agreed'), /*#__PURE__*/React.createElement("li", null, es ? `${nights} noches, tarifa mensual` : `${nights} nights, monthly rate`), /*#__PURE__*/React.createElement("li", null, es ? 'Sin comisiones de plataformas' : 'No platform commissions')), /*#__PURE__*/React.createElement("a", {
