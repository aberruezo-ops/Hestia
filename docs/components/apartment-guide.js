  ...
  vm: {
    ...
    en: {
      ...
      rooms: [{
        ...
        id: 'urbanizacion',
        title: 'Your complex',
        body: 'Your complex is textile-free. Your underground parking space is nº 160, on floor -2. You also have outdoor parking and a pedestrian entrance (nº 14, 1.A) on ground floor. In your complex you can also enjoy the pool and jacuzzi on floor -2, where there is a pedestrian shortcut to the beach and green areas.',
...
const CompactPlaceItem = ({
  ...
  const hasDetails = p.desc || p.specialty || p.best || p.tip || p.services || p.access || p.level || p.url || Array.isArray(p.events) && p.events.length > 0;
  ...
  }, p.access), p.level && /*#__PURE__*/React.createElement("span", {
...
const PlacesOfInterestAtlas = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      "aria-hidden": "true"
    }, sc.icon), /*#__PURE__*/React.createElement("span", null, lang === 'es' ? sc.es : sc.en), /*#__PURE__*/React.createElement("span", {
...
const Top5BeachesBand = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("em", null, lang === 'es' ? 'Servicios:' : 'Services:'), " ", p.services), p.access && /*#__PURE__*/React.createElement("span", {
      className: "ag-top5-meta"
    }, /*#__PURE__*/React.createElement("em", null, lang === 'es' ? 'Acceso:' : 'Access:'), " ", p.access), /*#__PURE__*/React.createElement("div", {
...
const AptGuideView = ({
  ...
  return /*#__PURE__*/React.createElement("article", {
    ...
    "aria-hidden": "true"
  }, rule.icon), /*#__PURE__*/React.createElement("div", {
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Pueblos blancos, castillos, yacimientos y festivales. Cada lugar con sus atractivos principales, recomendaciones y las fiestas que merece la pena coincidir.' : 'White villages, castles, archaeological sites and festivals. Each place with its highlights, recommendations and festivals worth timing your visit with.'), /*#__PURE__*/React.createElement(EventsCalendar, {
    lang: lang
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Las mejores playas y calas, desde las más accesibles a las más vírgenes que exigen caminar un rato. Servicios, acceso y la mejor hora para ir en cada época del año.' : 'The best beaches and coves, from the easily accessible to the wild ones that require a walk. Services, access and the best hour to visit in each season.'), /*#__PURE__*/React.createElement(Top5BeachesBand, {
    places: PLACES,
    lang: lang
    ...
    className: "ag-para"
  }, lang === 'es' ? 'El calendario semanal de mercadillos de la zona y los mejores sitios para llevarte un recuerdo: cerámica de Níjar, jarapas, aceite local.' : 'Weekly street markets in the area and the best places for souvenirs: Níjar ceramics, traditional rugs, local olive oil.'), SECTION_CATS.mercados.map(catId => {
    const cat = CATEGORIES.find(c => c.id === catId);
    if (!cat) return null;
    const inCat = PLACES.filter(p => p.cat === catId);
    if (!inCat.length) return null;
