...
const AptGuideView = ({
  ...
  return /*#__PURE__*/React.createElement("article", {
    ...
    key: i
  }, r)))), a.rooms.map((room, idx) => /*#__PURE__*/React.createElement("section", {
    key: room.id,
    id: `ag-${room.id}`,
    className: `ag-section ag-room ag-room-${room.id}`
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-section-num"
  }, String(idx + 5).padStart(2, '0')), /*#__PURE__*/React.createElement("h2", {
    className: "ag-h2"
    ...
    className: "ag-section-num"
  }, "11"), /*#__PURE__*/React.createElement("h2", {
    className: "ag-h2"
