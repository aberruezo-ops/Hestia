...
const DayPlanCard = ({
  ...
  }, s[`d_${lang}`]))))), tip && /*#__PURE__*/React.createElement("div", {
    className: "dp-tip"
  }, /*#__PURE__*/React.createElement("span", {
...
const DayPlans = ({
  ...
  }, lang === 'es' ? 'Estos son solo ideas — hay innumerables opciones para todos los gustos. Los horarios son orientativos: dependen tanto de vuestras necesidades como de las posibles excursiones o actividades que decidáis contratar. Os animamos a descubrir, vivir Vera y Hestía a vuestro propio ritmo.' : 'These are just ideas — there are countless options for every taste. The times are approximate: they depend on your own needs and on any excursions or activities you may book. We invite you to discover, to live Vera and Hestía at your own pace.')), /*#__PURE__*/React.createElement("div", {
    className: "dp-tabs",
    role: "tablist"
  ...
  }, t[lang]))), Object.entries(DAY_PLAN_GROUPS).map(([type, group]) => {
