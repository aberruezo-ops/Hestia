...
const ROOM_PHOTOS = {
  vm: {
    salon: [0, 1, 2, 19, 20, 21],
    // 'Salón · ...' (19=lámpara sofá, movida desde urbanización)
    cocina: [5, 6, 7],
    // 'Cocina · ...'
    dormitorios: [8, 9, 23],
    // 8=Dorm 2 turquesa, 9=Dorm principal, 23=Dorm principal lámpara globo
    banos: [13, 14, 15],
    // 13=Baño 1 LED verde, 14/15=Baño 2 (16=Piscina movido a urbanización)
    terraza: [11, 12],
...
const GUIDE_SECTIONS = [{
  ...
  id: 'registro',
  es: 'Registro de viajeros',
  en: 'Traveller registration'
}, {
  id: 'previaje',
  es: 'Información sobre dónde está Hestía',
  en: 'Information about where Hestía is located'
}, {
  id: 'tiempo',
  es: 'El tiempo que te espera',
  en: 'The weather that awaits you'
}, {
  id: 'expectativas',
  es: 'Qué puedes esperar de Hestía',
  en: 'What you can expect from Hestía'
}, {
  id: 'llegada',
  es: 'Comienza tu viaje hasta Hestía',
  en: 'Your journey to Hestía begins'
}, {
  id: 'wifi',
  es: 'Tu WiFi',
  en: 'Your WiFi'
  ...
  id: 'descuentos',
  es: 'Recomendados con descuento',
  en: 'Recommended, with a discount'
}, {
  id: 'feedback',
  es: 'Tu salida de Hestía',
  en: 'Your departure from Hestía'
}];
...
const GUIDE_GROUPS = [{
  ...
  es: 'Cosas para disfrutar la zona',
  en: 'Things to enjoy around the area',
  ...
  es: 'Otros servicios y ayuda',
  en: 'Other services & help',
...
const ARRIVAL_EATS = {
  es: {
    ...
    routes: [{
      ...
      stops: [{
        name: 'Arrocería El Grano de Oro',
        town: 'Albatera (Alicante) · a ~2 h',
        note: 'Arroces al horno y paellas a la brasa de sarmiento. Pide el arroz con conejo.',
        q: 'Arrocería El Grano de Oro Albatera'
      }, {
        name: 'Tapeo en el centro',
        town: 'Murcia · a ~1 h',
        note: 'Plaza de las Flores y Santo Domingo: marinera, zarangollo y michirones.',
        q: 'Plaza de las Flores Murcia tapas'
      }, {
        name: 'La Cofradía',
        town: 'Lorca · a ~50 min',
      ...
      stops: [{
        name: 'Mesón Granadul I',
        town: 'Guadix · a ~1 h 40',
        note: 'Jamón y quesos de la zona, cocina mediterránea; también venden producto para llevar.',
        q: 'Mesón Granadul Guadix A-92'
      }, {
        name: 'Los Cántaros / La Parra',
        town: 'Baza · a ~1 h 10',
      ...
      stops: [{
        ...
        note: 'Arrocería en el paseo marítimo: arroz del señorito, meloso con bogavante.',
        q: 'Akalá arrocería Almería'
      }, {
        name: 'La Encina',
        town: 'Almería capital · a ~1 h',
  ...
  en: {
    ...
    routes: [{
      ...
      stops: [{
        name: 'Arrocería El Grano de Oro',
        town: 'Albatera (Alicante) · ~2 h away',
        note: 'Oven-baked rice and wood-fired paellas. Try the rice with rabbit.',
        q: 'Arrocería El Grano de Oro Albatera'
      }, {
        name: 'Tapas in the old town',
        town: 'Murcia · ~1 h away',
        note: 'Plaza de las Flores and Santo Domingo: marinera, zarangollo and michirones.',
        q: 'Plaza de las Flores Murcia tapas'
      }, {
        name: 'La Cofradía',
      ...
      stops: [{
        ...
        note: 'Local ham and cheese, Mediterranean cooking; they also sell produce to take away.',
        q: 'Mesón Granadul Guadix A-92'
      }, {
        name: 'Los Cántaros / La Parra',
      ...
      stops: [{
        ...
        note: 'Seafront rice restaurant: arroz del señorito, soupy rice with lobster.',
        q: 'Akalá arrocería Almería'
      }, {
        name: 'La Encina',
        town: 'Almería city · ~1 h away',
...
const EMERGENCY_CARDS = [{
  ...
  es: {
    ...
    steps: ['Sal del agua y no frotes la zona.', 'Retira los restos de tentáculo con el borde de una tarjeta o unas pinzas, nunca con la mano desnuda.', 'Enjuaga con agua de mar (nunca con agua dulce ni con orina, un mito que no funciona y puede empeorarlo).', 'Si tienes agua caliente a mano (no quemando, unos 40°), sumerge la zona 20-30 min: alivia bastante el dolor.'],
  ...
  en: {
    ...
    steps: ['Get out of the water and avoid rubbing the area.', 'Remove any tentacle remains with the edge of a card or tweezers, never with your bare hand.', 'Rinse with seawater (never fresh water or urine, a myth that does not work and can make it worse).', 'If you have warm water at hand (warm, not scalding, around 40°), soak the area 20-30 min: it eases the pain a lot.'],
  ...
  es: {
    ...
    steps: ['Si ha quedado el aguijón, retíralo raspando con una tarjeta (no lo aprietes con los dedos, inyecta más veneno).', 'Lava con agua y jabón y aplica frío local (hielo envuelto en un paño) para bajar la hinchazón y el picor.', 'Un antihistamínico oral, si tenéis, ayuda con la reacción local.', 'Las arañas realmente peligrosas son muy raras por aquí: lo habitual es escozor local que pasa en un día o dos.'],
  ...
  en: {
    ...
    steps: ['If the stinger is still in, scrape it out with a card (do not pinch it out, that injects more venom).', 'Wash with soap and water and apply local cold (ice wrapped in a cloth) to bring down swelling and itching.', 'An oral antihistamine, if you have one, helps with the local reaction.', 'Genuinely dangerous spiders are very rare around here: the usual outcome is local soreness that fades in a day or two.'],
  ...
  es: {
    ...
    steps: ['Con dolor de cabeza, mareo, sudoración intensa o náuseas: es agotamiento por calor. Lleva a la persona a la sombra o a un sitio fresco, afloja la ropa y ofrece agua a sorbos.', 'Paños húmedos y fríos en cuello, nuca, muñecas e ingles ayudan a bajar la temperatura más rápido.', 'El golpe de calor es distinto y más grave: piel muy caliente pero seca (deja de sudar), confusión o desorientación.'],
  ...
  en: {
    ...
    steps: ['Headache, dizziness, heavy sweating or nausea: that is heat exhaustion. Move the person to shade or somewhere cool, loosen clothing and offer small sips of water.', 'Cool, damp cloths on the neck, wrists and groin help bring the temperature down faster.', 'Heatstroke is different and more serious: skin that is very hot but dry (sweating stops), confusion or disorientation.'],
  ...
  es: {
    ...
    steps: ['Si alguien nota que se marea y va a desmayarse, siéntalo con la cabeza entre las rodillas o túmbalo con las piernas elevadas.', 'Afloja ropa ajustada (cuello, cinturón) y dale aire.', 'Si se recupera sola en segundos, sin golpe en la caída y sin otros síntomas, no suele ser grave: que descanse y beba agua.'],
  ...
  en: {
    ...
    steps: ['If someone feels faint and about to pass out, sit them down with their head between their knees, or lay them down with legs raised.', 'Loosen tight clothing (collar, belt) and let them get some air.', 'If they come round on their own within seconds, did not hit their head falling and have no other symptoms, it is usually not serious: let them rest and drink water.'],
...
const CATEGORIES = [{
  ...
  id: 'fish',
  es: 'Producto fresco · pescado, carne, pan',
  en: 'Fresh produce · fish, meat, bread',
  color: 'var(--sol-text)',
  icon: '🐟'
}, {
  id: 'pharmacy',
  ...
  id: 'health',
  es: 'Centros de salud y urgencias',
  en: 'Health centres & ER',
  color: 'var(--err)',
  icon: '🏥'
}, {
  id: 'vet',
  ...
  id: 'pet-board',
  es: 'Guarderías y residencias de animales',
  ...
  id: 'ev-charge',
  es: 'Puntos de carga eléctrica',
  en: 'EV charging points',
  color: 'var(--teal-dk)',
  icon: '🔌'
}, {
  id: 'coworking',
  es: 'Coworking y teletrabajo',
  en: 'Coworking & remote work',
  color: 'var(--vt-dk)',
  icon: '💻'
}, {
  id: 'laundry',
  es: 'Lavanderías y tintorerías',
...
const iconifyText = (text, size = 14) => {
  ...
  while (m = GUIDE_EMOJI_RE.exec(text)) {
    ...
    out.push(/*#__PURE__*/React.createElement(HiIcon, {
      key: `i${k++}`,
      name: name,
      size: size,
      style: {
...
{
  id: 'iceland-vera',
  name: 'Iceland Overseas (Vera Playa)',
  desc: 'Supermercado británico junto al complejo Vera Natura. Productos congelados, ready meals, té, salsas y dulces típicos de UK.',
  ...
  desc: 'Supermercado británico clásico de la Costa Almería. Surtido amplio de marcas UK que no encuentras en supermercado español.',
  specialty: 'embutidos ingleses (sausages, bacon Wiltshire), pasteles, panes especiales, repostería casera.',
  cat: 'super',
  lat: 37.1450,
  lng: -1.8540
}, {
  ...
  specialty: 'productos alemanes (cerveza, embutidos, dulces) y precios bajos en básicos.',
  cat: 'super',
  lat: 37.2491,
  lng: -1.8639
},
...
// Restaurantes
{
  ...
  desc_en: 'Moroccan, in the Sierra Cabrera hills. A mountain road, but well worth it.',
  ...
  desc_en: 'Upscale. Chef-driven cooking in Vera village.',
  ...
  desc_en: 'Modern Spanish cooking in Vera village. A house with history.',
  ...
  desc_en: 'Garrucha. The pizzas are excellent.',
  ...
  desc_en: 'Upscale. Better for dinner or a drink.',
  ...
  desc_en: 'Facing Hestía Vera Mar. Thoughtful small plates, easy-going atmosphere.',
  ...
  desc_en: 'Right on the beach, a 10-minute walk.',
  ...
  desc_en: 'Villaricos. Excellent lobster paella.',
  ...
  desc_en: 'Villaricos. Seafood cooking with the day\'s catch.',
  ...
  desc_en: 'Next to Garrucha\'s fish market. Ultra-fresh seafood and a fishing-village feel.',
  ...
  desc_en: 'Garrucha. Harbour views, focused on fish straight from the market.',
  ...
  desc: 'Detrás del Consum: pubs, comida rápida y más.',
  desc_en: 'Behind the Consum supermarket: pubs, fast food and more.',
  cat: 'restaurant',
  lat: 37.2196,
  lng: -1.8082
}, {
  ...
  desc_en: 'Vera Playa. Right on the sand, no-frills atmosphere.',
...
// Mojácar
{
  id: 'titos-mojacar',
  name: "Tito's (Mojácar)",
  desc: 'Mojácar Pueblo. Tapas y carta tradicional con producto local. Imprescindible.',
  desc_en: 'Mojácar village. Tapas and a traditional menu with local produce. A must.',
  specialty: 'rabo de toro, croquetas de jamón y atún encebollado.',
  tip: 'Reserva con días de antelación en verano, siempre llena.',
  tier: '€€',
  rating: 4.6,
  cat: 'restaurant',
  lat: 37.1380,
  ...
  id: 'acebuche',
  name: 'El Acebuche (Mojácar)',
  desc: 'Recomendado por Guía Repsol y Bib Gourmand. Cocina almeriense actualizada.',
  desc_en: 'Recommended by Guía Repsol and Bib Gourmand. Updated Almería cooking.',
  specialty: 'menú degustación con producto de proximidad, pescados de Garrucha y verduras del huerto.',
  tier: '€€€',
  rating: 4.7,
  cat: 'restaurant',
  lat: 37.1373,
...
// Vera pueblo
{
  id: 'casa-egea',
  name: 'Casa Egea (Vera)',
  desc: 'Vera pueblo. Cocina tradicional con producto del Levante almeriense.',
  desc_en: 'Vera village. Traditional cooking with Almería Levante produce.',
  specialty: 'fritura de pescaíto, arroz a banda y postres caseros.',
  tier: '€€',
  rating: 4.6,
  cat: 'restaurant',
  lat: 37.2494,
  ...
  id: 'regio-restaurante',
  name: 'Regio (Vera)',
  desc: 'Vera pueblo. Casa de comidas con platos de cuchara y arroces.',
  desc_en: 'Vera village. Home-style cooking, stews and rice dishes.',
  specialty: 'olla de trigo, gurullos con conejo y arroz caldoso.',
  tier: '€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 37.2487,
...
{
  id: 'almejero',
  name: 'El Almejero (Garrucha)',
  desc: 'Garrucha. Frente al puerto, especialista en marisco y arroces. Bib Gourmand.',
  desc_en: 'Garrucha. Facing the harbour, specialist in shellfish and rice dishes. Bib Gourmand.',
  specialty: 'arroz caldoso con bogavante, gamba roja a la plancha y almejas a la marinera.',
  tip: 'Mejor a mediodía con la luz del puerto.',
  tier: '€€€',
  rating: 4.6,
  cat: 'restaurant',
  lat: 37.1820,
...
{
  id: 'gallineta',
  name: 'La Gallineta (Pozo de los Frailes)',
  desc: 'Pozo de los Frailes. Uno de los más reputados del Parque Natural. Reserva imprescindible.',
  desc_en: 'Pozo de los Frailes. One of the most respected in the Natural Park. Booking essential.',
  specialty: 'menú degustación de pescado del día y atún rojo de almadraba.',
  tip: 'Reserva con 1-2 semanas de antelación en temporada.',
  tier: '€€€',
  rating: 4.7,
  cat: 'restaurant',
  lat: 36.7860,
  ...
  desc: 'San José. Clásico de pescado y marisco a buen precio.',
  specialty: 'fritura de pescaíto, arroz marinero y gamba roja.',
  tier: '€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 36.7665,
...
{
  id: 'chumbera',
  name: 'Asador La Chumbera (Sopalmo)',
  desc: 'Entre Mojácar y Agua Amarga. Cocina al fuego con vistas espectaculares al mar.',
  desc_en: 'Between Mojácar and Agua Amarga. Fire-cooked food with spectacular sea views.',
  specialty: 'cordero al horno de leña, lubina a la sal y chuletón de ternera.',
  tip: 'Atardecer en la terraza, una de las mejores panorámicas de la costa.',
  tier: '€€€',
  rating: 4.6,
  cat: 'restaurant',
  lat: 37.0410,
...
// ── Guía Michelin 2025 ── Almería ──────────────────────────────
{
  ...
  desc_en: 'Almería city. Cooking in motion: a menu that changes with the season\'s local produce.',
  ...
  desc_en: 'Almería city, old town. A former grill house reborn: renovated Castilian-style rooms, with a large monochrome octopus mural.',
  ...
  desc_en: 'Almería city. "Love for cooking", a vocation since the chef\'s childhood. Mediterranean base with touches of Japan, Mexico, Peru and Holland.',
  ...
  desc_en: 'Almería city, residential area. Chef Dani Muñoz: creative contemporary cooking with seasonal, local produce.',
  ...
  desc_en: 'Agua Amarga, Níjar. A villa with several Mediterranean dining rooms and a terrace with a pool. Contemporary menu built around the grill.',
  ...
  desc_en: 'Almería city. Shares kitchen and cellar with La Costa (⭐ Michelin Star). Bar plus tableclothless tables, contemporary dishes in half portions.',
...
// ── Guía Michelin 2025 ── Murcia ───────────────────────────────
{
  ...
  desc_en: 'El Palmar (Murcia). ⭐⭐ Two Michelin Stars, the only one in the region. Chef Pablo González-Conejero.',
  ...
  desc_en: 'Murcia city. ⭐ Michelin Star. Chef Juan Guillamón. Mediterranean market cooking over two floors with floor-to-ceiling windows.',
  ...
  desc_en: 'Murcia city. ⭐ Michelin Star (new in 2025). Chefs Marco Antonio Iniesta and María Egea. Every dish is a "sentence" telling a local story.',
  ...
  desc_en: 'Yecla. ⭐ Michelin Star (new in 2025, Yecla\'s first). Chef Alejandro Ibáñez. Terroir cooking amid the Señorío de Barahonda vineyards.',
...
// ── Guía Michelin 2025 ── Granada ──────────────────────────────
{
  ...
  desc_en: 'Loja (Granada/Málaga). ⭐ Michelin Star. Chef Fernando Arjona. Barceló La Bobadilla resort, deep in the mountains.',
  ...
  desc_en: 'Granada city, Cuesta de Gomérez (at the foot of the Alhambra). Recommended 2025 · ⭐ Michelin Star 2026. Chef Cristina Jiménez.',
  ...
  desc_en: 'Granada city, a 19th-century mansion. Bib Gourmand. Chef Chechu González. Modern Granada cooking built on sauces, acidity and seasonality.',
  ...
  desc_en: 'Granada city. Recommended. Since 1985. Francisco Martín: a seafood bar with a direct line to the Motril fish market.',
  ...
  desc_en: 'Calahonda (Gualchos, Granada coast). Recommended. Antonio and Daniel Lorenzo. A fine-dining room plus a tavern for small plates.',
...
// Almería capital desc: 'Cocina vasca-mediterránea de autor. Recomendado por Guía Michelin.', specialty: 'menú degustación con producto de mercado, pescados a la brasa.', tier: '€€€€', rating: 4.7, cat: 'restaurant', lat: 36.8395, lng: -2.4635, featured: true },
{
  ...
  desc_en: 'Historic tavern founded in 1870. A temple of the Almería tapa.',
  specialty: 'tapas tradicionales: caracoles, ensaladilla y tortilla del Sacromonte.',
  tip: 'Sin reservas, llega antes de las 13:30 o sobre las 20:00 para evitar cola.',
  tier: '€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 36.8395,
  ...
  id: 'tetería',
  name: 'Tetería Almedina (Almería capital)',
  desc: 'Barrio Almedina. Cocina marroquí auténtica en el casco antiguo.',
  specialty: 'tagine de cordero, cuscús casero y té con menta.',
  tier: '€€',
  rating: 4.6,
  cat: 'restaurant',
  lat: 36.8400,
  ...
  id: 'torreluz-med',
  name: 'Torreluz Mediterráneo (Almería capital)',
  desc: 'En Plaza Flores. Cocina mediterránea con producto de mercado.',
  specialty: 'arroces marineros, atún rojo y carrillera de ternera.',
  tier: '€€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 36.8392,
  ...
  id: 'salmantice',
  name: 'Salmantice (Almería capital)',
  desc: 'Asador castellano-leonés. Carnes a la brasa de primera.',
  specialty: 'chuletón de buey, lechazo asado y embutidos ibéricos.',
  tier: '€€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 36.8378,
...
{
  id: 'magoga',
  name: 'Magoga (Cartagena)',
  desc: 'Cartagena. ⭐ Estrella Michelin. Cocina murciana de alta gama.',
  desc_en: 'Cartagena. ⭐ Michelin Star. High-end Murcian cooking.',
  specialty: 'menú degustación con producto del Mar Menor y huerta murciana.',
  tip: 'Reserva con 3-4 semanas, es de lo mejor del Sureste.',
  tier: '€€€€',
  rating: 4.7,
  cat: 'restaurant',
  lat: 37.6017,
  ...
  id: 'marquesita',
  name: 'La Marquesita (Cartagena)',
  desc: 'Cartagena. Clásico imprescindible junto al teatro romano.',
  specialty: 'caldero del Mar Menor, dorada a la sal y arroz con bogavante.',
  tier: '€€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 37.6030,
  ...
  id: 'san-roque',
  name: 'El Barrio de San Roque (Cartagena)',
  desc: 'Cartagena. Cocina tradicional con producto de la lonja.',
  specialty: 'michirones, marineras y arroz caldero.',
  tier: '€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 37.6042,
  ...
  id: 'el-faro-aguilas',
  name: 'El Faro (Águilas)',
  desc: 'Águilas. A pie de puerto. Famoso por el arroz caldero murciano.',
  desc_en: 'Águilas. Right by the harbour. Famous for Murcian caldero rice.',
  specialty: 'arroz caldero, salmonete y dorada a la sal.',
  tier: '€€€',
  rating: 4.6,
  cat: 'restaurant',
  lat: 37.4070,
  ...
  id: 'juan-mari',
  name: 'Juan Mari (Águilas)',
  desc: 'Águilas. Cocina marinera con producto del día.',
  specialty: 'lubina al horno, arroces y mariscada.',
  tier: '€€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 37.4065,
  ...
  id: 'casino-lorca',
  name: 'Asador Casino de Lorca',
  desc: 'Lorca. Comedor histórico dentro del Casino. Cocina murciana actualizada.',
  specialty: 'arroces secos, cordero segureño y verduras de la huerta.',
  tier: '€€€',
  rating: 4.5,
  cat: 'restaurant',
  lat: 37.6770,
...
// Restaurantes celíacos (con menú o platos sin gluten certificados)
{
  ...
  desc_en: 'Walking distance, or 5 min by car.',
  ...
  desc_en: 'Three safe bets on Mojácar\'s seafront.',
  ...
  desc_en: 'Central Vera: three reliable spots with gluten-free options.',
...
// Copas y chiringuitos
{
  ...
  desc_en: 'Walking distance from home. Family atmosphere by day, drinks at sunset.',
  ...
  desc_en: 'Walking distance from home. Chill music from mid-afternoon.',
  ...
  desc_en: 'Walking distance from home. The most laid-back spot on the promenade.',
  ...
  desc_en: 'Beach club with DJ and a sea-view sunbed area.',
  ...
  desc_en: 'Small and very local, right on the sand.',
  ...
  desc_en: 'Right on the beach, a 10-minute walk. Wide Mediterranean views.',
  ...
  desc_en: 'Beer, shellfish and a view of the fishing harbour.',
...
{
  id: 'cantares',
  name: 'Cantares (Mojácar Pueblo)',
  desc: 'Plaza Nueva. Terraza con vistas al valle, ambiente bohemio.',
  desc_en: 'Plaza Nueva. Terrace with valley views, bohemian atmosphere.',
  specialty: 'vermut con tapa, tabla ibérica y cócteles al atardecer.',
  tip: 'Reserva mesa con vistas al valle, el atardecer es brutal.',
  rating: 4.5,
  cat: 'bar',
  lat: 37.1380,
  lng: -1.8525,
  ...
  id: 'mandala',
  name: 'Mandala (Mojácar Pueblo)',
  desc: 'Coctelería de autor en el casco antiguo.',
  specialty: 'gin tonics premium y mezcales mexicanos.',
  rating: 4.5,
  cat: 'bar',
  lat: 37.1378,
  lng: -1.8522
...
{
  id: 'cafe-bahia',
  name: 'Café Bahía (Vera pueblo)',
  desc: 'Plaza Mayor. Aperitivo clásico con tapa.',
  desc_en: 'Plaza Mayor. A classic aperitif with tapas.',
  specialty: 'caña con tapa de jamón ibérico de la zona.',
  rating: 4.4,
  cat: 'bar',
  lat: 37.2491,
  lng: -1.8639
...
// San José
{
  ...
  desc: 'San José. Música en vivo y ambiente de Cabo de Gata.',
  specialty: 'cervezas artesanas locales y tapas marineras.',
  rating: 4.5,
  cat: 'bar',
  lat: 36.7665,
  lng: -2.1080
...
{
  id: 'la-mala',
  name: 'La Mala (Almería capital)',
  desc: 'Centro histórico. Coctelería referente de la capital.',
  desc_en: 'Historic centre. The capital\'s go-to cocktail bar.',
  specialty: 'cócteles de autor: Negroni clarificado, Old Fashioned con PX.',
  tip: 'Mejor a partir de las 22:00; antes está más tranquilo.',
  rating: 4.7,
  cat: 'bar',
  lat: 36.8395,
  lng: -2.4625,
  ...
  id: 'tetería-cap',
  name: 'Tetería La Almedina Cafés (Almería)',
  desc: 'Casco antiguo. Té marroquí y dulces árabes.',
  specialty: 'té con menta, pastelería árabe y cuscús dulce.',
  rating: 4.6,
  cat: 'bar',
  lat: 36.8398,
  lng: -2.4688
  ...
  id: 'jovellanos',
  name: 'Jovellanos 16 (Almería capital)',
  desc: 'Tapeo de calidad en el centro. Producto y elaboración.',
  specialty: 'croquetas líquidas, atún rojo crujiente y bao de cochinita.',
  rating: 4.6,
  cat: 'bar',
  lat: 36.8380,
  lng: -2.4615
...
{
  id: 'columbares',
  name: 'Columbares (Cartagena)',
  desc: 'Plaza San Sebastián. Tapas creativas y vermuts.',
  desc_en: 'Plaza San Sebastián. Creative tapas and vermouth.',
  specialty: 'marinera, michirón y zarangollo.',
  rating: 4.6,
  cat: 'bar',
  lat: 37.6020,
  lng: -0.9885,
  ...
  id: 'el-zorro',
  name: 'El Zorro Pub (Cartagena)',
  desc: 'Coctelería junto al puerto. Carta extensa.',
  specialty: 'gin tonics de autor y combinados premium.',
  rating: 4.5,
  cat: 'bar',
  lat: 37.5995,
  lng: -0.9810
...
{
  id: 'mar-menuda',
  name: 'La Mar Menuda (Águilas)',
  desc: 'Águilas. Coctelería frente al mar.',
  specialty: 'mojitos, vermut casero y tapeo marinero.',
  rating: 4.5,
  cat: 'bar',
  lat: 37.4080,
  lng: -1.5785
...
{
  id: 'lonja-garrucha',
  name: 'Lonja de Garrucha (subasta)',
  desc: 'Una de las lonjas más activas del Mediterráneo español. Subasta diaria de marisco y pescado de barco, se puede ver el espectáculo desde la cristalera.',
  specialty: 'gamba roja de Garrucha (la mejor del Mediterráneo), quisquilla, conchas finas, gallineta.',
  ...
  id: 'mercado-vera',
  name: 'Mercado de abastos (Vera pueblo)',
  ...
  id: 'el-mero',
  name: 'Pescadería El Mero (Garrucha)',
  desc: 'Junto a la lonja. Una de las pescaderías de referencia de Garrucha.',
  specialty: 'gamba roja recién subastada, lubinas y doradas salvajes, mariscos del día.',
  cat: 'fish',
  url: 'https://goo.gl/maps/AdJz6SEyGRvLeToDA',
  lat: 37.1815,
  lng: -1.8235,
  featured: true
}, {
  id: 'isabel',
  name: 'Pescados y Mariscos Isabel (Garrucha)',
  desc: 'Pescadería pequeña pero con mucho oficio.',
  specialty: 'pescado para horno (besugo, dorada), pulpo cocido y conserva casera de mojama.',
  cat: 'fish',
  url: 'https://goo.gl/maps/RHCieMNkgo3FL8m5A',
  lat: 37.1820,
  lng: -1.8240
}, {
  id: 'pescados-online',
  name: 'Pescados Garrucha (online)',
  desc: 'Servicio de pescado y marisco online, entrega en Vera Playa el mismo día.',
  specialty: 'gamba roja de Garrucha empacada en hielo, lista para comer o congelar.',
  tip: 'Útil si quieres llevarte producto a casa al final de la estancia.',
  cat: 'fish',
  url: 'https://pescadosgarrucha.es/',
  lat: 37.1815,
  lng: -1.8230
}, {
  id: 'pescaderia-vera',
  name: 'Pescadería Hermanos Quintana (Vera pueblo)',
  desc: 'Tradicional, de las pescaderías de toda la vida en Vera. Producto fresco diario.',
  specialty: 'pescado del día y marisco a precio razonable.',
  cat: 'fish',
  lat: 37.2493,
  lng: -1.8633
},
...
{
  id: 'carniceria-rey',
  name: 'Carnicería Rey (Vera pueblo)',
  desc: 'Carnicería de confianza con carne de la Sierra de los Filabres y cordero segureño.',
  specialty: 'cordero segureño (IGP), chuletón de vaca madurada, embutidos artesanos.',
  tip: 'Pide con un día de antelación si quieres cordero entero o piezas grandes.',
  cat: 'fish',
  lat: 37.2490,
  lng: -1.8635,
  featured: true
}, {
  id: 'carniceria-garrucha',
  name: 'Carnicería Hermanos López (Garrucha)',
  desc: 'Carnicería con producto local y embutidos curados en la sierra.',
  specialty: 'morcilla de Vera, jamón ibérico de Las Alpujarras, chorizo casero.',
  cat: 'fish',
  lat: 37.1818,
  lng: -1.8233
}, {
  id: 'jamoneria-vera',
  name: 'Jamonería Sierra Almería (Vera)',
  desc: 'Especialista en ibéricos y jamones de toda España. Cortan al momento.',
  specialty: 'jamón ibérico de bellota, lomo embuchado, chorizo cular y caña de lomo.',
  tip: 'Se puede comprar jamón cortado a cuchillo y envasado al vacío para llevar a casa.',
  cat: 'fish',
  lat: 37.2495,
  lng: -1.8636
}, {
  id: 'panaderia-vera',
  name: 'Panadería La Viña (Vera pueblo)',
  desc: 'Panadería tradicional con horno de leña.',
  specialty: 'pan de Cuevas, mollete almeriense, ensaimadas y empanadillas saladas.',
  tip: 'Llega antes de las 11:00, el pan de Cuevas se acaba pronto.',
  cat: 'fish',
  lat: 37.2491,
  lng: -1.8637
}, {
  ...
  desc: 'Quesos artesanos de cabra y oveja de la Sierra de María-Los Vélez.',
  specialty: 'queso de cabra al romero, oveja semicurado y manchego de los Vélez.',
  tip: 'Pídelo en queserías de Vera o ve directamente al obrador en Vélez-Rubio.',
  cat: 'fish',
  lat: 37.6520,
  lng: -2.0760
},
...
{
  id: 'cs-vera',
  name: 'Centro de Salud de Vera (base 061)',
  ...
  id: 'cs-garrucha',
  name: 'Centro de Salud de Garrucha',
  ...
  cat: 'health',
  url: 'https://www.google.com/maps/search/?api=1&query=Centro+de+Salud+Garrucha',
  lat: 37.1815,
  lng: -1.8240
}, {
  id: 'cs-mojacar-playa',
  name: 'Centro de Salud de Mojácar Playa',
...
{
  id: 'vet-garrucha',
  name: 'Clínica Veterinaria Garrucha (24h)',
  ...
  cat: 'vet',
  url: 'https://www.google.com/maps/search/?api=1&query=Clinica+Veterinaria+Costa+Indalo+Mojacar',
  lat: 37.1380,
  lng: -1.8500
},
// ==========================================================
...
{
  id: 'pet-vera',
  name: 'Hotel Residencia Canina-Felina Vera (Llanos de Rosa)',
  ...
  cat: 'pet-board',
  url: 'https://www.hotelcaninovera.es/',
  lat: 37.2480,
  lng: -1.8400,
  featured: true,
  featuredOrder: 1,
  ...
  id: 'pet-mojacar',
  name: 'Residencia Canina Mojácar',
  ...
  cat: 'pet-board',
  url: 'https://www.residenciacaninamojacar.com/',
  lat: 37.1350,
  lng: -1.8550,
  rating: 4.6
}, {
  id: 'pet-garrucha',
  name: 'Centro Canino Loma de Vera (Garrucha)',
  ...
  cat: 'pet-board',
  url: 'https://www.bydeperros.com/residencias/residencia-centro-canino-loma-de-vera-1048.html',
  lat: 37.1810,
  lng: -1.8290,
  rating: 4.5
},
...
{
  id: 'fisio-vera-salud',
  name: 'Centro de Fisioterapia Vera Salud (Garrucha)',
  ...
  cat: 'physio',
  url: 'https://holisticcenter.es/vitea-fisioterapia/',
  lat: 37.2495,
  lng: -1.8625,
  rating: 5.0
}, {
  id: 'fisio-vane',
  name: 'Clínica de Fisioterapia Vane (Garrucha)',
  desc: 'Fisioterapia en Garrucha. 5/5 en valoraciones.',
  cat: 'physio',
  url: 'https://www.google.com/maps/search/?api=1&query=Clinica+Fisioterapia+Vane+Garrucha+Moratin',
  lat: 37.1810,
  lng: -1.8235,
  rating: 5.0
}, {
  id: 'fisio-rehab-vera',
  name: 'Centro de Rehabilitación Vera',
  desc: 'Centro de rehabilitación con fisioterapia en Vera pueblo.',
  cat: 'physio',
  url: 'https://www.google.com/maps/search/?api=1&query=Centro+Rehabilitacion+Vera+Villar',
  lat: 37.2490,
  lng: -1.8635
},
// ==========================================================
...
// ==========================================================
{
  id: 'bodega-sierra-almagrera',
  name: 'Bodega Sierra Almagrera',
  ...
  cat: 'bodega',
  url: 'https://bodegasierraalmagrera.com/',
  lat: 37.3680,
  lng: -1.8120,
  featured: true,
  featuredOrder: 1,
  ...
  cat: 'health',
  url: 'https://goo.gl/maps/ei7cMoTYLmWLnWZj7',
  lat: 37.2473,
  lng: -1.8612
}, {
  id: 'virgen-alcazar',
  name: 'Virgen del Alcázar',
  desc: 'Privado.',
  cat: 'health',
  url: 'https://goo.gl/maps/AXJ74Goy1ESTtBVy7',
  lat: 37.6850,
  lng: -1.7060
},
...
{
  id: 'cw-biblio-vera',
  name: 'Biblioteca Pública de Vera',
  cat: 'coworking',
  ...
  url: 'https://www.google.com/maps/search/?api=1&query=Biblioteca+P%C3%BAblica+Vera+Almer%C3%ADa',
  lat: 37.2473,
  lng: -1.8612
}, {
  id: 'cw-cafes-garrucha',
  name: 'Cafeterías para teletrabajar (Garrucha y Mojácar)',
  cat: 'coworking',
  ...
  url: 'https://www.google.com/maps/search/?api=1&query=cafeter%C3%ADa+wifi+Garrucha',
  lat: 37.1815,
  lng: -1.8235
}, {
  id: 'cw-almeria',
  name: 'Coworking en Almería capital',
  cat: 'coworking',
  ...
  url: 'https://www.google.com/maps/search/?api=1&query=coworking+Almer%C3%ADa',
  lat: 36.8381,
  lng: -2.4597
},
...
{
  id: 'ln-veraplaya',
  name: 'Lavandería autoservicio (Vera Playa)',
  cat: 'laundry',
  ...
  url: 'https://www.google.com/maps/search/?api=1&query=lavander%C3%ADa+tintorer%C3%ADa+Moj%C3%A1car',
  lat: 37.1377,
  lng: -1.8523
},
// Cajeros y bancos
{
  id: 'atm-vera',
  name: 'Cajeros y bancos en Vera pueblo',
  cat: 'atm',
  ...
  url: 'https://www.google.com/maps/search/?api=1&query=cajeros+Garrucha+Almer%C3%ADa',
  lat: 37.1815,
  lng: -1.8235
},
...
// Actividades: más tranquilas, aptas para todas las edades.
{
  ...
  desc_en: 'Departures from Garrucha with visits to coves reachable only by sea. A comfortable boat.',
  ...
  desc_en: 'Departures from Las Negras, the wildest corner of Cabo de Gata Natural Park. Boat trips along the Park\'s unspoilt coves, reachable only from the sea. The Las Negras-San Pedro area holds some of the clearest water on the whole Mediterranean coast. Distance: ~45 min from Vera Playa by road.',
...
{
  id: 'lunar-cable',
  name: 'Lunar Cable Park (wakeboard · ski náutico)',
  ...
  desc_en: 'Cable ski on the former rowing canal of the 2005 Mediterranean Games, next to the Cuevas del Almanzora reservoir. Reopened in 2019 as Lunar Cable Park. No boat, no wake, the cable pulls you along. Distance: ~20 km / 24 min from Vera Playa by local road via Vera and Cuevas del Almanzora.',
  ...
  id: 'sport-garrucha-adventure',
  name: 'Garrucha Adventure Sports · pesca y alquiler de barcos',
  ...
  desc_en: 'A company specialising in recreational fishing aboard a 4-person Menorquina 500 boat. Departures from Garrucha harbour. Also rents boats with or without a skipper. Distance: ~10 min by car from Vera Playa (~7 km).',
  ...
  id: 'sport-mojacar-tour-snorkel',
  name: 'Snorkel Cabo de Gata · Mojácar Tour',
  ...
  desc_en: 'Guided boat trip to the unspoilt coves of Cabo de Gata (Cala de Enmedio, San Pedro, Plomo). Pick-up in Vera Playa or Garrucha. Full day, 9am-6pm. Equipment and picnic included.',
  ...
  id: 'sport-deep-emotion',
  name: 'Snorkel y buceo · Deep Emotion (Mojácar)',
  ...
  desc_en: 'Nearby dive centre, with try-dives and full PADI courses.',
  ...
  desc_en: 'Dives on the wrecks and reefs of Villaricos. Full equipment rental.',
  ...
  id: 'aquamundo',
  name: 'Motos de agua · Aquamundo (sin titulación)',
  desc: 'Alquiler de motos de agua en Vera Playa, sin necesidad de licencia. Sesiones de 15-30 min en zona acotada.',
  desc_en: 'Jet ski rental in Vera Playa, no licence required. 15-30 min sessions in a marked-off area.',
  ...
  id: 'jetski-island',
  name: 'Motos de agua · Desert Island (Carboneras)',
  ...
  desc_en: 'Outdoor karting track in Garrucha. Separate adult and children\'s karts. Distance: ~10 min by car from Vera Playa.',
  ...
  id: 'buggy',
  name: 'Buggy en el desierto de Tabernas',
  ...
  desc_en: 'Surf and SUP lessons right on Vera beach. Equipment rental.',
...
// ── Cabo de Gata ──────────────────────────────────────────────
{
  id: 'trek-genoveses-monsul',
  name: 'San José → Los Genoveses → Mónsul (PR-A 47)',
  ...
  desc_en: 'The Natural Park\'s most spectacular coastal route. Passes through the open bay of Los Genoveses and ends at Mónsul, with its black volcanic rocks and dune-sculpting waves. UNESCO World Heritage.',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Playa+Los+Genoveses+San+Jose+Almeria',
  lat: 36.7617,
  lng: -2.1050,
  featured: true,
  featuredOrder: 11
}, {
  id: 'trek-negras-san-pedro',
  name: 'Las Negras → Cala de San Pedro',
  ...
  desc_en: 'Coastal trail along cliffs to a remote cove with a 15th-century Nasrid castle and crystal-clear water. On arrival you\'ll find a small self-sufficient community selling coffee and fruit. No road access.',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Cala+San+Pedro+Las+Negras+Almeria',
  lat: 36.8800,
  lng: -2.0164,
  featured: true,
  featuredOrder: 12
}, {
  id: 'trek-isleta-escullos',
  name: 'Isleta del Moro → Los Escullos (Cabo de Gata)',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Isleta+del+Moro+sendero+Los+Escullos',
  lat: 36.8964,
  lng: -1.9837
}, {
  id: 'trek-rodalquilar-albaricoques',
  name: 'Rodalquilar → Los Albaricoques → Pozo de los Frailes',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Rodalquilar+Almeria+senderismo',
  lat: 36.8533,
  lng: -2.0497
}, {
  id: 'trek-faro-cabo-gata',
  name: 'Circuito Faro de Cabo de Gata – Las Amoladeras',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Faro+Cabo+de+Gata+senderismo',
  lat: 36.7269,
  lng: -2.1898
},
// ── Sierra Cabrera ─────────────────────────────────────────────
{
  id: 'trek-sierra-cabrera-cumbre',
  name: 'Cumbre de Sierra Cabrera (Punta Entinas)',
  ...
  cat: 'trek',
  url: 'https://www.wikiloc.com/wikiloc/find.do?act=trail&sport=9&lat=37.1550&lon=-1.8700&page=1',
  lat: 37.1550,
  lng: -1.8700
}, {
  id: 'trek-cabrera-turre-bedar',
  name: 'Turre → Bédar por la Sierra Cabrera',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Sendero+Turre+Bedar+Sierra+Cabrera',
  lat: 37.1600,
  lng: -1.8900
},
// ── Desde Vera Playa (saliendo desde los apartamentos) ────────
{
  id: 'trek-vera-garrucha',
  name: 'Vera Playa → Garrucha (paseo litoral)',
  ...
  desc_en: 'Flat walk along the shore from Vera Playa to Garrucha\'s fishing harbour. No incline, buggy or elderly-friendly. At the harbour, fried-fish restaurants serve the area\'s best catch.',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Paseo+maritimo+Vera+Playa+Garrucha',
  lat: 37.2270,
  lng: -1.7965,
  featured: true,
  featuredOrder: 13
}, {
  id: 'trek-vera-villaricos',
  name: 'Vera Playa → Villaricos (ruinas romanas)',
  ...
  desc_en: 'Walk north along the beach and low cliffs to Villaricos, where remains of a 3rd-century BC Phoenician and Roman colony stand. Ends at the Archaeological Park with views over the Almanzora delta.',
  ...
  desc_en: 'A roughly 40-minute walk inland, climbing gently along the old road and rural track to Vera\'s historic centre. Ends at the 16th-century fortress-cathedral, built to withstand Berber raids.',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Vera+Almeria+casco+historico+Catedral',
  lat: 37.2491,
  lng: -1.8639
},
// ── Rutas entre pueblos ────────────────────────────────────────
{
  id: 'trek-mojacar-garrucha',
  name: 'Paseo costero Mojácar Playa – Garrucha',
  ...
  desc_en: 'An easy walk (no technical difficulty) along Mojácar Playa\'s Paseo del Mediterráneo to Garrucha\'s fishing harbour. No incline, great with kids. Arriving at the harbour with the fishing boats and fried-fish spots makes it a complete plan.',
  ...
  cat: 'trek',
  url: 'https://www.google.com/maps/search/?api=1&query=Paseo+Maritimo+Mojacar+Garrucha',
  lat: 37.1800,
  lng: -1.8280
},
// ── Rutas existentes ───────────────────────────────────────────
{
  id: 'trek-la-mena',
  name: 'Sendero La Mena – Macenas (PR-A 96)',
  ...
  desc_en: 'Linear coastal route between the cliffs of Mojácar and Macenas beach. Passes the 16th-century Torre del Pirulico watchtower and several viewpoints.',
  ...
  id: 'trek-marina-mojacar',
  name: 'Marina de la Torre → Mojácar Pueblo',
  ...
  id: 'trek-jali',
  name: 'El Jalí – Sierra Cabrera (Turre)',
...
// ── Excursión de día completo, fuera de Almería ────────────────
{
  ...
  desc_en: 'Karst canyon at the northern tip of Granada province, with the Castril river rising between limestone walls, waterfalls and wooden walkways over the water. Natural Park.',
  ...
  desc_en: 'Murcia\'s largest natural area: century-old reforested pine woods and the Las Cámaras via ferrata and trail up to the Morrón de Totana, with Spanish ibex sightings almost guaranteed.',
  ...
  desc_en: 'A landscape of gullies and badlands shaped by the erosion of marl and clay, with narrow canyons and formations that look like another planet. Quite unlike anything on the coast.',
...
// El campo `events` es una lista de fiestas/festivales con su mes.
{
  id: 't-mojacar',
  name: 'Mojácar',
  desc: 'El pueblo blanco más fotografiado de Almería, colgado sobre un cerro a 175 m. Herencia árabe en cada calle estrecha encalada.',
  desc_en: 'Almería\'s most photographed white village, perched on a hill at 175 m. Moorish heritage in every whitewashed narrow street.',
  best: 'Plaza del Frontón al atardecer (mirador), Fuente Mora, Iglesia de Santa María (fortaleza-iglesia), Puerta de la Ciudad y el símbolo del Indalo.',
  tip: 'Aparca en el parking de la entrada y sube andando. Mejor a última hora, la luz dora las fachadas y bajan las temperaturas.',
  events: [{
    name: 'Moros y Cristianos',
    when: '2.ª semana de junio',
    d: 'Tres días de desfiles, embajadas y batallas históricas en homenaje a la Reconquista de 1488.'
  }, {
    name: 'Fiestas patronales de San Agustín',
    when: '28-29 de agosto',
    d: 'Procesión del Indalo, conciertos en Plaza Nueva y verbenas en la playa.'
  }, {
    name: 'Noche de los Museos',
    when: 'mayo',
    d: 'Visitas nocturnas gratuitas a museos y galerías del casco antiguo.'
  }],
  cat: 'town',
  lat: 37.1377,
  lng: -1.8523,
  ...
  id: 't-vera',
  name: 'Vera pueblo',
  desc: 'Cabecera comarcal. Plaza Mayor con palmeras, iglesia-fortaleza del s. XVI, ayuntamiento del s. XVIII y restos de la muralla.',
  desc_en: 'The comarca\'s main town. Palm-lined Plaza Mayor, a 16th-century fortress-church, an 18th-century town hall and remains of the old wall.',
  best: 'Iglesia de la Encarnación (sólo fortaleza de iglesia conservada en Andalucía con cuatro torres), Plaza Mayor, Mercado de Abastos y Museo Histórico Municipal.',
  tip: 'Aprovecha la mañana de sábado para el mercadillo grande y queda a comer en Juan Moreno o Terraza Carmona.',
  events: [{
    name: 'Feria y Fiestas de Vera (San Cleofás)',
    when: '24-29 de septiembre',
    d: 'Feria patronal con caseta municipal, conciertos, toros y procesión de San Cleofás.'
  }, {
    name: 'Romería de la Virgen de las Angustias',
    when: 'último domingo de abril',
    d: 'Romería al santuario de Cabrera con caballos y carretas engalanadas.'
  }, {
    name: 'Festival de Cante Flamenco',
    when: 'agosto',
    d: 'Uno de los festivales flamencos veteranos del Levante almeriense.'
  }],
  cat: 'town',
  lat: 37.2491,
  lng: -1.8639,
  ...
  id: 't-velez',
  name: 'Vélez-Rubio',
  desc: 'Puerta de la Comarca de los Vélez, al norte de la provincia. Imponente arquitectura barroca y casas señoriales.',
  best: 'Iglesia de la Encarnación (catedral barroca del s. XVIII), Museo Comarcal Velezano y Casa de los Arrieros.',
  tip: 'Combina con Vélez-Blanco y la Cueva de los Letreros (arte rupestre Patrimonio UNESCO). Un día perfecto desde Vera.',
  events: [{
    name: 'Fiestas patronales en honor a la Virgen del Carmen',
    when: '15-16 de julio',
    d: 'Procesión nocturna y verbena en la plaza.'
  }, {
    name: 'Romería de la Virgen de la Cabeza',
    when: 'último domingo de abril',
    d: 'Una de las romerías más arraigadas de la sierra.'
  }],
  cat: 'town',
  lat: 37.6520,
  lng: -2.0760
  ...
  id: 't-velez-blanco',
  name: 'Vélez-Blanco',
  desc: 'Pueblo encalado coronado por uno de los castillos renacentistas más bellos de España. Su patio original está hoy en el Metropolitan de Nueva York.',
  desc_en: 'Whitewashed village crowned by one of the finest Renaissance castles in Spain. Its original courtyard is now in New York\'s Metropolitan Museum.',
  best: 'Castillo del Marqués de los Vélez (s. XVI), Cueva de los Letreros (arte rupestre, Indalo original), Iglesia de Santiago.',
  tip: 'La Cueva de los Letreros exige visita guiada (reserva en oficina de turismo). En el castillo, no te pierdas el Cubo del Marqués.',
  events: [{
    name: 'Festival Internacional de Música y Patrimonio',
    when: 'segunda quincena de julio',
    d: 'Conciertos de música clásica y jazz en el patio del castillo.'
  }, {
    name: 'Fiestas de San Roque',
    when: '16 de agosto',
    d: 'Procesión, danzas tradicionales de los moros y cristianos del Marqués.'
  }, {
    name: 'Festival Drácula',
    when: 'última semana de octubre',
    d: 'Recreaciones góticas en el castillo, pintoresco y único.'
  }],
  cat: 'town',
  lat: 37.6905,
  lng: -2.0998,
  ...
  id: 't-castillo',
  name: 'Castillo Marqués de los Vélez',
  desc: 'Dentro de Vélez-Blanco. Fortaleza renacentista del s. XVI, una de las cumbres del Renacimiento andaluz.',
  best: 'Vista desde la Torre del Homenaje, la galería con vistas al valle y la reproducción del patio renacentista (el original está en el MET).',
  tip: 'Entrada económica (~5 €). Combínalo con la Cueva de los Letreros y comida en Vélez-Rubio.',
  cat: 'town',
  lat: 37.6905,
  lng: -2.0998
}, {
  id: 't-sorbas',
  name: 'Sorbas',
  desc: 'Pueblo de casas colgadas sobre el barranco. Su entorno es el Paraje Natural Karst en Yesos, único en Europa.',
  desc_en: 'Village of houses hanging over the ravine. Surrounded by the Karst en Yesos nature reserve, unique in Europe.',
  best: 'Mirador de las casas colgadas, Cuevas de Sorbas (visita guiada en yeso natural), alfarería tradicional (talleres abiertos), Iglesia de Santa María.',
  tip: 'Las cuevas se visitan con guía obligatorio (3 niveles de dificultad). Reserva en cuevasdesorbas.com.',
  events: [{
    name: 'Fiestas en honor a la Virgen de las Nieves',
    when: '5-8 de agosto',
    d: 'Patrona con procesión, verbena y degustación de productos típicos.'
  }, {
    name: 'Festival Alfarería de Sorbas',
    when: 'octubre',
    d: 'Demostraciones de los últimos alfareros tradicionales.'
  }],
  cat: 'town',
  lat: 37.0920,
  lng: -2.0770,
  ...
  id: 't-nijar',
  name: 'Níjar',
  desc: 'Pueblo blanco al pie de Sierra Alhamilla, puerta natural al Parque de Cabo de Gata. Cuna de la cerámica andaluza más reputada y de la jarapa (alfombra tradicional).',
  desc_en: 'White village at the foot of Sierra Alhamilla, the natural gateway to Cabo de Gata Natural Park. Home to Andalusia\'s most respected pottery and traditional jarapa rugs.',
  best: 'Calle de las Tiendas (alfarerías centenarias: La Tienda de los Milagros, El Oficio), Iglesia de Santa María (s. XVI), Plaza La Glorieta.',
  tip: 'Las jarapas y la cerámica de Níjar son uno de los mejores recuerdos posibles de Almería. Pregunta por el taller de Matilde Sánchez.',
  events: [{
    name: 'Fiestas patronales de San Antonio Abad',
    when: '17 de enero',
    d: 'Hogueras (luminarias) y bendición de animales.'
  }, {
    name: 'Fiestas del Cristo de la Salud',
    when: 'segunda semana de septiembre',
    d: 'Feria, conciertos y verbena en la plaza.'
  }, {
    name: 'Feria de la Cerámica',
    when: 'julio',
    d: 'Encuentro de alfareros tradicionales con talleres abiertos al público.'
  }],
  cat: 'town',
  lat: 36.9663,
  lng: -2.2056,
  ...
  id: 't-gergal',
  name: 'Gérgal',
  desc: 'Pueblo blanco a los pies de la Sierra de los Filabres. Punto de partida natural para el Observatorio Astronómico de Calar Alto (uno de los más importantes de Europa).',
  best: 'Castillo de Gérgal (s. XV, vistas), Observatorio de Calar Alto (visitas guiadas a 2.168 m), senderismo en los Filabres.',
  tip: 'Para Calar Alto, reserva con antelación en calaralto.es. Las visitas nocturnas con observación de estrellas son experiencias únicas.',
  events: [{
    name: 'Fiestas patronales de la Virgen de la Cabeza',
    when: 'último fin de semana de abril',
    d: 'Romería a la ermita y procesión por el pueblo.'
  }],
  cat: 'town',
  lat: 37.1110,
  lng: -2.5430
  ...
  desc: 'Capital del valle del Almanzora, dominada por un castillo del s. XV restaurado.',
  best: 'Castillo del Marqués (museo arqueológico y de arte), Cueva del Tesoro, ruta del Almanzora (paseos al río).',
  tip: 'Si vas con niños, el museo del castillo tiene yacimientos del Argar (Edad del Bronce) muy didácticos.',
  events: [{
    name: 'Fiestas de San Diego',
    when: '12-13 de noviembre',
    d: 'Procesión, conciertos y verbena.'
  }, {
    name: 'Feria de Cuevas',
    when: 'mediados de agosto',
    d: 'Feria veraniega con caseta municipal y conciertos.'
  }],
  cat: 'town',
  lat: 37.2978,
  lng: -1.8814
  ...
  id: 't-garrucha',
  name: 'Garrucha',
  desc: 'Pueblo pesquero a 10 min de Hestía. Su lonja es de las más importantes del Mediterráneo (famosa la gamba roja).',
  desc_en: 'Fishing village 10 min from Hestía. Its fish market is one of the most important on the Mediterranean (famous for red prawns).',
  best: 'Subasta de pescado (17:00 días laborables), Paseo Marítimo, Castillo de Jesús Nazareno (s. XVIII), Plaza del Pueblo.',
  tip: 'Llega al puerto sobre las 19:00 para ver descargar el día y comer al lado en Rincón del Puerto o El Almejero.',
  events: [{
    name: 'Fiestas patronales de la Virgen del Carmen',
    when: '15-16 de julio',
    d: 'Procesión marítima de la Virgen por el puerto, la más emotiva de la zona.'
  }, {
  ...
  id: 't-san-jose',
  name: 'San José',
  desc: 'Capital del Parque Natural de Cabo de Gata. Pueblo blanco junto al mar, base perfecta para explorar playas vírgenes.',
  best: 'Paseo del puerto deportivo, Centro de Visitantes Las Amoladeras, playas de Genoveses y Mónsul a 5-10 min.',
  tip: 'En julio-agosto el acceso a Genoveses/Mónsul se restringe, llega temprano o usa el bus lanzadera desde el pueblo.',
  events: [{
    name: 'Fiestas de la Virgen del Carmen',
    when: '15-16 de julio',
    d: 'Procesión marítima con barcas pesqueras engalanadas.'
  }, {
    name: 'Festival Mar de Cabo de Gata',
    when: 'agosto',
    d: 'Conciertos de música mediterránea al atardecer en el puerto.'
  }],
  cat: 'town',
  lat: 36.7665,
  lng: -2.1083
  ...
  desc: 'Capital de la provincia, a 1 h 15 min. Mezcla única de Alcazaba musulmana, Catedral-fortaleza y barrios marineros.',
  desc_en: 'The provincial capital, 1h15 away. A unique mix of a Moorish Alcazaba, a fortress-cathedral and old fishing quarters.',
  best: 'Alcazaba (segunda más grande de España tras la Alhambra), Catedral de la Encarnación (con planta de fortaleza), Refugios de la Guerra Civil, barrio de La Chanca, Cable Inglés (mirador al puerto), Aljibes Árabes.',
  tip: 'Empieza por la Alcazaba al abrir, baja al casco antiguo a tomar tapas (en Almería con cada caña traen una gratis), y termina en el Paseo Marítimo al atardecer.',
  events: [{
    name: 'Semana Santa de Almería',
    when: 'marzo o abril',
    d: 'Declarada de Interés Turístico Nacional. Hermandades por el casco antiguo.'
  }, {
    name: 'Feria de Almería en honor a la Virgen del Mar',
    when: 'última semana de agosto',
    d: 'Feria principal, con casetas en el recinto ferial y procesión marítima de la Patrona.'
  }, {
  ...
  id: 't-lorca',
  name: 'Lorca (Murcia)',
  desc: 'Ciudad barroca declarada Conjunto Histórico-Artístico. Conocida como "la Ciudad del Sol" y por una de las Semanas Santas más espectaculares de España.',
  desc_en: 'Baroque city declared a Historic-Artistic Site. Known as "the City of the Sun" and for one of the most spectacular Holy Weeks in Spain.',
  best: 'Castillo de Lorca (Fortaleza del Sol: visita guiada con teatralización), Colegiata de San Patricio, Palacio de Guevara, Museo MASS (bordados de la Semana Santa Blancos y Azules), Plaza de España.',
  tip: 'Sube al castillo en el ferrocarril turístico desde el centro. Si vas en Semana Santa, reserva alojamiento y entradas con meses de antelación.',
  events: [{
    name: 'Semana Santa de Lorca',
    when: 'marzo o abril',
    d: '⭐ Fiesta de Interés Turístico Internacional. La rivalidad histórica entre la Hermandad Blanca y la Azul produce procesiones únicas: cabalgatas con caballos y vestuario bordado en oro y seda.'
  }, {
    name: 'Feria y Fiestas de Lorca',
    when: '6-21 de septiembre',
    d: 'Feria veraniega con conciertos, festejos taurinos y verbenas.'
  }, {
    name: 'Noche de los Museos',
    when: 'mayo',
    d: 'Visitas nocturnas gratuitas a museos y monumentos.'
  }],
  cat: 'town',
  lat: 37.6770,
  lng: -1.7000,
  ...
  desc_en: 'Walled village on a hill next to Sierra Espuña, with its 13th-century defensive perimeter almost intact. One of the best-preserved historic sites in the Region of Murcia.',
  ...
  desc_en: 'Murcian coastal town, 30 min north. Famous for its Carnival, declared of International Tourist Interest.',
  best: 'Castillo de San Juan (mirador), Plaza de España, Embarcadero del Hornillo (antigua estación ferroviaria inglesa), Cuatro Calas (sur), Cala Cerrada.',
  tip: 'En invierno (febrero) es imprescindible el Carnaval: uno de los más auténticos de España, con la Musa del Carnaval y comparsas todo el año preparándose.',
  events: [{
    name: 'Carnaval de Águilas',
    when: 'febrero',
    d: '⭐ Fiesta de Interés Turístico Internacional. Tres días de comparsas, batalla de flores, entierro de la sardina.'
  }, {
    name: 'Fiestas patronales de la Virgen de los Dolores',
    when: 'segunda semana de septiembre',
    d: 'Procesión marítima y verbena en el paseo.'
  }, {
    name: 'Festival Trovero Marín',
    when: 'agosto',
    d: 'Festival de cante de trovo, género único de la cultura murciana.'
  }],
  cat: 'town',
  lat: 37.4060,
  lng: -1.5840,
  ...
  desc: 'Ciudad portuaria con 3.000 años de historia. Romana, modernista y militar, única en el Mediterráneo. A 1 h 30 min.',
  desc_en: 'Port city with 3,000 years of history. Roman, modernist and military, unlike anywhere else on the Mediterranean. 1h30 away.',
  best: 'Teatro Romano (descubierto en 1988, en perfecta conservación), Calle Mayor modernista, Museo del Foro Romano, Submarino Peral, Castillo de la Concepción (mirador), barrio del Molinete, Casa Cervantes.',
  tip: 'El bono "Puerto de Culturas" da acceso a todos los monumentos por ~25 €. Sube al castillo al atardecer.',
  events: [{
    name: 'Carthagineses y Romanos',
    when: '2.ª quincena de septiembre',
    d: '⭐ Fiesta de Interés Turístico Internacional. 10 días de recreación histórica de la conquista romana: campamentos, batallas, mercado romano.'
  }, {
    name: 'La Mar de Músicas',
    when: 'julio',
    d: 'Festival internacional de músicas del mundo. Conciertos en el Auditorio del Parque Torres con vista al puerto.'
  }, {
    name: 'Semana Santa de Cartagena',
    when: 'marzo o abril',
    d: 'Fiesta de Interés Turístico Internacional. Procesiones nocturnas únicas en sus tronos iluminados con cera.'
  }],
  cat: 'town',
  lat: 37.6040,
  lng: -0.9870,
...
// ── Pueblos adicionales (la Comarca, Murcia y conexiones) ─────
{
  id: 't-carboneras',
  name: 'Carboneras',
  desc: 'Pueblo pesquero al norte del Cabo de Gata. Punto de partida hacia Playa de los Muertos y Mesa Roldán.',
  desc_en: 'Fishing village north of Cabo de Gata. Starting point for Playa de los Muertos and Mesa Roldán.',
  best: 'Castillo de San Andrés (s. XVI, escenario de Juego de Tronos), Mesa Roldán y su faro, playa del Algarrobico (polémica icónica), puerto pesquero al atardecer.',
  tip: 'Sube a Mesa Roldán al amanecer o al atardecer, vistas a las mejores calas vírgenes de la zona.',
  events: [{
    name: 'Fiestas de la Virgen del Carmen',
    when: '16 de julio',
    d: 'Procesión marítima de la patrona de los pescadores: la imagen embarca seguida por una flota de barcas engalanadas.'
  }, {
    name: 'Moros y Cristianos de Carboneras',
    when: 'primera quincena de septiembre',
    d: 'Embajadas y desembarcos en la playa, una de las recreaciones más vistosas del Levante.'
  }, {
    name: 'Fiestas patronales de San Antonio de Padua',
    when: '13 de junio',
    d: 'Procesión por las calles del puerto y verbena.'
  }],
  cat: 'town',
  lat: 36.9963,
  lng: -1.8966,
  ...
  id: 't-pulpi',
  name: 'Pulpí',
  desc: 'Pueblo del Levante almeriense, último al norte. Famoso mundialmente por la Geoda gigante (8 m de altura).',
  desc_en: 'Village in the Almería Levante, the northernmost. World-famous for its giant Geode (8 m tall).',
  best: 'Geoda de Pulpí (visita guiada en mina, segunda más grande del mundo), Playa de los Cocedores, Castillo de San Juan de los Terreros.',
  tip: 'La visita a la Geoda requiere reserva con semanas de antelación en geodapulpi.es. Grupos de 8 personas máx, en pozo a 50 m.',
  events: [{
    name: 'Fiestas de San Juan',
    when: '23-24 de junio',
    d: 'Hogueras en la playa, baño nocturno y verbena junto al mar.'
  }, {
    name: 'Fiestas patronales de San Miguel',
    when: '29 de septiembre',
    d: 'Feria, conciertos y degustación gastronómica.'
  }],
  cat: 'town',
  lat: 37.4055,
  lng: -1.7635,
  ...
  id: 't-tabernas',
  name: 'Tabernas',
  desc: 'Pueblo blanco en medio del único desierto de Europa. Escenario de más de 500 películas (El bueno, el feo y el malo).',
  desc_en: 'White village in the middle of Europe\'s only desert. The setting for over 500 films (The Good, the Bad and the Ugly).',
  best: 'Desierto de Tabernas, Mini Hollywood (Oasys), Fort Bravo (poblado del Oeste), Castillo de Tabernas, ruta de localizaciones de cine.',
  tip: 'En verano hace mucho calor, ve por la mañana temprano. Mini Hollywood y Fort Bravo tienen espectáculos con dobles, ideal con niños.',
  events: [{
    name: 'Almería Western Film Festival',
    when: 'octubre',
    d: 'Festival internacional dedicado al género western, con proyecciones en el desierto.'
  }, {
    name: 'Fiestas de la Virgen de las Angustias',
    when: 'segunda semana de septiembre',
    d: 'Verbena y procesión por el casco antiguo.'
  }],
  cat: 'town',
  lat: 37.0420,
  lng: -2.3890,
  ...
  desc: 'Capital turística del sur de la provincia, a 1 h 30 min. Playas largas, marismas con flamencos y el Aquarium más grande de la costa.',
  best: 'Castillo de Santa Ana, Aquarium Costa de Almería, Marismas de las Salinas Viejas (flamencos), playas de Bajadilla y Aguadulce.',
  tip: 'El Aquarium es perfecto para días nublados o con niños. Combínalo con el paseo por el puerto deportivo y el Castillo.',
  events: [{
    name: 'Festival Internacional Roquetas Flamenca',
    when: 'julio',
    d: 'Espectáculos al aire libre en el Castillo de Santa Ana.'
  }, {
    name: 'Fiestas patronales de la Virgen del Rosario',
    when: 'primera quincena de octubre',
    d: 'Feria local, conciertos y procesión marinera.'
  }],
  cat: 'town',
  lat: 36.7641,
  lng: -2.6094
  ...
  id: 't-turre',
  name: 'Turre',
  desc: 'Pueblo blanco al pie de la Sierra Cabrera, a 15 min de Hestía. Auténtico y poco turistificado, con buenos olivares y almazaras.',
  best: 'Almazara de aceite (visitas con cata), senderismo en Sierra Cabrera, mirador hacia Mojácar y la costa, Iglesia de la Encarnación.',
  tip: 'Combínalo con una comida en Riad Cabrera (a 10 min, en la sierra). El aceite local es excepcional.',
  events: [{
    name: 'Fiestas patronales de San Francisco Javier',
    when: '3 de diciembre',
    d: 'Procesión y verbena en la plaza.'
  }, {
    name: 'Feria de Turre',
    when: 'agosto',
    d: 'Feria veraniega con caseta municipal.'
  }],
  cat: 'town',
  lat: 37.1530,
  lng: -1.8870
  ...
  id: 't-bedar',
  name: 'Bédar',
  desc: 'Pueblo blanco serrano con pasado minero, encaramado a 600 m. Vistas espectaculares al Levante almeriense.',
  best: 'Ruta minera (antiguos cargaderos y túneles), Iglesia de Santa María (s. XVI), mirador del pueblo, fuentes naturales.',
  tip: 'En verano es 5-7 °C más fresco que la costa, escapada perfecta para el calor. Combínalo con tapas en Bédar centro.',
  events: [{
    name: 'Fiestas patronales de San Gregorio',
    when: 'segunda quincena de mayo',
    d: 'Procesión, danzas tradicionales y degustación de migas.'
  }],
  cat: 'town',
  lat: 37.1860,
  lng: -1.9610
  ...
  id: 't-macael',
  name: 'Macael',
  desc: 'Capital mundial del mármol blanco: el mismo de la Alhambra, el Patio de los Leones y el Vaticano. A 50 min.',
  desc_en: 'The world capital of white marble: the same marble as the Alhambra, the Court of the Lions and the Vatican. 50 min away.',
  best: 'Centro de Interpretación del Mármol, ruta de los talleres artesanales, canteras (con visita guiada), Iglesia de Santa María (toda de mármol).',
  tip: 'El Centro de Interpretación explica 5.000 años de historia del mármol macaelero. Combínalo con Cantoria y Olula (Museo Pérez Siquier).',
  events: [{
    name: 'Fiestas patronales en honor a la Virgen del Rosario',
    when: 'primera semana de octubre',
    d: 'Procesión, conciertos y feria del mármol.'
  }, {
    name: 'Feria del Mármol',
    when: 'mayo (bienal)',
    d: 'Encuentro internacional con escultores y empresas del sector.'
  }],
  cat: 'town',
  lat: 37.3850,
  lng: -2.2780,
  ...
  id: 't-olula',
  name: 'Olula del Río',
  desc: 'Pueblo del valle del Almanzora, sede del Museo Pérez Siquier (uno de los mejores museos de fotografía contemporánea de España).',
  best: 'Museo Carmen Pérez Siquier (gratuito), Plaza Mayor, mercado los miércoles.',
  tip: 'Imperdible para amantes del arte. El museo está abierto de mié a dom, comprueba horarios.',
  cat: 'town',
  lat: 37.3680,
  lng: -2.2785
}, {
  id: 't-albox',
  name: 'Albox',
  desc: 'Capital del valle del Almanzora. Mercados al aire libre con producto local y artesanía marroquí.',
  best: 'Mercadillo de los sábados (uno de los más grandes de Almería), Iglesia de Santa María, paseo del Llano.',
  tip: 'El mercadillo es famoso por sus precios, perfecto para producto fresco si te quedas más de una semana.',
  events: [{
    name: 'Fiestas patronales del Saliente',
    when: 'primera semana de septiembre',
    d: 'Romería al Santuario del Saliente, una de las más concurridas de Almería.'
  }],
  cat: 'town',
  lat: 37.3870,
  lng: -2.1490
  ...
  id: 't-antas',
  name: 'Antas',
  desc: 'Pueblo cercano a Hestía con yacimiento argárico (Edad del Bronce) de El Argar, el más importante de la Península.',
  desc_en: 'Village near Hestía with the El Argar Bronze Age site, the most important on the Iberian Peninsula.',
  best: 'Yacimiento de El Argar, Centro de Interpretación, Cabezo de Yerba, Iglesia de Santa María.',
  tip: 'El yacimiento explica una de las primeras civilizaciones urbanas de Europa (3.000 a.C.). Visita guiada gratis los fines de semana.',
  events: [{
    name: 'Fiestas patronales del Cristo de la Salud',
    when: '14 de septiembre',
    d: 'Procesión y verbena.'
  }],
  cat: 'town',
  lat: 37.2440,
  lng: -1.8920
  ...
  id: 't-los-gallardos',
  name: 'Los Gallardos',
  desc: 'Pueblo tranquilo a 15 min de Hestía, a los pies de Sierra Cabrera, con una comunidad internacional muy viva. Buena base para senderismo y rutas del aceite.',
  best: 'Plaza del pueblo y sus bares, senderos de Sierra Cabrera con vistas a la costa, almazaras de la zona.',
  tip: 'Si coincide con su Mercado Medieval, no te lo pierdas: es de los de mejor ambiente del Levante. Los miércoles hay mercadillo.',
  events: [{
    name: 'Fiestas patronales',
    when: '16-17 de julio',
    d: 'Verbena, actividades y procesión en honor a la patrona, en torno a la Virgen del Carmen.'
  }, {
    name: 'Mercado Medieval de Los Gallardos',
    when: 'varias fechas al año',
    d: 'Recreación con puestos de artesanía, gastronomía y espectáculos por todo el pueblo.'
  }],
  cat: 'town',
  lat: 37.2107,
  lng: -1.9293
  ...
  id: 't-zurgena',
  name: 'Zurgena',
  desc: 'Pueblo del valle del Almanzora a orillas del río, rodeado de cítricos y con una nutrida comunidad internacional. Ambiente tranquilo y auténtico.',
  best: 'Paseo del río Almanzora, ermita de San Ramón, naranjos y limoneros del valle, miradores hacia la sierra.',
  tip: 'Combínalo con Albox (mercadillo de los sábados) y una comida con productos de la huerta del Almanzora.',
  cat: 'town',
  lat: 37.3517,
  lng: -2.0470
}, {
  id: 't-huercal-overa',
  name: 'Huércal-Overa',
  desc: 'Cabecera del Almanzora a 30 min, con una de las Semanas Santas más reconocidas de Almería (la rivalidad de los "Coloraos" y los "Verdes"). Buen comercio y gastronomía de comarca.',
  best: 'Iglesia de la Asunción, Convento de las Mercedarias, Teatro Rapallo, casco histórico y plaza del pueblo.',
  tip: 'Si vienes en Semana Santa, reserva con tiempo: las procesiones y la rivalidad entre cofradías llenan el pueblo.',
  events: [{
    name: 'Semana Santa de Huércal-Overa',
    when: 'marzo o abril',
    d: 'De las más reconocidas de Almería. La rivalidad entre los Coloraos y los Verdes llena las calles de tambores y tronos.'
  }, {
    name: 'Feria y Fiestas patronales',
    when: '16-20 de octubre',
    d: 'Feria principal con caseta municipal, conciertos y procesión.'
  }, {
    name: 'Día del Villazgo',
    when: '3 de marzo',
    d: 'Conmemora la independencia de Lorca en 1668, con actos y mercado.'
  }],
  cat: 'town',
  lat: 37.3897,
  lng: -1.9441
  ...
  id: 't-mazarron',
  name: 'Mazarrón (Murcia)',
  desc: 'Pueblo costero murciano con pasado minero romano. Playas vírgenes y aguas turquesas a 1 h 15 min.',
  best: 'Playa de Bolnuevo y sus erosiones geológicas (Las Gredas), Playa de la Carolina, Castillo de los Vélez, Museo Arqueológico.',
  tip: 'Las Gredas de Bolnuevo son formaciones erosionadas únicas, visítalas al atardecer para la mejor luz.',
  events: [{
    name: 'Fiestas patronales de la Purísima Concepción',
    when: '8 de diciembre',
    d: 'Procesión, hogueras y verbena.'
  }, {
    name: 'Carnaval de Mazarrón',
    when: 'febrero',
    d: 'Comparsas y desfiles por el paseo marítimo.'
  }],
  cat: 'town',
  lat: 37.5970,
  lng: -1.3170
  ...
  id: 't-murcia',
  name: 'Murcia capital',
  desc: 'Capital de la Región a 1 h 50 min. Catedral barroca, casino del s. XIX, jardines y la huerta más fértil de Europa. Cuna del Bando de la Huerta.',
  desc_en: 'The region\'s capital, 1h50 away. Baroque cathedral, a 19th-century casino, gardens and Europe\'s most fertile market-garden land. Birthplace of the Bando de la Huerta festival.',
  best: 'Catedral de Santa María (fachada barroca + torre con vistas), Casino de Murcia (s. XIX, joya ecléctica), Real Casino, Museo Salzillo (imaginería barroca), Plaza de las Flores, Plaza Cardenal Belluga.',
  tip: 'En Plaza de las Flores y Plaza de San Juan, todas las terrazas sirven marineras y matrimonios. Pide siempre una caña + tapa por 2 €.',
  events: [{
    name: 'Bando de la Huerta',
    when: 'martes tras Semana Santa',
    d: '⭐ Fiesta de Interés Turístico Internacional. La huerta entera "invade" la ciudad: peñas en traje regional, paellas en la calle, música y baile desde el amanecer.'
  }, {
    name: 'Entierro de la Sardina',
    when: 'sábado tras Semana Santa',
    d: '⭐ Fiesta de Interés Turístico Internacional. Cabalgata nocturna mitológica con carrozas y juguetes lanzados al público. Cierra las Fiestas de Primavera.'
  }, {
    name: 'Semana Santa de Murcia',
    when: 'marzo o abril',
    d: 'Fiesta de Interés Turístico Internacional. Procesiones con imaginería barroca de Salzillo, tallas del s. XVIII únicas en España.'
  }, {
    name: 'Feria de Septiembre',
    when: 'primera semana de septiembre',
    d: 'Feria patronal con conciertos, mercado medieval, fuegos artificiales y feria taurina.'
  }],
  cat: 'town',
  lat: 37.9836,
  lng: -1.1280,
  ...
  id: 't-caravaca',
  name: 'Caravaca de la Cruz (Murcia)',
  desc: 'Ciudad Santa, una de las cinco del mundo cristiano con jubileo perpetuo cada 7 años. A 2 h 15 min, sierras del noroeste murciano.',
  desc_en: 'A Holy City, one of only five in the Christian world with a perpetual jubilee every 7 years. 2h15 away, in the mountains of northwest Murcia.',
  best: 'Real Basílica de la Vera Cruz (s. XVII, con la reliquia de la Vera Cruz), Castillo de Caravaca, Museo de la Fiesta, casco antiguo medieval.',
  tip: 'El Año Jubilar (cada 7 años: próximo 2024 y luego 2031) atrae miles de peregrinos. Fuera de Año Jubilar, mucho más tranquila.',
  events: [{
    name: 'Caballos del Vino',
    when: '1-3 de mayo',
    d: '⭐ Patrimonio Inmaterial de la Humanidad UNESCO + Fiesta de Interés Turístico Internacional. Caballos enjaezados con sedas bordadas suben al castillo a galope tendido. Único en el mundo.'
  }, {
    name: 'Moros y Cristianos de Caravaca',
    when: '1-5 de mayo',
    d: 'Recreación histórica con desfiles, embajadas y la conquista cristiana del castillo. Coincide con Caballos del Vino.'
  }],
  cat: 'town',
  lat: 38.1083,
  lng: -1.8617,
  ...
  id: 't-san-pedro',
  name: 'San Pedro del Pinatar (Murcia)',
  desc: 'Pueblo costero del Mar Menor a 1 h 20 min. Salinas, baños de lodo terapéuticos y el sabor del caldero murciano.',
  best: 'Salinas y arenales de San Pedro (parque regional, flamencos), playas de Lo Pagán, baños de lodo (terapéuticos, gratuitos), puerto pesquero.',
  tip: 'Los baños de lodo en las charcas de Las Salinas son una experiencia única: embárrate, deja secar al sol y enjuaga en el mar.',
  events: [{
    name: 'Fiestas patronales del Carmen',
    when: '16 de julio',
    d: 'Procesión marinera de la Virgen del Carmen con flota pesquera engalanada saliendo del puerto.'
  }, {
    name: 'Festival Internacional de Cante de las Minas',
    when: 'primera semana de agosto',
    d: 'En La Unión (a 15 min), pero la zona se vuelca. Cante flamenco minero, el más importante del mundo.'
  }],
  cat: 'town',
  lat: 37.8200,
  lng: -0.7800
  ...
  id: 't-yecla',
  name: 'Yecla (Murcia)',
  desc: 'Pueblo del interior vinícola murciano a 2 h 40 min. Capital del vino DOP Yecla (monastrell). Conjunto histórico de iglesias barrocas.',
  best: 'Basílica de la Purísima Concepción, Iglesia Vieja, Museo del Vino, bodegas DOP Yecla (Castaño, Barahonda).',
  tip: 'Combina Yecla con Jumilla (a 30 min) para una ruta del vino monastrell murciano, los tintos más potentes y golosos del Sureste.',
  events: [{
    name: 'Moros y Cristianos de Yecla',
    when: '5-10 de diciembre',
    d: 'Fiesta de Interés Turístico Nacional. La fiesta más importante de Yecla: desfiles, embajadas, fuegos y "Bajada de la Virgen" desde el santuario.'
  }],
  cat: 'town',
  lat: 38.6125,
  lng: -1.1170
  ...
  id: 't-cuevas-velez',
  name: 'Cuevas de los Letreros (Vélez-Blanco)',
  desc: 'Abrigo rupestre con pinturas neolíticas. Aquí se descubrió el Indalo, símbolo de Almería.',
  best: 'Las pinturas rupestres (4.000-7.000 a.C.) Patrimonio de la Humanidad UNESCO: antílopes, brujos y el Indalo original.',
  tip: 'Visita guiada obligatoria. Reserva en la Oficina de Turismo de Vélez-Blanco (teléfono 950 415 354).',
  cat: 'town',
  lat: 37.6920,
  lng: -2.0960
},
// Visitas únicas (gem), en sección Planes y excursiones
{
  ...
  desc_en: 'Black volcanic rocks rising from the turquoise Mediterranean, beside the Cabo de Gata lighthouse. The most iconic image of the Almería coast.',
  ...
  desc_en: 'Ruins of the farmhouse where the real crime that inspired Lorca\'s "Blood Wedding" took place. Total silence, adobe walls and a story that raises goosebumps.',
  ...
  desc_en: 'The Park\'s most authentic and photogenic fishing village. Whitewashed houses, coloured boats and silence. A real postcard that still exists.',
  ...
  desc_en: 'Phoenician-Roman city (6th c. BC) right by the beach, 10 minutes from Hestía. Walls, garum factories and a necropolis remain. Barely signposted, look for the green signs.',
  ...
  desc_en: 'Village rebuilt in the 15th century after the 1518 earthquake. The Collegiate Church, cobbled squares and quiet Andalusian life 10 minutes from the beach.',
...
// ── HACIA EL NORTE (camino a Murcia)
{
  ...
  rating: 4.5,
  services: '🛏️ 🚻 ♿',
  access: '🚗 parking pequeño · pista corta',
  url: 'https://goo.gl/maps/pCTJ8y5mt4y4VYkE8',
  lat: 37.3790,
  lng: -1.6260
}, {
  id: 'p-carolina',
...
// ── VERA PLAYA Y ALREDEDORES INMEDIATOS
{
  ...
  desc_en: 'Right next to Hestía. Long, fine sand, warm water. Our default beach.',
  best: 'el atardecer caminando por la orilla hacia Garrucha.',
  cat: 'beach',
  rating: 4.4,
  services: '🚿 🛟 🍹 🛏️ 🚻 ♿ 🏊 Bandera Azul',
  access: '🚶 desde Hestía · 🚗 parking en calle',
  access_en: '🚶 from Hestía · 🚗 street parking',
  lat: 37.2275,
  lng: -1.7935
}, {
  id: 'p-garrucha',
  ...
  desc_en: 'Fishing village 10 min away. Good fish market. A pleasant stroll.',
  best: 'tomar algo en el puerto al atardecer cuando llegan los barcos.',
  cat: 'beach',
  rating: 4.4,
  services: '🚿 🛟 🍹 🛏️ 🚻 ♿',
  access: '🚗 parking en pueblo',
  access_en: '🚗 village parking',
  lat: 37.1810,
  lng: -1.8230
}, {
  id: 'p-macenas',
  ...
  rating: 4.5,
  services: 'sin servicios',
  access: '🚗 parking pequeño · 🚶 5 min',
  url: 'https://goo.gl/maps/eySnjWJp1YcjkSiu9',
  lat: 37.0200,
  lng: -1.8730
},
// ── HACIA EL SUR (Cabo de Gata)
{
  ...
  desc_en: 'Carboneras. One of the best beaches in Spain. Crystal-clear water, large pebbles. Not a single service.',
  ...
  access: '🚗 parking de pago en verano · 🚶 15 min sendero pedregoso, fuerte pendiente',
  access_en: '🚗 paid parking in summer · 🚶 15-min stony trail, steep slope',
  url: 'https://goo.gl/maps/uh1baJWHPp1uan81A',
  lat: 37.0050,
  lng: -1.8800,
  featured: true,
  featuredOrder: 1
  ...
  desc_en: 'Agua Amarga. Our favourite. Fine white sand framed by sculpted rock. Almost untouched because it takes a walk to reach.',
  ...
  rating: 4.7,
  services: 'virgen · sin servicios',
  access: '🚗 hasta Agua Amarga · 🚶 30 min campo a través',
  access_en: '🚗 to Agua Amarga · 🚶 30-min walk across country',
  url: 'https://goo.gl/maps/i72YXUhFgBzi7vhf6',
  lat: 36.9540,
  lng: -1.9740,
  featured: true,
  featuredOrder: 4
  ...
  rating: 4.6,
  services: 'virgen · sin servicios',
  access: '🚗 pista corta · 🚶 30 min a pie',
  lat: 36.9460,
  lng: -1.9690
}, {
  id: 'p-aguamarga',
  ...
  access: '🚶 90 min desde Las Negras (sendero costero) · ⛵ taxi-barca en verano',
  lat: 36.8540,
  lng: -1.9890
}, {
  id: 'p-playazo',
  ...
  access: '🚗 hasta el aparcamiento al pie de la playa',
  url: 'https://goo.gl/maps/bu6fEsoT1mHC9j2w6',
  lat: 36.8470,
  lng: -2.0230
}, {
  id: 'p-escullos',
  ...
  rating: 4.5,
  services: '🍹 🚻',
  access: '🚗 parking en pueblo · 🚶 corto',
  ...
  desc_en: 'San José. A perfect half-kilometre bay, dunes with juniper scrub. No services, to preserve the setting.',
  ...
  access: '🚌 bus desde San José en verano (acceso restringido al coche) · 🚲 carril bici · 🚶 25 min desde San José',
  access_en: '🚌 bus from San José in summer (car access restricted) · 🚲 cycle lane · 🚶 25 min from San José',
  lat: 36.7610,
  lng: -2.0890,
  featured: true,
  featuredOrder: 3
  ...
  desc_en: 'San José. Famous for its dune and volcanic rock. Featured in The Good, the Bad and the Ugly and Indiana Jones.',
  ...
  access: '🚌 bus desde San José en verano (acceso restringido al coche) · 🚲 carril bici',
  access_en: '🚌 bus from San José in summer (car access restricted) · 🚲 cycle lane',
  lat: 36.7460,
  lng: -2.1130,
  featured: true,
  featuredOrder: 2
  ...
  desc_en: 'San José. Wilder than Mónsul. Behind the dunes off the track. One of our favourites.',
  ...
  rating: 4.6,
  services: 'virgen · sin servicios',
  access: '🚌 bus + 🚶 10 min andando entre dunas',
  access_en: '🚌 bus + 🚶 10-min walk through the dunes',
  url: 'https://goo.gl/maps/sF2xaKDPrHEgjpxv6',
  lat: 36.7430,
  lng: -2.1180,
  featured: true,
  featuredOrder: 5
  ...
  rating: 4.6,
  services: 'virgen',
  access: '🚶 desde el Barronal por sendero costero',
  url: 'https://goo.gl/maps/ngDbWgoBfAdH5x4S8',
  lat: 36.7415,
  lng: -2.1195
}, {
  id: 'p-cabogata',
  ...
  rating: 4.5,
  services: '🚿 🍹 🛏️ 🚻 ♿',
  access: '🚗 parking gratuito · 🚌 línea M-100',
  lat: 36.7530,
  lng: -2.2250
}, {
  id: 'p-fabriquilla',
...
{
  id: 'p-zapillo',
  name: 'Playa del Zapillo (Almería)',
  desc: 'Capital. Bandera Azul. Paseo, hamacas, chiringuitos, paddle.',
  cat: 'beach',
  rating: 4.3,
  services: '🚿 🛟 🍹 🛏️ 🚻 ♿ 🏊 Bandera Azul',
  access: '🚗 · 🚌 bus urbano',
  ...
  id: 'p-nueva-almeria',
  name: 'Playa Nueva Almería / Térmica',
  desc: 'Capital. Paralela al Zapillo, 1,5 km de arena con todos los servicios.',
  cat: 'beach',
  rating: 4.3,
  services: '🚿 🛟 🍹 🛏️ 🚻 ♿',
  access: '🚗 · 🚌 bus urbano',
  ...
  desc: 'Almería. Larga, urbana, con un paseo amplio. Buena para familias.',
  cat: 'beach',
  rating: 4.2,
  services: '🚿 🛟 🍹 🛏️ 🚻',
  access: '🚗 · 🚌 bus M-2',
  ...
  id: 'p-almeria',
  name: 'Playa de El Palmer (Almería)',
  desc: 'Capital. Paseo, hamacas, chiringuitos. 1 h 15 min en coche.',
  cat: 'beach',
  rating: 4.2,
  services: '🚿 🛟 🍹 🛏️ 🚻',
  access: '🚗 · 🚌 bus urbano',
  ...
  id: 'p-aguadulce',
  name: 'Playa de Aguadulce (Roquetas)',
  desc: 'Roquetas de Mar. Larga, urbana, amplia. Buena para familia.',
  cat: 'beach',
  rating: 4.3,
  services: '🚿 🛟 🍹 🛏️ 🚻 ♿ 🏊 Bandera Azul',
  access: '🚗 parking · 🚌 línea M-302',
  lat: 36.8070,
  lng: -2.5680
}, {
  id: 'p-toyo',
  name: 'Playa del Toyo (Retamar)',
  desc: 'Retamar / El Ejido. Limita con el Parque Natural. Arena fina y tranquila.',
  cat: 'beach',
  rating: 4.4,
  services: '🚿 🛟 🍹 🛏️ 🚻 ♿',
  access: '🚗 parking',
  ...
  id: 'p-almerimar',
  name: 'Playa de Almerimar (El Ejido)',
  desc: 'Junto al puerto deportivo. 1 h 30 min de Vera. Aguas tranquilas.',
  cat: 'beach',
  rating: 4.3,
  services: '🚿 🛟 🍹 🛏️ 🚻 ♿ 🏊 Bandera Azul',
  access: '🚗 parking',
  ...
  id: 'p-balerma',
  name: 'Playa de Balerma (El Ejido)',
  desc: 'La playa más larga de la zona. Arena gruesa, casi virgen en algunos tramos.',
  cat: 'beach',
  rating: 4.2,
  services: '🚿 🛟 🍹 🛏️ 🚻',
  access: '🚗 parking abundante',
  ...
  id: 'p-adra',
  name: 'Playa de San Nicolás (Adra)',
  desc: 'Adra. Última playa antes de Granada. 1 h 50 min en coche.',
  cat: 'beach',
  rating: 4.2,
  services: '🚿 🛟 🍹 🛏️ 🚻',
  access: '🚗 parking',
...
// Playas para perros
{
  ...
  name: 'Cala de Mijo',
  cat: 'beach-dog',
  url: 'https://goo.gl/maps/bH2xyYdjNCdHvGy19',
  lat: 37.0440,
  lng: -1.8910
}, {
  id: 'p-canada',
  name: 'Playa de la Cañada del Negro',
  cat: 'beach-dog',
  url: 'https://goo.gl/maps/9iQMPzR1YWpPGjNc6',
  lat: 37.0220,
  lng: -1.8770
}, {
  id: 'playeros',
  name: 'Playeros.es · directorio',
  cat: 'beach-dog',
  url: 'http://www.playeros.es',
  lat: 37.1100,
  lng: -1.8395
},
// Playas naturistas (Vera Playa es la mayor zona naturista de España)
{
  ...
  desc: 'Frente al complejo naturista. La mayor zona naturista de España.',
  desc_en: 'Facing the naturist complex. Spain\'s largest naturist stretch of coast.',
  cat: 'beach-nude',
  lat: 37.2425,
  lng: -1.7880
}, {
  id: 'p-naturista-almanzora',
  name: 'Playa del Almanzora (zona naturista)',
  desc: 'Tramo norte de la playa, junto a la desembocadura del Almanzora.',
  desc_en: 'Northern stretch of the beach, by the mouth of the Almanzora river.',
  cat: 'beach-nude',
  lat: 37.2530,
  lng: -1.7720
}, {
  id: 'p-naturista-marina',
  name: 'Playa de la Marina de la Torre (Mojácar)',
  desc: 'Zona naturista en su tramo sur.',
  cat: 'beach-nude',
  lat: 37.1075,
  lng: -1.8395
},
// Playas con servicios (sombrillas, hamacas, chiringuitos)
{
  id: 'p-srvc-vera',
  name: 'Playa de Vera (sector textil)',
  desc: 'Sombrillas, hamacas y chiringuitos.',
  desc_en: 'Sunbeds, umbrellas and beach bars.',
  cat: 'beach-srvc',
  lat: 37.2275,
  lng: -1.7935
}, {
  id: 'p-srvc-mojacar',
  name: 'Mojácar Playa',
  desc: 'Hamacas, sombrillas y chiringuitos a lo largo del paseo.',
  cat: 'beach-srvc',
  lat: 37.1100,
  lng: -1.8395
}, {
  id: 'p-srvc-garrucha',
  name: 'Playa de Garrucha',
  desc: 'Servicios de playa y paseo marítimo.',
  desc_en: 'Beach services and a seafront promenade.',
  cat: 'beach-srvc',
  lat: 37.1815,
  lng: -1.8210
}, {
  id: 'p-srvc-quitapellejos',
  name: 'Playa Quitapellejos (Palomares)',
  desc: 'Hamacas, sombrillas y chiringuitos cerca de Hestía.',
  desc_en: 'Sunbeds, umbrellas and beach bars near Hestía.',
  cat: 'beach-srvc',
  lat: 37.2050,
  lng: -1.7980
},
...
// ==========================================================
{
  ...
  id: 'gas-plenoil-vera',
  name: 'Plenoil Vera (Crta. de Cuevas)',
  ...
  cat: 'fuel',
  url: 'https://www.google.com/maps/search/?api=1&query=BARAZA+gasolinera+N-340A+Vera',
  lat: 37.2490,
  lng: -1.8970
}, {
  id: 'gas-vera-diesel',
  name: 'Vera Diesel (Ctra. de Ronda)',
  ...
  cat: 'fuel',
  url: 'https://www.google.com/maps/search/?api=1&query=Vera+Diesel+Carretera+Ronda+Vera+Almeria',
  lat: 37.2475,
  lng: -1.8620
}, {
  id: 'gas-repsol-garrucha',
  name: 'Repsol Garrucha (Puerto)',
  ...
  cat: 'fuel',
  url: 'https://www.google.com/maps/search/?api=1&query=Repsol+Garrucha+Puerto',
  lat: 37.1808,
  lng: -1.8210
}, {
  id: 'gas-cepsa-garrucha',
  name: 'Cepsa La Garrucha (AL-152 Garrucha-Turre)',
  ...
  cat: 'fuel',
  url: 'https://www.google.com/maps/search/?api=1&query=Cepsa+La+Garrucha+AL-152+Turre',
  lat: 37.1700,
  lng: -1.8650
}, {
  id: 'gas-repsol-mojacar',
  name: 'Repsol Mojácar (AL-118 km 0,6)',
  ...
  cat: 'fuel',
  url: 'https://www.google.com/maps/search/?api=1&query=Repsol+Mojacar+AL-118',
  lat: 37.1380,
  lng: -1.8475
}, {
  id: 'gas-repsol-palomares',
  name: 'Repsol Palomares (ALP-118)',
...
// ==========================================================
{
  id: 'ev-mercadona-vera-mz',
  name: 'Mercadona Vera (Av. Medina Azahara)',
  ...
  name: 'Mercadona Vera Pueblo (C/ Baza)',
  ...
  cat: 'ev-charge',
  url: 'https://www.google.com/maps/search/?api=1&query=Mercadona+Vera+Pueblo+Calle+Baza',
  lat: 37.2491,
  lng: -1.8639
}, {
  id: 'ev-lidl-albox',
  name: 'Lidl Albox (ruta hacia interior)',
  ...
  id: 'ev-electromaps',
  name: 'Mapa completo (Electromaps)',
  ...
  cat: 'ev-charge',
  url: 'https://www.electromaps.com/en/charging-stations/spain/almeria/vera',
  lat: 37.2491,
  lng: -1.8639
}];
...
const GUIDE_SHARED = {
  es: {
    ...
    expectativas: {
      ...
      paras: ['Nosotros nos hacemos responsables de que Hestía esté impecable, funcione todo y estés bien atendido durante tu estancia. Lo que ocurre fuera del apartamento (el tiempo, el ambiente de la zona, la oferta de ocio, cómo de concurridas están las playas) no depende de nosotros. Si esta descripción encaja con lo que buscas, te va a encantar. Si tenías en mente otra cosa, mejor saberlo ahora que al llegar.', 'Por favor, ten en cuenta que cualquier cosa puede romperse, estropearse, fallar… Lo que te garantizamos es que estaremos pendientes y que haremos todo lo que esté en nuestra mano para solucionarlo lo antes posible.', 'Nos gustaría que nos valoraras por todo esto y no por aquello que sabes de antemano que no tiene el alojamiento o que no depende de lo que está en nuestra mano o en los servicios que podemos prestar. Pero siempre siempre vamos a intentar ayudarte.']
    },
    welcome: {
    ...
    checkin: {
      ...
      airports: [{
        ...
        km: 95,
        time: '1 h',
        notes: 'El más cercano. Vuelos sobre todo Madrid, Barcelona, UK y centro Europa. Pista corta.'
      }, {
        name: 'Murcia · Corvera',
        code: 'RMU',
        km: 130,
        time: '1 h 25',
        notes: 'Murcia (sustituyó a San Javier en 2019). Mucha conexión con Reino Unido (TUI, Ryanair).'
      }, {
        name: 'Alicante · Elche',
        code: 'ALC',
        km: 175,
        time: '1 h 50',
        notes: 'El más conectado del Mediterráneo: 100+ destinos. Si no hay vuelo a Almería, suele ser la mejor opción.'
      }, {
        name: 'Granada · F. García Lorca',
        code: 'GRX',
        km: 215,
        time: '2 h 30',
        notes: 'Útil si combinas con visita a Granada (Alhambra). Pocas conexiones internacionales.'
      }, {
        name: 'Málaga · Costa del Sol',
        code: 'AGP',
        km: 295,
        time: '3 h 15',
        notes: 'El mejor conectado de Andalucía (Lufthansa, KLM, vuelos largos). Solo lo eligen si los demás no encajan en horario.'
      }],
      ...
      stations: [{
        type: 'BUS',
        name: 'Estación de Autobuses de Vera',
        km: 4,
        time: '5-10 min',
        notes: 'Ctra. de Águilas, s/n · ALSA. Líneas a Almería, Murcia, Cuevas del Almanzora, Mojácar y Águilas. Tel. 950 39 09 25.'
      }, {
        type: 'BUS',
        name: 'Estación de Autobuses de Almería',
        km: 95,
        time: '1 h',
        notes: 'Estación Intermodal Almería (Plaza de la Estación). ALSA y compañías locales. Conexión con el aeropuerto LEI vía línea 30 (Surbus).'
      }, {
        type: 'BUS',
        name: 'Estación de Autobuses de Murcia',
        km: 145,
        time: '1 h 30',
        notes: 'Plaza de la Industria. ALSA con conexiones a toda la costa levantina y al aeropuerto RMU.'
      }, {
        type: 'TRN',
        name: 'Estación de tren de Almería',
        km: 95,
        time: '1 h',
        notes: 'Estación Intermodal (comparte edificio con la de buses). Cercanías y media distancia a Granada, Sevilla, Madrid (Talgo nocturno). Sin AVE todavía.'
      }, {
        type: 'TRN',
        name: 'Estación de tren de Murcia · Carmen',
        km: 145,
        time: '1 h 30',
        notes: 'AVE Murcia ↔ Madrid (en obras desde 2022; tramo Murcia-Almería en ejecución). Combinable con Renfe Cercanías al aeropuerto RMU.'
      }],
      ...
      modalities: [{
        tag: 'Autónoma',
        body: 'Llegas y entras directamente. Te pasamos por mensaje el código de la urbanización, el acceso a la caja-llaves y las instrucciones paso a paso. Útil si vienes con vuelo nocturno o si prefieres tu ritmo.'
      }, {
        tag: 'Presencial',
        body: 'Te recibe Leila o alguien de su equipo, te enseñan la casa y te resuelven cualquier duda en el momento. Horario de recepción presencial: 15:00 – 21:00. Si tu llegada cae fuera, pasamos a la modalidad autónoma sin más.'
      }],
    ...
    cleaning: {
      ...
      recs: ['Por favor respeta los textiles y mobiliario de Hestía.', 'Avísanos si quieres servicio opcional de limpieza o de textil.', 'Las toallas, úsalas solo en Hestía.']
    },
    ...
    pets: {
      ...
      items: [{
        icon: '📝',
        t: 'Avisad antes de llegar, o al reservar',
        ...
        icon: '💶',
        t: 'Suplemento: 10 €/noche, máximo 50 €',
    ...
    surroundings: {
      ...
      disclaimer: ['Distancias y tiempos en coche calculados desde Vera Playa, punto común a las tres Hestías (a menos de 2 km entre sí). Comprueba la ruta exacta en Google Maps antes de salir, especialmente en verano cuando el tráfico se carga.', 'Los horarios de bares, restaurantes y comercios cambian con la temporada y pueden alterarse sin previo aviso: llama o consulta su web antes de ir.', 'Las valoraciones (⭐) y los "best" que destacamos son recomendaciones personales que dependen del momento: un sitio brillante en mayo puede estar saturado en agosto, y el aforo o el tiempo cambian la experiencia. Tómalo como guía de salida, no como verdad absoluta.'],
      sources: ['Pregúntanos. Te ayudaremos con mucho gusto según nuestra experiencia y la de huéspedes como tú. A continuación tienes una pequeña muestra…'],
      sites: {
        ...
        groups: [{
          ...
          links: [{
            ...
            label: 'Mojácar Turismo',
            url: 'https://mojacar.es/turismo/'
          }, {
            label: 'Garrucha Turismo',
          ...
          links: [{
            label: 'Turismo de Almería · provincia',
            ...
            label: 'Junta de Andalucía · turismo',
            ...
            label: 'TripAdvisor Almería',
            url: 'https://www.tripadvisor.es/Tourism-g315912-Province_of_Almeria_Andalucia-Vacations.html'
          }]
        }, {
          title: 'Murcia occidental (Lorca, Águilas, Mazarrón)',
          links: [{
            label: 'Turismo Región de Murcia',
            url: 'https://www.murciaturistica.es/'
          }, {
            label: 'Lorca Turismo',
            url: 'https://www.lorcaturismo.es/'
          }, {
            label: 'Águilas Turismo',
      ...
      categories: [{
        title: 'Supermercados',
        items: ['En Vera Playa, Consum y Mercadona, a menos de 3 km.', 'En Vera, Dia, Lidl, Mercadona y otros más pequeños, así como mercados y mercadillos.']
      }, {
        title: 'Farmacia',
        items: ['La más cercana, junto al Consum de Vera Playa.', 'En Vera, Garrucha y Mojácar, hay varias.']
      }, {
        title: 'Librerías',
        items: ['En Vera: Nobel.', 'En Mojácar: Macondo.']
      }, {
        title: 'Actividades',
        items: ['Parque acuático Aquavera: aquavera.com', 'Paseos en barco: elcaboafondo.es · cabogataalmeria.com', 'Buceo y snorkel: buceotortuga.com · villaricosub.com · buceomojacar.com', 'En Mojácar: mojacarfiesta.com/actividades/', 'Motos de agua sin titulación: aquamundo.es', 'Karting Garrucha: kartinggarrucha.es', 'Alquiler de bicis en Villaricos: 627 139 092', 'Naturismo: gran oferta de playas, locales y zonas naturistas de Vera.', 'Golf. En Vera y Mojácar tienes para elegir.', 'Actividades de aventura: lunarcablepark.com']
      }],
    ...
    feedback: {
      ...
      paras: ['Al valorarnos, ten en cuenta lo que depende de nosotros: que Hestía esté impecable, que todo funcione y que te sientas bien atendido. Que algo se rompa o falle alguna vez no está al 100% en nuestra mano, pero intentar solucionarlo y ayudarte sí lo está siempre.', 'Tu experiencia importa más que ninguna palabra que podamos escribir aquí. Si algo no ha estado a la altura, dínoslo antes de irte y lo solucionamos.', 'Al terminar tu estancia te pediremos que nos evalúes: si te gustó tu Hestía, una reseña honesta en Booking, Airbnb o Google Maps nos ayuda muchísimo a seguir mejorando.', 'Nos encantaría que volvieras, y que nos recomendaras a quien quieras: creemos en el boca a boca más que en cualquier otra forma de publicidad.']
    }
  },
  en: {
    pretrip: {
    ...
    checkin: {
      ...
      airports: [{
        ...
        km: 95,
        time: '1 h',
        notes: 'The closest. Flights mostly Madrid, Barcelona, UK and central Europe. Short runway.'
      }, {
        name: 'Murcia · Corvera',
        code: 'RMU',
        km: 130,
        time: '1 h 25',
        notes: 'Murcia (replaced San Javier in 2019). Lots of UK connections (TUI, Ryanair).'
      }, {
        name: 'Alicante · Elche',
        code: 'ALC',
        km: 175,
        time: '1 h 50',
        notes: 'Best-connected on the Mediterranean: 100+ destinations. If no Almería flight, usually the best alternative.'
      }, {
        name: 'Granada · F. García Lorca',
        code: 'GRX',
        km: 215,
        time: '2 h 30',
        notes: 'Worth it if you combine with visiting Granada (Alhambra). Few international connections.'
      }, {
        name: 'Málaga · Costa del Sol',
        code: 'AGP',
        km: 295,
        time: '3 h 15',
        notes: 'Best-connected in Andalusia (Lufthansa, KLM, long-haul). Only worth it if others do not fit your schedule.'
      }],
      ...
      stations: [{
        type: 'BUS',
        name: 'Vera bus station',
        km: 4,
        time: '5-10 min',
        notes: 'Ctra. de Águilas, s/n · ALSA. Routes to Almería, Murcia, Cuevas del Almanzora, Mojácar and Águilas. Tel. +34 950 39 09 25.'
      }, {
        type: 'BUS',
        name: 'Almería bus station',
        km: 95,
        time: '1 h',
        notes: 'Almería Intermodal Station (Plaza de la Estación). ALSA and local operators. Connects with LEI airport via line 30 (Surbus).'
      }, {
        type: 'BUS',
        name: 'Murcia bus station',
        km: 145,
        time: '1 h 30',
        notes: 'Plaza de la Industria. ALSA with connections along the Levante coast and to RMU airport.'
      }, {
        type: 'TRN',
        name: 'Almería train station',
        km: 95,
        time: '1 h',
        notes: 'Intermodal Station (shared with the bus terminal). Cercanías and medium-distance services to Granada, Seville and Madrid (overnight Talgo). No AVE service yet.'
      }, {
        type: 'TRN',
        name: 'Murcia · Carmen train station',
        km: 145,
        time: '1 h 30',
        notes: 'AVE Murcia ↔ Madrid (under construction since 2022; the Murcia-Almería leg is in progress). Combine with Renfe Cercanías to RMU airport.'
      }],
      ...
      modalities: [{
        tag: 'Self check-in',
        body: 'You arrive and let yourself in. We send you the gate code, lockbox access and step-by-step instructions by message. Handy for late flights or if you prefer your own pace.'
      }, {
        tag: 'In-person check-in',
        body: 'Leila or someone from her team greets you, shows you around and answers anything on the spot. In-person reception hours: 15:00 – 21:00. If your arrival falls outside that window, we switch to self check-in, no problem.'
      }],
    ...
    cleaning: {
      ...
      recs: ['Please take care of Hestía\'s textiles and furniture.', 'Ask us if you want optional cleaning or extra textile services.', 'Use towels only inside Hestía.']
    },
    ...
    pets: {
      ...
      items: [{
        icon: '📝',
        t: 'Tell us before you arrive, or when booking',
        ...
        icon: '💶',
        t: 'Supplement: €10/night, €50 maximum',
    ...
    surroundings: {
      ...
      sources: ['Just ask us. We are happy to help based on our experience and that of guests like you. A small sample below…'],
      sites: {
        ...
        groups: [{
          ...
          links: [{
            ...
            label: 'Mojácar Tourism',
            url: 'https://mojacar.es/turismo/'
          }, {
            label: 'Garrucha Tourism',
            url: 'https://www.garrucha.es/'
          }, {
          ...
          links: [{
            label: 'Almería Province · tourism',
            url: 'https://www.turismodealmeria.org/'
          }, {
            ...
            label: 'TripAdvisor Almería',
            url: 'https://www.tripadvisor.com/Tourism-g315912-Province_of_Almeria_Andalucia-Vacations.html'
          }]
        }, {
          title: 'Western Murcia (Lorca, Águilas, Mazarrón)',
          links: [{
            label: 'Region of Murcia · tourism',
            url: 'https://www.murciaturistica.es/'
          }, {
            label: 'Lorca Tourism',
            url: 'https://www.lorcaturismo.es/'
          }, {
            label: 'Águilas Tourism',
            url: 'https://www.aguilas.es/turismo'
          }, {
      ...
      categories: [{
        title: 'Supermarkets',
        items: ['Vera Playa: Consum and Mercadona, less than 3 km away.', 'Vera: Dia, Lidl, Mercadona and smaller shops, plus markets and street markets.']
      }, {
        title: 'Pharmacy',
        items: ['The closest is next to Consum in Vera Playa.', 'Several in Vera, Garrucha and Mojácar.']
      }, {
        title: 'Bookshops',
        items: ['In Vera: Nobel.', 'In Mojácar: Macondo.']
      }, {
        title: 'Activities',
        items: ['Aquavera water park: aquavera.com', 'Boat trips: elcaboafondo.es · cabogataalmeria.com', 'Diving and snorkelling: buceotortuga.com · villaricosub.com · buceomojacar.com', 'In Mojácar: mojacarfiesta.com/actividades/', 'Jet skis (no licence): aquamundo.es', 'Karting Garrucha: kartinggarrucha.es', 'Bike rental in Villaricos: 627 139 092', 'Nudism: many beaches, venues and naturist areas in Vera.', 'Golf, choices in Vera and Mojácar.', 'Adventure activities: lunarcablepark.com']
      }],
    ...
    feedback: {
      ...
      paras: ['When you rate us, judge us on what is actually in our hands: Hestía being spotless, everything working, and you feeling well looked after. Something breaking or going wrong now and then is not 100% avoidable, but trying to fix it and help you always is.', 'Your experience matters more than anything we can write here. If something isn\'t up to scratch, tell us before you leave and we\'ll fix it.', 'At the end of your stay we will ask you to rate us: and if you loved your Hestía, an honest review on Booking, Airbnb or Google Maps really helps us keep improving.', 'We would love for you to come back, and to recommend us to the people you care about: we believe in word of mouth more than any other kind of advertising.']
    }
  }
};
  ...
  vm: {
    ...
    es: {
      ...
      rooms: [{
        ...
        body: 'Tu dormitorio principal mira al mar y tiene sábanas suaves y rellenos nórdicos de plumas o sintéticos. Colchones de alta calidad y almohadas de diferentes durezas. En el armario te espera la sombrilla de playa.',
        ...
        id: 'banos',
        title: 'Tus baños',
        body: 'Tus dos baños: uno con columna de hidroterapia y espejo de cromoterapia, y otro con ducha. Productos básicos para tus primeros días: aromas, velas, secador, botiquín y más.',
        ...
        id: 'terraza',
        title: 'Tu terraza',
        body: 'Tu terraza tiene dos ambientes para cada momento de las vacaciones: desayunar al sol de día, cenar al fresco al volver de la playa.',
    ...
    en: {
      ...
      rooms: [{
        ...
        id: 'dormitorios',
        title: 'Your bedrooms',
        body: 'Your master bedroom faces the sea and has soft sheets and feather or synthetic duvets. Quality mattresses and pillows of different firmness. Your beach umbrella waits in the closet.',
        ...
        body: 'Your two bathrooms: one with a hydrotherapy column and chromotherapy mirror, the other with a shower. Basic products for your first days: scents, candles, hairdryer, first-aid kit and more.',
        ...
        id: 'terraza',
        title: 'Your terrace',
        body: 'Your terrace has two set-ups for every moment of your holiday: breakfast in the sun by day, dinner outside after the beach.',
  ...
  vt: {
    ...
    es: {
      ...
      rooms: [{
        ...
        id: 'dormitorios',
        title: 'Tus dormitorios',
        body: 'Tu dormitorio principal mira al mar y a las palmeras de la urbanización. Colchones de alta calidad y almohadas de diferentes durezas. Sábanas suaves y rellenos nórdicos de plumas o sintéticos.',
        ...
        id: 'terraza',
        title: 'Tu terraza',
        body: 'Tu terraza panorámica de 18 m² mira al mar y al Salar de los Canos. El sitio del ático donde ver el día entero, del amanecer al atardecer.',
    ...
    en: {
      ...
      rooms: [{
        id: 'salon',
        title: 'Your living room',
        body: 'Your sofa-bed and flat-screen TV are the perfect spot for a movie night in. It is not the point of the stay, but SkyShowtime, HBO Max, Prime Video, Movistar Plus and Disney+ are always active, plus free apps. You control the temperature with the centralised A/C panel.',
        ...
        id: 'dormitorios',
        title: 'Your bedrooms',
        body: 'Your master bedroom looks out to the sea and the complex palm trees. Quality mattresses and pillows of different firmness. Soft sheets and feather or synthetic duvets.',
        ...
        id: 'terraza',
        title: 'Your terrace',
        body: 'Your 18 m² panoramic terrace looks out to the sea and the Salar de los Canos. The spot in the penthouse to watch the whole day go by, sunrise to sunset.',
      ...
      checkin: {
        ...
        modalities: [{
          ...
          tag: 'In-person check-in',
          body: 'Leila, our Thalassa host, or one of her team greets you, shows you around and answers anything on the spot. In-person reception hours: 15:00 – 21:00. If you arrive after 21:00 we switch to self check-in, unless you prefer in-person: it has an additional fee, paid to Leila on arrival.'
        }],
  ...
  vs: {
    ...
    es: {
      ...
      rooms: [{
        ...
        id: 'dormitorios',
        title: 'Tus dormitorios',
        body: 'Tus dormitorios tienen sábanas suaves y rellenos nórdicos de plumas. Colchones de alta calidad y almohadas de viscoelástica. En el armario te espera la sombrilla de playa.',
        recs: ['Las cremas bronceadoras pueden estropear sábanas, toallas y tapicerías.', 'Cuidado con el aire acondicionado por la noche y las corrientes de aire.', 'Ponte el despertador un día no muy nublado para ver el amanecer.']
      }, {
        id: 'banos',
        title: 'Tus baños',
        body: 'Tus dos baños: uno con bañera de hidromasaje, otro con ducha hidromasaje. Productos básicos para tus primeros días: aromas, velas, secador, botiquín y más.',
        recs: ['Haz un uso prudente y responsable del agua. El agua es vida.', 'Las toallas del baño no son para la playa ni para la piscina.', 'Cuidado con las cremas y maquillaje. Estropean los textiles del hogar.']
      }, {
        id: 'terraza',
        title: 'Tu terraza',
        body: 'Tu terraza tiene dos ambientes para cada momento de las vacaciones: mañanas tranquilas al sol y sobremesas largas cuando cae la luz.',
    ...
    en: {
      ...
      rooms: [{
        ...
        id: 'dormitorios',
        title: 'Your bedrooms',
        body: 'Your bedrooms have soft sheets and feather duvets. Quality mattresses and memory-foam pillows. Your beach umbrella waits in the closet.',
        ...
        id: 'banos',
        title: 'Your bathrooms',
        body: 'Your two bathrooms: one with a hydromassage bathtub, the other with a hydromassage shower. Basic products for your first days: scents, candles, hairdryer, first-aid kit and more.',
        recs: ['Use water responsibly. Water is life.', 'Bathroom towels are not for the beach or the pool.', 'Be careful with creams and make-up, they damage textiles.']
      }, {
        id: 'terraza',
        title: 'Your terrace',
        body: 'Your terrace has two set-ups for every moment of your holiday: quiet mornings in the sun and long after-dinner evenings as the light fades.',
      ...
      checkin: {
        ...
        modalities: [{
          ...
          tag: 'In-person check-in',
          body: 'Leila, our Salinas host, or one of her team greets you, shows you around and answers anything on the spot. In-person reception hours: 15:00 – 21:00. If you arrive after 21:00 we switch to self check-in, unless you prefer in-person: it has an additional fee, paid to Leila on arrival.'
        }],
...
function buildGuidePopup(p, col, ci, section, lang) {
  ...
  return `<div class="hgp">` + `<div class="hgp-tag" style="background:${col.fill}">${hiSvg(ci.hi, 12)} ${catLabel}</div>` + `<strong class="hgp-name">${p.name}</strong>` + (sd ? `<span class="hgp-desc">${sd}</span>` : '') + `<a href="${sLink}" class="hgp-link" style="color:${col.fill}">${sLabel} →</a>` + `</div>`;
}
...
const GuideMap = ({
  ...
  }, lang === 'es' ? `Mapa interactivo con ${withCoords} lugares de la guía. Toca cualquier pin para ver el detalle y navegar a esa sección.` : `Interactive map with ${withCoords} guide places. Tap any pin for details and a direct link to its section.`), /*#__PURE__*/React.createElement("div", {
    className: "ag-map-note ag-map-note-wip"
  ...
  }), lang === 'es' ? 'Mapa en construcción: algunos pines pueden no coincidir con la ubicación exacta del lugar.' : 'Map under construction: some pins may not match the exact location of the place.'));
};
...
const CompactPlaceItem = ({
  ...
  const hasDetails = p.desc || p.specialty || p.best || p.tip || p.services || p.access || p.level || p.url || p.discount_es || p.discount_en || Array.isArray(p.events) && p.events.length > 0;
  ...
  }), " ", p.rating.toFixed(1)), (lang === 'es' ? p.discount_es : p.discount_en) && /*#__PURE__*/React.createElement("span", {
    className: "ag-place-discount"
  }, /*#__PURE__*/React.createElement(HiIcon, {
    name: "ticket",
    size: 12,
    style: {
  ...
  }), lang === 'es' ? 'Descuento huésped' : 'Guest discount'), hasDetails && /*#__PURE__*/React.createElement("span", {
    className: `ag-place-compact-chev ${open ? 'open' : ''}`,
    "aria-hidden": "true"
  }, "↓")), open && /*#__PURE__*/React.createElement("div", {
    className: "ag-place-compact-body"
  }, (lang === 'es' ? p.discount_es : p.discount_en) && /*#__PURE__*/React.createElement("span", {
    className: "ag-place-discount-detail"
  }, /*#__PURE__*/React.createElement(HiIcon, {
    name: "ticket",
    size: 14,
    style: {
  ...
  }), lang === 'es' ? p.discount_es : p.discount_en), p.desc && /*#__PURE__*/React.createElement("span", {
    className: "ag-place-desc"
  }, iconifyText(p.desc)), p.specialty && /*#__PURE__*/React.createElement("span", {
  ...
  }, iconifyText(p.services)), p.access && /*#__PURE__*/React.createElement("span", {
    className: "ag-place-access"
  }, iconifyText(p.access)), p.level && /*#__PURE__*/React.createElement("span", {
...
const DishesGuide = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("article", {
      key: d.id,
      className: "ag-dish-card"
    }, /*#__PURE__*/React.createElement("div", {
      className: "ag-dish-head"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ag-dish-icon",
      "aria-hidden": "true"
    }, iconifyText(d.icon, 16)), /*#__PURE__*/React.createElement("div", {
      className: "ag-dish-titles"
    }, /*#__PURE__*/React.createElement("h4", {
      className: "ag-dish-name"
    }, name), /*#__PURE__*/React.createElement("span", {
      className: "ag-dish-region"
    }, region))), /*#__PURE__*/React.createElement("p", {
      className: "ag-dish-desc"
    }, desc), tip && /*#__PURE__*/React.createElement("p", {
      className: "ag-dish-tip"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ag-dish-tip-tag"
    }, lang === 'es' ? 'Tip:' : 'Tip:'), " ", tip), refs.length > 0 && /*#__PURE__*/React.createElement("div", {
      className: "ag-dish-where"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ag-dish-where-tag"
    }, lang === 'es' ? 'Dónde:' : 'Where:'), /*#__PURE__*/React.createElement("span", {
      className: "ag-dish-chips"
    }, refs.map(p => /*#__PURE__*/React.createElement("a", {
      key: p.id,
      className: "ag-dish-chip",
      ...
      className: "ag-dish-where-tag"
    }, lang === 'es' ? 'Dónde:' : 'Where:'), " ", whereText, d.extLink && /*#__PURE__*/React.createElement(React.Fragment, null, " ", /*#__PURE__*/React.createElement("a", {
      className: "ag-dish-extlink",
      href: d.extLink,
      target: "_blank",
      rel: "noopener"
...
const EventsCalendar = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Todas las fiestas y eventos de los pueblos del entorno (Almería + Murcia) en un solo calendario. El mes actual aparece desplegado; el resto se abre al pinchar.' : 'All the festivals and events from the surrounding villages (Almería + Murcia) in one calendar. The current month is open by default; click any other to expand.'), /*#__PURE__*/React.createElement("div", {
...
const FINDER_STOPWORDS = new Set(['de', 'del', 'la', 'el', 'los', 'las', 'un', 'una', 'unos', 'unas', 'en', 'y', 'o', 'que', 'para', 'con', 'algo', 'alguna', 'alguno', 'cosa', 'dame', 'dime', 'quiero', 'busco', 'necesito', 'recomienda', 'recomiendame', 'sin', 'por', 'muy', 'mas', 'ya', 'no', 'si', 'su', 'sus', 'como', 'tambien', 'solo', 'este', 'esta', 'esa', 'ese', 'eso', 'esto', 'hay', 'estan', 'pero', 'sea', 'sera', 'este', 'the', 'a', 'an', 'of', 'in', 'and', 'or', 'for', 'me', 'want', 'looking', 'give', 'something', 'anything', 'find', 'need', 'is', 'are', 'be', 'it', 'on', 'at', 'to', 'with', 'without', 'very', 'also', 'that', 'this', 'these', 'those']);
const FINDER_PROXIMITY_TERMS = ['cerca de una hestia', 'cerca de la hestia', 'cerca de hestia', 'cerca de mi hestia', 'near hestia', 'close to hestia', 'walking distance', 'a pie desde hestia', 'andando desde hestia'];
const FINDER_REGION_TERMS = ['almeria capital', 'san juan de los terreros', 'cuevas del almanzora', 'sierra cabrera', 'vera playa', 'villaricos', 'mojacar', 'garrucha', 'palomares', 'cartagena', 'aguilas', 'mazarron', 'roquetas', 'nijar', 'tabernas', 'lorca', 'murcia', 'almeria', 'vera'];
...
const FINDER_CAT_MAP = [{
  ids: ['beach-dog'],
  terms: ['playa para perros', 'playa perros', 'playas para perros', 'dog beach', 'dog friendly beach']
}, {
  ids: ['beach-nude'],
  terms: ['playa nudista', 'playa naturista', 'playas naturistas', 'nude beach', 'naturist beach']
}, {
  ids: ['beach-srvc'],
  terms: ['sombrilla', 'sombrillas', 'hamaca', 'hamacas', 'tumbona', 'tumbonas', 'socorrista', 'lifeguard', 'sunbed', 'sunbeds', 'umbrella', 'umbrellas']
}, {
  ids: ['beach-hard'],
  terms: ['dificil acceso', 'cala escondida', 'cala dificil', 'hard to reach', 'hard access beach']
}, {
  ids: ['beach', 'beach-dog', 'beach-nude', 'beach-srvc', 'beach-hard'],
  terms: ['playa', 'playas', 'beach', 'beaches', 'cala', 'calas', 'cove', 'coves']
}, {
  ids: ['michelin'],
  terms: ['michelin', 'estrella michelin']
}, {
  ids: ['celiac'],
  terms: ['celiaco', 'celiaca', 'sin gluten', 'gluten free', 'celiac']
}, {
  ids: ['restaurant'],
  terms: ['restaurante', 'restaurantes', 'restaurant', 'restaurants', 'comer', 'cena', 'cenar', 'comida', 'food', 'dinner', 'lunch']
}, {
  ids: ['bar'],
  terms: ['bar', 'bares', 'copas', 'chiringuito', 'tapas', 'tapear', 'pub', 'drinks', 'cerveza']
}, {
  ids: ['pet-board'],
  terms: ['guarderia mascota', 'residencia canina', 'residencia mascota', 'pet boarding', 'kennel', 'dog daycare']
}, {
  ids: ['pet-shop'],
  terms: ['tienda de animales', 'tienda mascotas', 'pienso', 'pet shop']
}, {
  ids: ['vet'],
  terms: ['veterinario', 'veterinaria', 'vet', 'veterinary']
}, {
  ids: ['super'],
  terms: ['supermercado', 'super', 'comprar comida', 'grocery', 'supermarket', 'groceries']
}, {
  ids: ['fish'],
  terms: ['pescaderia', 'carniceria', 'panaderia', 'fishmonger', 'butcher', 'bakery']
}, {
  ids: ['pharmacy'],
  terms: ['farmacia', 'pharmacy']
}, {
  ids: ['health'],
  terms: ['urgencias', 'hospital', 'centro de salud', 'emergency', 'clinic']
}, {
  ids: ['physio'],
  terms: ['fisioterapia', 'fisio', 'physiotherapy', 'physio']
}, {
  ids: ['gem'],
  terms: ['imprescindible', 'must see', 'visita unica']
}, {
  ids: ['water'],
  terms: ['buceo', 'kayak', 'paddel', 'paddle surf', 'vela', 'snorkel']
}, {
  ids: ['adventure'],
  terms: ['aventura', 'adrenalina', 'adventure']
}, {
  ids: ['trek'],
  terms: ['ruta', 'rutas', 'senderismo', 'sendero', 'hiking', 'trail', 'trekking']
}, {
  ids: ['leisure'],
  terms: ['parque', 'ocio', 'niños', 'ninos', 'kids', 'family fun']
}, {
  ids: ['bodega'],
  terms: ['bodega', 'bodegas', 'vino', 'vinos', 'enoturismo', 'winery', 'wine']
}, {
  ids: ['town'],
  terms: ['pueblo', 'pueblos', 'town', 'village']
}, {
  ids: ['bookshop'],
  terms: ['libreria', 'libros', 'bookshop', 'books']
}, {
  ids: ['abasto'],
  terms: ['mercado de abastos', 'mercado cubierto', 'covered market']
}, {
  ids: ['market'],
  terms: ['mercadillo', 'mercadillos', 'street market']
}, {
  ids: ['fuel'],
  terms: ['gasolinera', 'gasolina', 'petrol', 'gas station']
}, {
  ids: ['ev-charge'],
  terms: ['carga electrica', 'punto de carga', 'ev charging', 'electric car charge']
}, {
  ids: ['coworking'],
  terms: ['coworking', 'teletrabajo', 'remote work']
}, {
  ids: ['laundry'],
  terms: ['lavanderia', 'tintoreria', 'laundry', 'dry cleaning']
}, {
  ids: ['atm'],
  terms: ['cajero', 'banco', 'atm', 'bank']
}];
...
function findGuidePlaces(rawQuery) {
  ...
  if (usedProximity) {
    ...
    scored.forEach(s => {
      s.dist = Math.min(...hestias.map(h => _finderDist(h.lat, h.lng, s.p.lat, s.p.lng)));
    });
  ...
  return {
    results: scored.slice(0, 6).map(s => s.p),
    matchedCatIds,
    matchedRegion,
    usedProximity
  };
...
const PlaceFinder = ({
  ...
  const placeholder = lang === 'es' ? 'Ej. un restaurante cerca de una Hestía, algo en Murcia, una playa con sombrillas…' : 'E.g. a restaurant near a Hestía, something in Murcia, a beach with sunbeds…';
  return /*#__PURE__*/React.createElement("div", {
    className: "ag-finder"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3"
  }, lang === 'es' ? 'Busca algo concreto' : 'Search for something specific'), /*#__PURE__*/React.createElement("p", {
    className: "ag-finder-note"
  }, lang === 'es' ? 'Escribe lo que buscas con tus palabras. Buscamos entre los sitios que ya conocemos y recomendamos en esta guía, no en internet en tiempo real: si no encuentras justo lo que necesitas, o quieres confirmar un dato, escríbenos.' : 'Type what you are looking for in your own words. We search among the places we already know and recommend in this guide, not live on the internet: if you cannot find exactly what you need, or want to confirm a detail, message us.'), /*#__PURE__*/React.createElement("form", {
    className: "ag-finder-form",
    onSubmit: onSubmit
    ...
    type: "submit",
    className: "ag-finder-submit"
  }, lang === 'es' ? 'Buscar' : 'Search')), result && (result.results.length > 0 ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    className: "ag-finder-summary"
  }, lang === 'es' ? `${result.results.length} resultado${result.results.length === 1 ? '' : 's'}${result.usedProximity ? ', ordenados por cercanía a Hestía' : ''}:` : `${result.results.length} result${result.results.length === 1 ? '' : 's'}${result.usedProximity ? ', sorted by distance from Hestía' : ''}:`), /*#__PURE__*/React.createElement("ul", {
    className: "ag-places ag-places-compact ag-finder-results"
  }, result.results.map(p => /*#__PURE__*/React.createElement(CompactPlaceItem, {
    key: p.id,
    p: p,
    lang: lang
  })))) : /*#__PURE__*/React.createElement("p", {
    className: "ag-finder-empty"
  }, lang === 'es' ? 'No hemos encontrado nada claro con esas palabras en esta guía. Prueba con otros términos, o pregúntanos directamente por el chat.' : 'We could not find a clear match for that in this guide. Try different words, or ask us directly through the chat.')));
};
...
// --- Yacimientos arqueológicos ---
{
  ...
  subcat: 'yacimientos',
  name_es: 'Yacimiento de El Argar',
  ...
  subcat: 'yacimientos',
  name_es: 'Villaricos (Baria fenicio-romana)',
  ...
  subcat: 'yacimientos',
  name_es: 'Yacimiento de Tagilis (Tíjola)',
  ...
  subcat: 'yacimientos',
  name_es: 'Necrópolis megalítica de Gorafe',
  ...
  subcat: 'yacimientos',
  name_es: 'Cerro de Montecristo (Adra)',
...
{
  subcat: 'castillos',
  name_es: 'Castillo de San Juan de los Terreros',
  ...
  subcat: 'castillos',
  name_es: 'Castillo-fortaleza de Vera',
  ...
  subcat: 'castillos',
  name_es: 'Castillo del Marqués de los Vélez (Cuevas del Almanzora)',
  ...
  subcat: 'castillos',
  name_es: 'Castillo de San Juan de las Águilas',
  ...
  subcat: 'castillos',
  name_es: 'Castillo de Vélez-Blanco',
  ...
  subcat: 'castillos',
  name_es: 'Fortaleza del Sol (Castillo de Lorca)',
  ...
  subcat: 'castillos',
  name_es: 'Castillo de la Concepción (Cartagena)',
  ...
  subcat: 'castillos',
  name_es: 'Castillo de Mojácar la Vieja',
...
// --- Patrimonio islámico ---
{
  ...
  subcat: 'islamico',
  name_es: 'Aljibes árabes de Jayrán (Almería)',
  ...
  subcat: 'islamico',
  name_es: 'Murallas de Jayrán (Almería)',
  ...
  subcat: 'islamico',
  name_es: 'Baños árabes de Alhama de Almería',
...
{
  subcat: 'romano',
  name_es: 'Teatro Romano de Cartagena',
  ...
  subcat: 'romano',
  name_es: 'Barrio del Foro Romano (Molinete)',
  ...
  subcat: 'romano',
  name_es: 'Decumano Romano de Cartagena',
  ...
  subcat: 'romano',
  name_es: 'Anfiteatro Romano de Cartagena',
  ...
  subcat: 'romano',
  name_es: 'Casa de la Fortuna (Cartagena)',
  ...
  subcat: 'romano',
  name_es: 'Yacimiento romano de Villaricos',
...
{
  subcat: 'cuevas',
  name_es: 'Geoda Gigante de Pulpí',
  ...
  subcat: 'cuevas',
  name_es: 'Karst en Yesos de Sorbas (Cuevas)',
  ...
  subcat: 'cuevas',
  name_es: 'Cueva de los Letreros (Vélez-Blanco)',
  ...
  subcat: 'cuevas',
  name_es: 'Cuevas de Almanzora (casas-cueva)',
  ...
  subcat: 'cuevas',
  name_es: 'Mesa Roldán (Carboneras)',
  ...
  subcat: 'cuevas',
  name_es: 'Gredas de Bolnuevo (Mazarrón)',
...
{
  subcat: 'faros',
  name_es: 'Faro de Mesa Roldán (Carboneras)',
  ...
  subcat: 'faros',
  name_es: 'Faro de la Polacra (Cabo de Gata)',
  ...
  subcat: 'faros',
  name_es: 'Mirador de la Amatista (Cabo de Gata)',
  ...
  subcat: 'faros',
  name_es: 'Mirador del Arrecife de las Sirenas',
  ...
  subcat: 'faros',
  name_es: 'Mirador de la Granatilla (Carboneras)',
...
{
  subcat: 'naturaleza',
  name_es: 'Salinas de Cabo de Gata',
  ...
  subcat: 'naturaleza',
  name_es: 'Observatorio de Calar Alto (Gérgal)',
  ...
  subcat: 'naturaleza',
  name_es: 'Playa de los Muertos (Carboneras)',
  ...
  subcat: 'naturaleza',
  name_es: 'Parque Natural Sierra María-Los Vélez',
  ...
  subcat: 'naturaleza',
  name_es: 'Isla de Terreros y Negra (Pulpí)',
...
{
  subcat: 'familia',
  name_es: 'Oasys MiniHollywood (Tabernas)',
  ...
  subcat: 'familia',
  name_es: 'Fort Bravo / Texas Hollywood (Tabernas)',
  ...
  subcat: 'familia',
  name_es: 'Western Leone (Tabernas)',
  ...
  subcat: 'familia',
  name_es: 'Aquarium Costa de Almería (Roquetas)',
  ...
  subcat: 'familia',
  name_es: 'Parque de las Familias (Almería capital)',
  ...
  subcat: 'familia',
  name_es: 'Refugios de la Guerra Civil (Almería capital)',
...
const SUBCATS = [{
  ...
  id: 'castillos',
  es: 'Castillos y fortalezas',
  en: 'Castles & fortresses',
  icon: '🏰',
  hi: 'shield'
}, {
  id: 'islamico',
  es: 'Patrimonio islámico',
  en: 'Islamic heritage',
  icon: '☪',
  hi: 'star'
}, {
  id: 'romano',
  es: 'Patrimonio romano',
  en: 'Roman heritage',
  icon: '🏛️',
  hi: 'buildings'
}, {
  id: 'cuevas',
  es: 'Cuevas y geología',
  en: 'Caves & geology',
  icon: '🕳️',
  hi: 'mountain'
}, {
  id: 'faros',
  es: 'Faros y miradores',
  en: 'Lighthouses & viewpoints',
  icon: '🗼',
  hi: 'pin'
}, {
  id: 'naturaleza',
  es: 'Naturaleza singular',
  en: 'Singular nature',
  icon: '🌿',
  hi: 'olive'
}, {
...
const PlacesOfInterestAtlas = ({
  lang
}) => {
  if (!PLACES_OF_INTEREST || PLACES_OF_INTEREST.length === 0) {
    return /*#__PURE__*/React.createElement("p", {
      className: "ag-para ag-para-note"
    }, lang === 'es' ? 'Atlas en preparación, estamos curando la lista. Disponible muy pronto.' : 'Atlas in preparation, we are curating the list. Available very soon.');
  }
  return /*#__PURE__*/React.createElement("div", {
    className: "ag-poi-atlas"
  }, SUBCATS.map(sc => {
    const items = PLACES_OF_INTEREST.filter(p => p.subcat === sc.id);
    if (items.length === 0) return null;
    return /*#__PURE__*/React.createElement("div", {
      key: sc.id,
      className: "ag-poi-cat"
    }, /*#__PURE__*/React.createElement("h3", {
      className: "ag-poi-cat-title"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ag-poi-cat-icon",
      "aria-hidden": "true",
      style: {
        color: 'var(--sol-text, #176E80)'
      }
    }, /*#__PURE__*/React.createElement(HiIcon, {
      name: sc.hi,
      size: 18
    })), /*#__PURE__*/React.createElement("span", null, lang === 'es' ? sc.es : sc.en), /*#__PURE__*/React.createElement("span", {
      className: "ag-poi-cat-count"
    }, items.length)), /*#__PURE__*/React.createElement("ul", {
      className: "ag-poi-list"
    }, items.map((p, i) => {
      ...
      return /*#__PURE__*/React.createElement("li", {
        key: i,
        className: "ag-poi-row"
      }, /*#__PURE__*/React.createElement("div", {
        className: "ag-poi-row-main"
      }, /*#__PURE__*/React.createElement("a", {
        className: "ag-poi-name",
        href: url,
        target: "_blank",
        rel: "noopener noreferrer"
      }, name), desc && /*#__PURE__*/React.createElement("span", {
        className: "ag-poi-desc"
      }, ", ", desc)), /*#__PURE__*/React.createElement("div", {
        className: "ag-poi-row-meta"
      }, /*#__PURE__*/React.createElement("span", {
        className: "ag-poi-km"
      ...
      }, iconifyText(lang === 'es' ? p.comoLlegar_es || p.comoLlegar_en : p.comoLlegar_en || p.comoLlegar_es)), p.anchor && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
        className: "ag-poi-sep"
      }, "·"), /*#__PURE__*/React.createElement("a", {
...
const CatGroup = ({
  ...
  const [open, setOpen] = React.useState(false);
  const featured = places.filter(p => p.featured).sort((a, b) => (a.featuredOrder || 99) - (b.featuredOrder || 99));
  const rest = places.filter(p => !p.featured);
  const renderPlace = p => {
    const mapHref = p.url || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(p.name + ' Almería')}`;
    return /*#__PURE__*/React.createElement("li", {
      key: p.id,
      className: `ag-place${p.featured ? ' is-featured' : ''}`
    }, /*#__PURE__*/React.createElement("div", {
      className: "ag-place-main"
    ...
    }), lang === 'es' ? 'Descuento huésped' : 'Guest discount')), (lang === 'es' ? p.discount_es : p.discount_en) && /*#__PURE__*/React.createElement("span", {
      className: "ag-place-discount-detail"
    }, /*#__PURE__*/React.createElement(HiIcon, {
      name: "ticket",
      size: 14,
    ...
    }), lang === 'es' ? p.discount_es : p.discount_en), (p.desc || p.desc_en) && /*#__PURE__*/React.createElement("span", {
      className: "ag-place-desc"
    }, iconifyText(lang === 'en' && p.desc_en ? p.desc_en : p.desc), p.dist && /*#__PURE__*/React.createElement("span", {
      ...
      className: "ag-place-access",
      "aria-label": lang === 'es' ? 'Acceso' : 'Access'
    }, iconifyText(p.access)), p.level && /*#__PURE__*/React.createElement("span", {
      className: "ag-place-level"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ag-place-level-tag"
...
const GuestDiscounts = ({
  ...
  return /*#__PURE__*/React.createElement("ul", {
    className: "ag-places ag-discounts-list"
  }, list.map(p => {
    const mapHref = p.url || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(p.name + ' Almería')}`;
    return /*#__PURE__*/React.createElement("li", {
      key: p.id,
      className: "ag-place is-featured"
    }, /*#__PURE__*/React.createElement("div", {
      className: "ag-place-main"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ag-place-star",
      ...
      className: "ag-place-desc"
    }, iconifyText(p.desc)), /*#__PURE__*/React.createElement("a", {
      className: "ag-place-link",
      href: mapHref,
      target: "_blank",
      rel: "noopener"
    }, lang === 'es' ? 'Ver web' : 'Visit website', " ", /*#__PURE__*/React.createElement("span", {
      "aria-hidden": "true"
    }, "↗")));
  }));
};
...
// ================================================================
const Top5BeachesBand = ({
  places,
  lang
}) => {
  const tops = places.filter(p => p.top5).sort((a, b) => (a.featuredOrder || 99) - (b.featuredOrder || 99));
  if (!tops.length) return null;
  return /*#__PURE__*/React.createElement("div", {
    className: "ag-top5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ag-top5-head"
  }, /*#__PURE__*/React.createElement("span", {
    className: "eyebrow"
  }, lang === 'es' ? 'Lo que no te puedes perder' : 'Don\'t-miss spots'), /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3",
    style: {
      margin: 0
    }
  }, lang === 'es' ? 'Top 5 playas de la zona' : 'Top 5 beaches around')), /*#__PURE__*/React.createElement("ol", {
    className: "ag-top5-list"
  }, tops.map(p => {
    const mapHref = p.url || `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(p.name + ' Almería')}`;
    const photosHref = `https://www.google.com/search?tbm=isch&q=${encodeURIComponent(p.name + ' Almería')}`;
    return /*#__PURE__*/React.createElement("li", {
      key: p.id,
      className: "ag-top5-item"
    }, /*#__PURE__*/React.createElement("span", {
      className: "ag-top5-num"
    }, String(p.featuredOrder).padStart(2, '0')), /*#__PURE__*/React.createElement("a", {
    ...
    }, iconifyText(p.desc)), p.services && /*#__PURE__*/React.createElement("span", {
      className: "ag-top5-meta"
    }, /*#__PURE__*/React.createElement("em", null, lang === 'es' ? 'Servicios:' : 'Services:'), " ", iconifyText(p.services)), p.access && /*#__PURE__*/React.createElement("span", {
      className: "ag-top5-meta"
    }, /*#__PURE__*/React.createElement("em", null, lang === 'es' ? 'Acceso:' : 'Access:'), " ", iconifyText(p.access)), /*#__PURE__*/React.createElement("div", {
      className: "ag-top5-links"
    }, /*#__PURE__*/React.createElement("a", {
      href: mapHref,
      target: "_blank",
      rel: "noopener"
...
const DAY_PLAN_GROUPS = {
  morning: {
    es: 'Madrugadores',
    en: 'Early birds',
    sub_es: 'Empezar al amanecer y terminar comiendo',
    sub_en: 'Start at sunrise, finish over lunch'
  },
  fullday: {
    es: 'Día completo',
    en: 'Full-day',
    sub_es: 'Mañana, comida y tarde sin prisas',
    sub_en: 'Morning, lunch, afternoon, unhurried'
  },
  evening: {
    es: 'Tarde-noche',
    en: 'Evening',
    sub_es: 'Atardecer, cena y un sitio especial',
    sub_en: 'Sunset, dinner and a beautiful night spot'
  }
};
...
const ICONIC_DISHES = [{
  id: 'gurullos',
  icon: '🍝',
  name_es: 'Gurullos almerienses',
  name_en: 'Almerían gurullos',
  region_es: 'Almería · Levante',
  region_en: 'Almería · Levante',
  ...
  id: 'olla-trigo',
  icon: '🍲',
  name_es: 'Olla de trigo',
  name_en: 'Wheat stew (olla de trigo)',
  region_es: 'Levante almeriense',
  region_en: 'Levante almeriense',
  ...
  id: 'caldero-almeriense',
  icon: '🥘',
  name_es: 'Caldero almeriense',
  name_en: 'Almerían caldero (rice & fish)',
  region_es: 'Almería',
  region_en: 'Almería',
  ...
  id: 'gamba-roja',
  icon: '🦐',
  name_es: 'Gamba roja de Garrucha',
  name_en: 'Garrucha red shrimp',
  region_es: 'Garrucha · marca de calidad',
  region_en: 'Garrucha · quality label',
  ...
  id: 'quisquilla',
  icon: '🍤',
  name_es: 'Quisquilla y camarón de Garrucha',
  name_en: 'Garrucha pink shrimp & prawn',
  region_es: 'Garrucha',
  region_en: 'Garrucha',
  ...
  id: 'migas',
  icon: '🌾',
  name_es: 'Migas almerienses',
  name_en: 'Almerían migas',
  region_es: 'Almería',
  region_en: 'Almería',
  ...
  id: 'atun-almadraba',
  icon: '🐟',
  name_es: 'Atún rojo de almadraba',
  name_en: 'Almadraba bluefin tuna',
  region_es: 'Costa · temporada',
  region_en: 'Coast · in season',
  ...
  id: 'pescaito-frito',
  icon: '🍽️',
  name_es: 'Pescaíto frito y fritura mixta',
  name_en: 'Fried fish platter',
  region_es: 'Toda la costa',
  region_en: 'All along the coast',
  ...
  id: 'caldero-mar-menor',
  icon: '🥘',
  name_es: 'Caldero del Mar Menor',
  name_en: 'Mar Menor caldero',
  region_es: 'Murcia · Mar Menor',
  region_en: 'Murcia · Mar Menor',
  ...
  id: 'paparajotes',
  icon: '🍋',
  name_es: 'Paparajotes (Murcia)',
  name_en: 'Paparajotes (Murcia)',
  region_es: 'Murcia · postre',
  region_en: 'Murcia · dessert',
  ...
  id: 'marinera',
  icon: '🥖',
  name_es: 'Marinera murciana',
  name_en: 'Murcian "marinera"',
  region_es: 'Murcia · tapa',
  region_en: 'Murcia · tapa',
  ...
  id: 'pastel-carne',
  icon: '🥧',
  name_es: 'Pastel de carne murciano',
  name_en: 'Murcian meat pie',
  region_es: 'Murcia',
  region_en: 'Murcia',
  ...
  id: 'tabernero',
  icon: '🍞',
  name_es: 'Tabernero almeriense',
  name_en: 'Tabernero (Almerían pisto-tapa)',
  region_es: 'Almería · tapa',
  region_en: 'Almería · tapa',
  ...
  id: 'ajo-colorao',
  icon: '🌶️',
  name_es: 'Ajo colorao con raya',
  name_en: 'Red garlic stew with stingray',
  region_es: 'Levante almeriense',
  region_en: 'Levante almeriense',
  ...
  id: 'olla-col',
  icon: '🥬',
  name_es: 'Olla de col (berza almeriense)',
  name_en: 'Cabbage stew (Almerían berza)',
  region_es: 'Almería · invierno',
  region_en: 'Almería · winter',
  ...
  id: 'guiso-pelotas',
  icon: '🥣',
  name_es: 'Guiso de pelotas',
  name_en: 'Almerían meatball stew',
  region_es: 'Almería',
  region_en: 'Almería',
  ...
  id: 'caldo-pimenton',
  icon: '🍵',
  name_es: 'Caldo pimentón',
  name_en: 'Paprika broth (caldo pimentón)',
  region_es: 'Levante almeriense',
  region_en: 'Levante almeriense',
  ...
  id: 'choto-ajillo',
  icon: '🐐',
  name_es: 'Choto al ajillo',
  name_en: 'Garlic kid (baby goat)',
  region_es: 'Almería interior · Alpujarra',
  region_en: 'Almería interior · Alpujarra',
  ...
  id: 'marrana-pulpo',
  icon: '🐙',
  name_es: 'Marraná de pulpo',
  name_en: 'Octopus marraná',
  region_es: 'Cabo de Gata · Carboneras',
  region_en: 'Cabo de Gata · Carboneras',
  ...
  id: 'zarangollo',
  icon: '🍳',
  name_es: 'Zarangollo murciano',
  name_en: 'Zarangollo (Murcian courgette)',
  region_es: 'Murcia · tapa',
  region_en: 'Murcia · tapa',
  ...
  icon: '🥗',
  name_es: 'Ensalada murciana (moje)',
  name_en: 'Murcian salad (moje)',
  region_es: 'Murcia · tapa',
  region_en: 'Murcia · tapa',
  ...
  id: 'arroz-conejo-caracoles',
  icon: '🐌',
  name_es: 'Arroz con conejo y caracoles',
  name_en: 'Rice with rabbit and snails',
  region_es: 'Murcia · huerta',
  region_en: 'Murcia · huerta',
  ...
  id: 'torticas-avio',
  icon: '🥞',
  name_es: 'Torticas de avío',
  name_en: 'Avío flatbreads',
  region_es: 'Almería interior',
  region_en: 'Inland Almería',
...
const TAPAS_ROUTES = [{
  ...
  stops: [{
    name: 'Bar Juan y Sole (C. Mayor, 72)',
    what_es: 'Primera parada: barra activa, tapa incluida con la consumición. Cerveza fría con chocos fritos o gambas al ajillo. ~2,50-3 € el combinado.',
    what_en: 'First stop: busy bar counter, tapa included with every drink. Cold beer with fried squid or garlic prawns. ~€2.50-3 per round.'
  }, {
    name: 'Bar la Plaza (C. Rda. Verasol, 5)',
    what_es: 'Bar de tapas del barrio con buena valoración. Croquetas caseras, ensaladilla y tapas del día. Mesa fuera en verano.',
    what_en: 'Well-rated neighbourhood tapas bar. Home-made croquettes, ensaladilla and daily tapas. Outdoor table in summer.'
  }, {
    name: 'Bar La Penúltima (C. Mayor, 51)',
    what_es: 'Para el último trago del día (abre a las 19:30): vermut de grifo, aceitunas y tapa de queso curado. Ambiente tranquilo y parroquiano.',
    what_en: 'For the last drink of the evening (opens 19:30): draft vermouth, olives and aged cheese tapa. Calm, regular-crowd atmosphere.'
  }],
  ...
  stops: [{
    name: 'Bares junto a la lonja',
    what_es: 'Empezar al caer la tarde: caña, camarones crudos y quisquilla viva. Llegar sobre las 19:00 cuando atracan los barcos. Los bares de la primera línea tienen el producto más fresco.',
    what_en: 'Start at sundown: beer, raw camarones and live quisquilla prawns. Arrive around 19:00 when the boats dock. First-row bars have the freshest produce.'
  }, {
    name: 'Restaurante Rincón del Puerto',
    what_es: 'Uno de los más concurridos del puerto. Gamba roja a la plancha: pedirla sin más, no necesita nada. El punto de cocción es clave: vuelta y vuelta. También: almejas a la marinera o cazuela de rape.',
    what_en: 'One of the port\'s busiest bars. Grilled red prawns: order them plain, they need nothing else. The cooking point is everything: just seared. Also: clams marinera or monkfish cazuela.'
  }, {
    name: 'Bar Almanzora',
    what_es: 'Parrilla y barra. Para cerrar con una ración completa: carnes a la brasa, tapa del día o un caldoso de marisco con vistas al paseo marítimo.',
    what_en: 'Grill and bar counter. To close with a full dish: chargrilled meats, daily tapa or shellfish caldoso with views over the promenade.'
  }],
  ...
  id: 'tapas-mojacar',
  city_es: 'Mojácar pueblo',
  city_en: 'Mojácar village',
  ...
  stops: [{
    name: 'Bar Puerta de la Ciudad',
    what_es: 'Primera parada al llegar al pueblo (abre a las 19:00). Barra activa con tapas del día, croquetas y vino de la tierra. Valoración muy alta entre los locales.',
    what_en: 'First stop when you reach the village (opens 19:00). Busy bar counter with daily tapas, croquettes and local wine. Very highly rated by locals.'
  }, {
    name: 'La Bodega Tapa y Caña',
    what_es: 'Vino y tapas en ambiente de bodega. Buena selección de vinos por copas, tabla ibérica y tapas de temporada. Mesa fuera en verano.',
    what_en: 'Wine and tapas in a bodega atmosphere. Good wine-by-the-glass selection, Iberian charcuterie board and seasonal tapas. Outdoor table in summer.'
  }, {
    name: 'Marcelo Entre Tapas',
    what_es: 'Para la última ronda: tapas elaboradas con producto local, buena selección de vermuts y vinos. Ambiente animado desde las 20:00.',
    what_en: 'For the last round: well-crafted tapas with local produce, good vermouth and wine selection. Lively atmosphere from 20:00.'
  }],
  ...
  stops: [{
    name: 'Taberna su_ka',
    what_es: 'Bar de tapas del centro de San José con buena valoración. Pulpo a la brasa, gambas a la plancha y tapas del mar. Abre a partir del mediodía.',
    what_en: 'Well-rated tapas bar in the centre of San José. Grilled octopus, griddle prawns and seafood tapas. Opens from midday.'
  }, {
    name: 'Restaurante El Òctopus',
    what_es: 'Bar de tapas de pescado y marisco; uno de los locales con más reseñas del pueblo. Abre a las 19:00. Pide lo que ofrezcan del día: la materia prima viene del Parque Natural.',
    what_en: 'Fish and seafood tapas bar; one of the most-reviewed spots in the village. Opens at 19:00. Order the daily special, the produce comes from the Natural Park.'
  }, {
  ...
  stops: [{
    name: 'Casa Puga',
    what_es: 'Taberna fundada en 1870, en la calle Jovellanos. Imprescindible: caracoles, ensaladilla almeriense y gambas en gabardina. Sin reservas, llega antes de las 13:30 o a las 20:00. La barra de azulejo y los barriles son parte del ritual.',
    what_en: 'Tavern founded in 1870 on Calle Jovellanos. Unmissable: snails, Almerían ensaladilla and battered prawns. No bookings, arrive before 13:30 or at 20:00. The tiled bar and barrels are part of the ritual.'
  }, {
    name: 'Los Diamantes',
    what_es: 'La fritura almeriense en su versión más pura: boquerones, chocos, gambas rebozadas y soldaditos de Pavía (bacalao). Cola frecuente a mediodía, merece la pena.',
    what_en: 'Almerían frying at its purest: anchovies, squid, battered prawns and Pavía-style salt cod. Frequent queue at midday, worth it.'
  }, {
    name: 'Bar Nevada',
    what_es: 'Clásico del centro histórico. Barra siempre animada, tapa generosa con cada consumición. Tapas de cuchara, ensaladilla y platos del día al precio de siempre.',
    what_en: 'Historic-centre classic. Always busy bar counter, generous tapa with every drink. Stewed tapas, ensaladilla and daily dishes at traditional prices.'
  }, {
    name: 'Bar El Chele',
    what_es: 'Taberna de barrio con ambiente de toda la vida. Conocida entre los almerienses por su barra informal y tapas generosas. Sin pretensiones, todo es producto.',
    what_en: 'Neighbourhood tavern with a timeless atmosphere. Known among Almería locals for its unpretentious bar counter and generous tapas. No frills, all produce.'
  }, {
    name: 'La Mala',
  ...
  stops: [{
    name: 'El Pimiento',
    what_es: 'La taberna de referencia de Águilas: bar muy concurrido con terraza, abre a las 19:00. Quisquilla y langostinos de la costa murciana, tapas del día, coquinas a la plancha. Ambiente local puro.',
    what_en: 'Águilas\' benchmark tavern: busy bar with terrace, opens at 19:00. Quisquilla and local langostinos, daily tapas, griddled coquinas. Pure local atmosphere.'
  }, {
    name: 'El Plazero',
    what_es: 'Taberna del casco antiguo con buena valoración. Tapa incluida con la consumición, herencia murciana. Pide vino DOP Bullas (el más cercano) o un vermut de grifo.',
    what_en: 'Old-town tavern with good ratings. Tapa included with every drink, Murcian tradition. Order DOP Bullas wine (the closest DO) or a draft vermouth.'
  }, {
    name: 'Pecado Águilas',
    what_es: 'Bar popular con miles de reseñas. Buena rotación de tapas y ambiente animado. Para la segunda parada de la ruta.',
    what_en: 'Popular bar with thousands of reviews. Good tapa rotation and lively atmosphere. Good for the second stop on the route.'
  }],
  ...
  stops: [{
    name: 'Puerto de Mazarrón · bares de barra junto a la lonja',
    what_es: 'Puerto pesquero activo. Pescaíto frito directo de la lonja, caldero del Mar Menor (arroz con pescado de roca) y camarones frescos. Los bares de la primera línea son los más auténticos.',
    what_en: 'Active fishing port. Freshly fried fish from the daily catch, Mar Menor caldero (rock fish rice) and fresh camarones. First-row bars closest to the quay are the most authentic.'
  }, {
    name: 'Cartagena · bares de Calle Mayor y Plaza San Sebastián',
    what_es: 'La marinera: boquerón en vinagre sobre rosquilla con oliva, invento 100% cartagenero. La barra de cualquier bar clásico de la Calle Mayor o la Plaza San Sebastián es el sitio donde pedirla. ~1,50 € la unidad.',
    what_en: 'The marinera: marinated anchovy on a rosquilla ring with olive, 100% Cartagena invention. Any classic bar on Calle Mayor or Plaza San Sebastián is the right place to order one. ~€1.50 each.'
  }, {
    name: 'Cartagena · Barrio del Foro Romano',
    what_es: 'Paseo entre barras con vistas al Teatro Romano. Vermut de grifo y marineras adicionales. Los bares de barrio de esta zona tienen tapa incluida en la consumición.',
    what_en: 'Bar walk with views of the Roman Theatre. Draft vermouth and more marineras. Neighbourhood bars in this area include a tapa with every drink.'
  }],
  ...
  stops: [{
    ...
    what_es: 'El epicentro del tapeo murciano. La plaza tiene terrazas animadas; la Trapería, la calle más antigua de la ciudad, bares de azulejo y madera. Pide zarangollo (huevo revuelto con calabacín y cebolla) y pasteles de carne (empanadillas de carne especiada).',
    ...
    name: 'Gran Bar Rhin',
    what_es: 'Institución histórica de Murcia desde 1879, frente al Casino. Barra clásica, vermut de grifo y tapas de la tierra. El local más representativo del tapeo murciano de siempre.',
    ...
    what_es: 'Zona de bodegas y barras de toda la vida. Marinera, michirones (habas secas guisadas con chorizo) y morcilla con arroz. Vino de Jumilla o Bullas por copas a buen precio.',
  ...
  stops: [{
    name: 'Albedrío (Pl. Calderón de la Barca, 2)',
    what_es: 'Bar de tapas de referencia en Lorca: tapas típicas refinadas y vinos de la tierra. Uno de los más valorados de la ciudad, con miles de reseñas. Ambiente animado en la plaza.',
    what_en: 'Lorca\'s benchmark tapas bar: refined traditional tapas and local wines. One of the city\'s most-reviewed spots. Lively atmosphere on the square.'
  }, {
    name: 'Taberna La Cepa (Pl. Abastos, 13)',
    what_es: 'Bar de tapas junto al mercado de abastos. Selección de vinos y tapas de temporada. Terraza en una de las plazas más animadas del centro.',
    what_en: 'Tapas bar next to the covered market. Wine selection and seasonal tapas. Terrace on one of the centre\'s most lively squares.'
  }, {
    name: 'El Doblao (C. Dr. Arcas Meca)',
    what_es: 'Bar de barrio con valoración excelente. Barra íntima, tapas del día y ambiente local sin pretensiones. El típico sitio que los vecinos no cuentan a los turistas.',
    what_en: 'Neighbourhood bar with excellent ratings. Intimate bar counter, daily tapas and unpretentious local atmosphere. The kind of place locals keep to themselves.'
  }],
  ...
  stops: [{
    name: 'La Frontera',
    what_es: 'Bar de tapas de toda la vida con miles de reseñas: tapas de siempre y fútbol en pantalla. El más concurrido del pueblo. Precios de barrio, producto de puerto.',
    what_en: 'Traditional tapas bar with thousands of reviews: classic tapas and football on screen. The busiest bar in the village. Neighbourhood prices, port-fresh produce.'
  }, {
    name: 'Aquí Santoña, Tienda y Tapas',
    what_es: 'Bar de tapas especializado en conservas y anchoas del Cantábrico. Abre a las 19:30. Anchoa sobre pan con tomate, boquerones y conservas de calidad. Distinto y muy bueno.',
    what_en: 'Tapas bar specialising in tinned fish and Cantabrian anchovies. Opens 19:30. Anchovy on bread with tomato, marinated anchovies and quality tinned produce. Different and very good.'
  }, {
    name: 'La Taberna del Berru',
    what_es: 'Taberna de barrio con buena valoración. Barra activa, tapas marineras y platos del día. Buena relación calidad-precio y ambiente de pueblo pesquero auténtico.',
    what_en: 'Neighbourhood tavern with good ratings. Busy bar counter, seafood tapas and daily dishes. Good value and a genuine fishing-village atmosphere.'
  }],
...
const PLAN_META = {
  'plan-flamencos': {
    duration_h: 7,
    themes: ['naturaleza', 'familia', 'gastronomia']
  },
  'plan-monsul-amanecer': {
    duration_h: 8,
    themes: ['naturaleza', 'pintoresco']
  },
  'plan-sendero-litoral': {
    duration_h: 7,
    themes: ['naturaleza', 'aventura', 'relax']
  },
  'plan-cabo-gata': {
    duration_h: 10,
    themes: ['naturaleza', 'aventura', 'pintoresco']
  },
  'plan-carboneras-aguamarga': {
    duration_h: 10,
    themes: ['naturaleza', 'pintoresco']
  },
  'plan-vera-sorbas-tabernas': {
    duration_h: 10,
    themes: ['naturaleza', 'cultura', 'aventura']
  },
  'plan-monsul-cena': {
    duration_h: 6,
    themes: ['naturaleza', 'pintoresco', 'gastronomia']
  },
  'plan-mojacar-noche': {
    duration_h: 6,
    themes: ['cultura', 'gastronomia', 'pintoresco']
  },
  'plan-riad-cabrera': {
    duration_h: 6,
    themes: ['cultura', 'gastronomia']
  },
  'plan-cala-enmedio-tarde': {
    duration_h: 7,
    themes: ['naturaleza', 'aventura', 'relax']
  },
  'plan-flamencos-niños': {
    duration_h: 6,
    themes: ['naturaleza', 'familia', 'gastronomia']
  },
  'plan-mini-hollywood': {
    duration_h: 9,
    themes: ['familia', 'cultura', 'aventura']
  },
  'plan-geoda-pulpi': {
    duration_h: 9,
  ...
  'plan-aqua-vera': {
    duration_h: 10,
    themes: ['familia', 'aventura']
  },
  'plan-mojacar-niños': {
    duration_h: 5,
    themes: ['cultura', 'gastronomia', 'pintoresco', 'familia']
  },
  'plan-carretera-cabo': {
    duration_h: 10,
    themes: ['naturaleza', 'aventura', 'pintoresco']
  ...
  'plan-murcia-gastro': {
    duration_h: 11,
    themes: ['gastronomia', 'cultura']
  },
  'plan-almeria-capital': {
    duration_h: 12,
    themes: ['cultura', 'gastronomia', 'historia']
  },
  'plan-nijar-ceramica': {
    duration_h: 10,
    themes: ['cultura', 'pintoresco']
  },
  'plan-kayak-cabo': {
    duration_h: 6,
    themes: ['naturaleza', 'aventura', 'pintoresco']
  },
  'plan-snorkel-familia': {
    duration_h: 4,
    themes: ['naturaleza', 'familia', 'aventura']
  },
  'plan-buceo-las-negras': {
    duration_h: 10,
    themes: ['naturaleza', 'aventura']
  },
  'plan-parque-vera-niños': {
    duration_h: 4,
    themes: ['familia', 'relax']
  },
  'plan-estrellas-cabo': {
    duration_h: 6,
    themes: ['naturaleza', 'aventura', 'pintoresco', 'relax']
  },
  'plan-mojacar-noche-musica': {
    duration_h: 6,
    themes: ['cultura', 'gastronomia', 'pintoresco']
  },
  'plan-crucero-cabo': {
    duration_h: 8,
    themes: ['naturaleza', 'aventura', 'familia', 'pintoresco']
  },
  'plan-lunar-cable': {
    duration_h: 4,
    themes: ['aventura', 'familia']
  },
  'plan-motos-acuaticas': {
    duration_h: 4,
    themes: ['aventura']
  },
  'plan-bici-costa': {
    duration_h: 5,
    themes: ['naturaleza', 'aventura', 'familia']
  },
  'plan-curso-buceo': {
    duration_h: 10,
    themes: ['naturaleza', 'aventura']
  ...
  'plan-lua-paseo': {
    duration_h: 4,
    themes: ['gastronomia', 'relax']
  },
  'plan-garrucha-malecon': {
    duration_h: 4,
    themes: ['familia', 'gastronomia', 'pintoresco']
  },
  'plan-calar-alto': {
    duration_h: 8,
    themes: ['naturaleza', 'aventura', 'cultura', 'relax']
  },
  'plan-granada-alhambra': {
    duration_h: 16,
    themes: ['cultura', 'historia', 'pintoresco']
  }
};
...
// ── MADRUGADORES ──────────────────────────────────────────────
{
  ...
  steps: [{
    t: '7:00',
    es: 'Sendero a las Salinas de Puerto Rey',
    en: 'Walk to the Puerto Rey Salt Flats',
    d_es: 'Acceso peatonal directo desde la urbanización Pueblo Salinas. Flamencos al amanecer.',
    d_en: 'Direct walking access from the Pueblo Salinas complex. Flamingos at sunrise.'
  }, {
    t: '8:30',
    es: 'Desayuno en bar local de Garrucha',
    en: 'Breakfast at a local Garrucha bar',
    d_es: 'Tostada con tomate en cualquier bar del paseo del puerto.',
    d_en: 'Toast with tomato at any bar along the harbour promenade.'
  }, {
    t: '10:00',
    es: 'Lonja del puerto · subasta de pescado',
    en: 'Fish market · live auction',
    d_es: 'Espectáculo gratis. Llegan los barcos y subastan al instante.',
    d_en: 'Free spectacle. Boats arrive, the auction runs immediately.'
  }, {
    t: '12:30',
    es: 'Comida en Tadeo (Villaricos)',
    en: 'Lunch at Tadeo (Villaricos)',
    d_es: 'Arroz con bogavante. 15 min en coche desde Garrucha.',
    d_en: 'Lobster rice. 15 min drive from Garrucha.'
  }],
  ...
  steps: [{
    t: '6:30',
    es: 'Salida hacia San José',
    en: 'Drive to San José',
    d_es: '1 h por la N-340. La barrera de la pista a Mónsul abre temprano.',
    d_en: '1 h on the N-340. The Mónsul track gate opens early.'
  }, {
    t: '7:30',
    es: 'Mónsul al amanecer',
    en: 'Mónsul at sunrise',
    d_es: 'Sin nadie. Foto desde la duna. Después, un baño rápido si te atreves.',
    d_en: 'Empty. Shoot from the dune. Then a quick swim if you dare.'
  }, {
    t: '10:30',
    es: 'Desayuno en San José',
    en: 'Breakfast in San José',
    d_es: 'Cualquier cafetería del puerto. Zumo de naranja recién hecho.',
    d_en: 'Any harbour café. Fresh orange juice.'
  }, {
    t: '12:00',
    es: 'Subir a Mojácar pueblo',
    en: 'Up to Mojácar village',
    d_es: 'Callejuelas blancas, mirador de la Plaza Nueva, vistas a la Sierra Cabrera.',
    d_en: 'Whitewashed streets, mirador at Plaza Nueva, Sierra Cabrera views.'
  }, {
    t: '14:00',
    es: 'Comida en Cabo Norte',
    en: 'Lunch at Cabo Norte',
    d_es: 'Buena materia prima a precio sensato. Reserva.',
    d_en: 'Quality produce at fair prices. Book ahead.'
  }],
  ...
  steps: [{
    t: '7:00',
    es: 'Caminata por la playa de Vera al amanecer',
    en: 'Walk along Vera beach at dawn',
    d_es: 'Desde Hestía hacia el sur, hasta el Almanzora. Arena fina y agua templada.',
    d_en: 'From Hestía southward to the Almanzora. Fine sand, warm water.'
  }, {
    t: '8:30',
    es: 'Desayuno en Chiringuito Playa Turquesa',
    en: 'Breakfast at Chiringuito Playa Turquesa',
    d_es: 'A pie. Tostada, café, pies en la arena.',
    d_en: 'On foot. Toast, coffee, toes in the sand.'
  }, {
    t: '10:00',
    es: 'Paseo del puerto de Garrucha',
    en: 'Garrucha harbour promenade',
    d_es: 'Lonja, barcas, terrazas con sombra.',
    d_en: 'Market, fishing boats, shaded terraces.'
  }, {
    t: '13:30',
    es: 'Comida en Lúa (Vera Playa)',
    en: 'Lunch at Lúa (Vera Playa)',
    d_es: 'Sofisticado y a pie de Hestía. Buena bodega.',
    d_en: 'Sophisticated and walkable from Hestía. Good wine list.'
  }],
...
// ── DÍA COMPLETO ──────────────────────────────────────────────
{
  ...
  steps: [{
    t: '9:30',
    es: 'Salida desde Vera Playa hacia el embalse de Cuevas del Almanzora',
    ...
    km: 20,
    gmaps: 'https://www.google.com/maps/search/?api=1&query=Lunar+Cable+Park+Cuevas+Almanzora'
  }, {
    t: '10:00',
    es: 'Llegada a Lunar Cable Park y check-in',
    ...
    km: 0,
    gmaps: 'https://www.google.com/maps/search/?api=1&query=Lunar+Cable+Park'
  }, {
    t: '10:30',
    es: 'Briefing de seguridad y primeros intentos en cable infantil',
    ...
    t: '12:00',
    es: 'Sesión en cable principal o circuito hinchable',
    ...
    t: '14:00',
    es: 'Comida en el chiringuito de las instalaciones',
    ...
    t: '16:00',
    es: 'Segunda sesión o kayak/paddle por el canal',
    ...
    t: '18:00',
    es: 'Parada en Cuevas del Almanzora pueblo · castillo del Marqués',
    ...
    km: 5,
    gmaps: 'https://www.google.com/maps/search/?api=1&query=Castillo+Marqu%C3%A9s+V%C3%A9lez+Cuevas+Almanzora'
  }, {
    t: '19:30',
    es: 'Vuelta a Hestía. Ducha larga, cerveza en la terraza.',
  ...
  steps: [{
    t: '9:30',
    es: 'Salida hacia el Faro de Cabo de Gata',
    en: 'Drive to the Cabo de Gata lighthouse',
    d_es: '1 h 15 min. Carretera espectacular junto al mar.',
    d_en: '1 h 15 min. Stunning seaside road.'
  }, {
    t: '10:45',
    es: 'Faro y Arrecife de las Sirenas',
    en: 'Lighthouse and Sirenas Reef',
    d_es: 'Mirador con dos columnas volcánicas saliendo del mar.',
    d_en: 'Viewpoint with two volcanic columns rising from the sea.'
  }, {
    t: '11:45',
    es: 'Salinas de Cabo de Gata',
    en: 'Cabo de Gata Salt Flats',
    d_es: 'Otra colonia de flamencos. Foto desde el observatorio.',
    d_en: 'Another flamingo colony. Shot from the observation deck.'
  }, {
    t: '13:30',
    es: 'Comida en San José',
    en: 'Lunch in San José',
    d_es: 'La Gallineta o La Ola, junto al mar.',
    d_en: 'La Gallineta or La Ola, right by the sea.'
  }, {
    t: '15:30',
    es: 'Playa de Genoveses o Mónsul',
    en: 'Genoveses or Mónsul beach',
    d_es: 'En verano, bus desde San José. En invierno entras con coche.',
    d_en: 'Summer: bus from San José. Winter: drive in.'
  }, {
    t: '18:30',
    es: 'Café en San José antes de volver',
    en: 'Coffee in San José before heading back',
    d_es: 'Terraza del puerto, atardecer suave.',
    d_en: 'Harbour terrace, gentle sunset.'
  }],
  ...
  steps: [{
    t: '9:30',
    es: 'Salida por la costa hacia Carboneras',
    en: 'Coastal drive to Carboneras',
    d_es: 'Pasando por Mojácar y Macenas.',
    d_en: 'Through Mojácar and Macenas.'
  }, {
    t: '11:00',
    es: 'Mesa Roldán: faro y fortaleza',
    en: 'Mesa Roldán: lighthouse and fortress',
    d_es: 'Mirador 360º. Aquí rodaron Juego de Tronos.',
    d_en: '360° viewpoint. Filmed for Game of Thrones.'
  }, {
    t: '12:30',
    es: 'Bajada a la Playa de los Muertos',
    en: 'Down to Playa de los Muertos',
    d_es: '15 min de sendero pedregoso. Una de las mejores playas de España.',
    d_en: '15 min rocky path. One of Spain\'s best beaches.'
  }, {
    t: '14:30',
    es: 'Comida en Carboneras',
    en: 'Lunch in Carboneras',
    d_es: 'Cualquier marisquería del puerto.',
    d_en: 'Any seafood spot at the harbour.'
  }, {
    t: '16:30',
    es: 'Coche hasta Agua Amarga',
    en: 'Drive to Agua Amarga',
    d_es: '15 min. El pueblo blanco más cuidado de la zona.',
    d_en: '15 min. The most polished white village around.'
  }, {
    t: '18:00',
    es: 'Aperitivo en Agua Amarga',
    en: 'Aperitif in Agua Amarga',
    d_es: 'Terraza con vistas al mar.',
    d_en: 'Sea-view terrace.'
  }],
  ...
  steps: [{
    ...
    es: 'Vera pueblo',
    en: 'Vera town',
    d_es: 'Si es jueves, mercadillo. Iglesia de la Encarnación, plaza mayor.',
    d_en: 'If Thursday, the street market. Encarnación church, main square.'
  }, {
    t: '11:00',
    es: 'Cuevas de Sorbas',
    en: 'Sorbas caves',
    d_es: 'Karst de yeso único en Europa. Visita guiada de 2 h con casco y linterna.',
    d_en: 'Unique gypsum karst in Europe. 2 h guided visit with helmet and torch.'
  }, {
    t: '13:30',
    es: 'Comida en Sorbas',
    en: 'Lunch in Sorbas',
    d_es: 'Cualquier mesón del pueblo. Cocina serrana.',
    d_en: 'Any village inn. Mountain home cooking.'
  }, {
    t: '15:30',
    es: 'Desierto de Tabernas',
    en: 'Tabernas Desert',
    d_es: 'Fort Bravo o Mini Hollywood, único desierto auténtico de Europa.',
    d_en: 'Fort Bravo or Mini Hollywood, Europe\'s only true desert.'
  }, {
    t: '18:00',
    es: 'Vuelta con parada en bar de carretera',
    en: 'Return with a roadside-bar stop',
    d_es: 'Caña, tapa, atardecer entre olivos.',
    d_en: 'Beer, tapa, sunset among olive groves.'
  }],
...
// ── TARDE-NOCHE ───────────────────────────────────────────────
{
  ...
  steps: [{
    ...
    es: 'Salida hacia San José',
    en: 'Drive to San José',
    d_es: '1 h. En verano deja el coche en la entrada y coge el bus.',
    d_en: '1 h. In summer leave the car at the entrance and take the bus.'
  }, {
    t: '18:30',
    es: 'Atardecer en Mónsul',
    en: 'Sunset at Mónsul',
    d_es: 'Sube a la duna y sentirás Indiana Jones.',
    d_en: 'Climb the dune, pure Indiana Jones.'
  }, {
    t: '20:30',
    es: 'Paseo por San José',
    en: 'Stroll through San José',
    d_es: 'Puerto, calles peatonales, terrazas.',
    d_en: 'Harbour, pedestrian streets, terraces.'
  }, {
    t: '21:30',
    es: 'Cena en La Ola junto al mar',
    en: 'Dinner at La Ola by the sea',
    d_es: 'Mesa al borde del agua. Reserva.',
    d_en: 'Table at the water\'s edge. Book.'
  }, {
    t: '23:00',
    es: 'Copa en alguna terraza del puerto',
    en: 'A drink at a harbour terrace',
    d_es: 'San José se vacía pronto, así que vuelve relajado.',
    d_en: 'San José empties early, drive back relaxed.'
  }],
  ...
  steps: [{
    t: '17:30',
    es: 'Subir a Mojácar pueblo',
    en: 'Drive up to Mojácar',
    d_es: '25 min. Aparca abajo y sube andando.',
    d_en: '25 min. Park below and walk up.'
  }, {
    t: '18:30',
    es: 'Mirador del Castillo · vistas 360°',
    en: 'Castle viewpoint · 360° views',
    d_es: 'Mediterráneo, Sierra Cabrera, salar de la Algaida.',
    d_en: 'Mediterranean, Sierra Cabrera, Algaida salt-marsh.'
  }, {
    t: '19:30',
    es: 'Paseo por la Plaza Nueva',
    en: 'Stroll along Plaza Nueva',
    d_es: 'Atardecer en cafés con jazmín.',
    d_en: 'Sunset at cafés scented with jasmine.'
  }, {
    t: '21:00',
    es: 'Cena en Cabo Norte',
    en: 'Dinner at Cabo Norte',
    d_es: 'Buena materia prima, ambiente tranquilo.',
    d_en: 'Quality produce, calm atmosphere.'
  }, {
    t: '23:00',
    es: 'Copa con el pueblo iluminado',
    en: 'A drink with the village lit up',
    d_es: 'Cualquier terraza alta, Mojácar de noche es magia.',
    d_en: 'Any rooftop terrace, Mojácar lit up is magic.'
  }],
  ...
  steps: [{
    t: '18:00',
    es: 'Salida hacia la Sierra Cabrera',
    en: 'Drive to Sierra Cabrera',
    d_es: '45 min de carretera de montaña, atardecer entre olivos.',
    d_en: '45 min of mountain road, sunset through olive groves.'
  }, {
    t: '19:30',
    es: 'Mirador de la Sierra',
    en: 'Sierra viewpoint',
    d_es: 'Pintamos el valle con la luz dorada del final del día.',
    d_en: 'The valley painted in late-day gold.'
  }, {
    t: '21:00',
    es: 'Cena en Riad Cabrera',
    en: 'Dinner at Riad Cabrera',
    d_es: 'Tagines, té de menta, decoración marroquí auténtica. Reserva sí o sí.',
    d_en: 'Tagines, mint tea, authentic Moroccan decor. Reserve in advance.'
  }, {
    t: '23:00',
    es: 'Vuelta tranquila a Hestía',
    en: 'Calm drive back to Hestía',
    d_es: 'Lleva mantita, la sierra refresca por la noche.',
    d_en: 'Bring a light blanket, the sierra cools at night.'
  }],
  ...
  steps: [{
    t: '16:00',
    es: 'Salida hacia Agua Amarga',
    en: 'Drive to Agua Amarga',
    d_es: '1 h por la costa.',
    d_en: '1 h along the coast.'
  }, {
    t: '17:00',
    es: 'Sendero a la Cala de Enmedio',
    en: 'Path to Cala de Enmedio',
    d_es: '30 min campo a través. Casi vacía a partir de las 17:00.',
    d_en: '30 min cross-country. Nearly empty after 5 pm.'
  }, {
    t: '17:30',
    es: 'Baño y atardecer en la cala',
    en: 'Swim and sunset in the cove',
    d_es: 'Arena blanca, roca esculpida, agua cristalina.',
    d_en: 'White sand, sculpted rock, crystalline water.'
  }, {
    t: '19:30',
    es: 'Vuelta caminando a Agua Amarga',
    en: 'Walk back to Agua Amarga',
    d_es: 'Calzado cerrado para la pista de tierra.',
    d_en: 'Closed shoes for the dirt path.'
  }, {
    t: '21:00',
    es: 'Cena en Agua Amarga frente al mar',
    en: 'Dinner in Agua Amarga by the sea',
    d_es: 'Cualquier restaurante del paseo. Ambiente boho.',
    d_en: 'Any seafront restaurant. Boho atmosphere.'
  }],
...
// ── PLANES CON NIÑOS ─────────────────────────────────────────
{
  ...
  steps: [{
    t: '9:00',
    es: 'Sendero a las Salinas de Puerto Rey',
    en: 'Walk to Puerto Rey Salt Flats',
    d_es: 'Acceso peatonal directo desde la urbanización Pueblo Salinas. Llevad binoculares, los flamencos están a 50-100 m.',
    d_en: 'Direct walking access from the Pueblo Salinas complex. Bring binoculars, flamingos are 50-100 m away.'
  }, {
    t: '10:30',
    es: 'Desayuno en Garrucha',
    en: 'Breakfast in Garrucha',
    d_es: 'Cruasán y zumo en cualquier bar del paseo. Cerca del puerto.',
    d_en: 'Croissant and juice at any promenade bar near the harbour.'
  }, {
    t: '11:30',
    es: 'Excursión en barco desde el puerto',
    en: 'Boat trip from the harbour',
    d_es: 'Mar Azul y otras compañías ofrecen vueltas de 1 h costeras. Reserva el día antes.',
    d_en: 'Mar Azul and others offer 1 h coastal tours. Book the day before.'
  }, {
    t: '13:00',
    es: 'Comida en Pizzería Pomodoro',
    en: 'Lunch at Pizzería Pomodoro',
    d_es: 'A pie de playa, ambiente familiar, niños pueden moverse.',
    d_en: 'Right on the beach, family-friendly, kids can roam.'
  }],
  ...
  steps: [{
    t: '10:00',
    es: 'Salida hacia el Desierto de Tabernas',
    en: 'Drive to the Tabernas Desert',
    d_es: '45 min en coche por la A-7 hacia Almería.',
    d_en: '45 min on the A-7 towards Almería.'
  }, {
    t: '11:30',
    es: 'Show del Oeste · gunfighters',
    en: 'Wild West gunfight show',
    d_es: 'En la calle principal del poblado. Los niños alucinan con los disparos y los caballos.',
    d_en: 'On the main street. Kids love the gunfire and horses.'
  }, {
    t: '13:00',
    es: 'Comida en el saloon',
    en: 'Lunch at the saloon',
    d_es: 'Hamburguesas, alitas, burrito mexicano. Apto para niños.',
    d_en: 'Burgers, wings, Mexican burrito. Kid-approved.'
  }, {
    t: '14:30',
    es: 'Reserva zoológica del desierto',
    en: 'Desert zoo reserve',
    d_es: 'Lobos, rapaces, pumas, dromedarios. Educativo y bien cuidado.',
    d_en: 'Wolves, raptors, pumas, camels. Educational and well kept.'
  }, {
    t: '16:00',
    es: 'Show de can-can en el saloon',
    en: 'Can-can show at the saloon',
    d_es: 'Tradicional. Apto para todos los públicos.',
    d_en: 'Classic. Family-friendly.'
  }, {
    t: '17:30',
    es: 'Piscinas del parque (verano)',
    en: 'Park pools (summer)',
    d_es: 'En temporada de calor. Llevad bañador y toalla.',
    d_en: 'Hot season only. Bring swimwear and towels.'
  }],
  ...
  steps: [{
    t: '10:00',
    es: 'Salida hacia Pulpí',
    en: 'Drive to Pulpí',
    d_es: '45 min. Reserva online imprescindible, grupos pequeños.',
    d_en: '45 min. Online booking required, small groups only.'
  }, {
    t: '11:00',
    es: 'Visita guiada a la Geoda Gigante',
    en: 'Guided tour of the Giant Geode',
    d_es: '8 m de cristales, la segunda más grande del mundo. Casco, linterna y arnés incluidos.',
    d_en: '8 m of crystals, second largest in the world. Helmet, torch and harness included.'
  }, {
    t: '13:00',
    es: 'Comida en San Juan de los Terreros',
    en: 'Lunch in San Juan de los Terreros',
    d_es: 'Pueblo costero pequeño con varios restaurantes a pie de mar.',
    d_en: 'Small coastal town with several seafront restaurants.'
  }, {
    t: '15:30',
    es: 'Playa de los Cocedores',
    en: 'Cocedores beach',
    d_es: 'Cuevas excavadas en la arenisca, perfectas para que los niños exploren. Aguas turquesas.',
    d_en: 'Sandstone caves perfect for kids to explore. Turquoise water.'
  }, {
    t: '18:00',
    es: 'Helado en San Juan o Pulpí pueblo',
    en: 'Ice cream in San Juan or Pulpí',
    d_es: 'Última parada antes de volver.',
    d_en: 'Last stop before heading back.'
  }],
  ...
  steps: [{
    t: '11:00',
    es: 'Apertura de Aqua Vera',
    en: 'Aqua Vera opens',
    d_es: 'Solo abre en temporada (junio-septiembre). 10 min en coche desde Hestía.',
    d_en: 'Open only in summer (June-September). 10 min drive from Hestía.'
  }, {
    t: '14:00',
    es: 'Comida dentro del parque',
    en: 'Lunch inside the park',
    d_es: 'O salís y volvéis con sello en la mano. Hay menú infantil.',
    d_en: 'Or step out and come back with a hand stamp. Kids menu available.'
  }, {
    t: '15:00',
    es: 'Toboganes y río salvaje',
    en: 'Slides and lazy river',
    d_es: 'Hay zona infantil con altura mínima muy baja y zona para mayores.',
    d_en: 'Kids area with low height limits and a bigger-kids area.'
  }, {
    t: '18:30',
    es: 'Salida del parque · ducha en Hestía',
    en: 'Leave the park · shower at Hestía',
    d_es: 'Volved relajados, secad, descansad un rato.',
    d_en: 'Drive back relaxed, dry off, rest a while.'
  }, {
    t: '20:30',
    es: 'Cena en Chiringuito Playa Turquesa',
    en: 'Dinner at Chiringuito Playa Turquesa',
    d_es: 'Pizza/pasta a pie de arena. Andando desde Hestía. Niños pueden seguir jugando en la playa.',
    d_en: 'Pizza/pasta on the sand. Walkable from Hestía. Kids can play on the beach.'
  }],
  ...
  steps: [{
    ...
    es: 'Subir a Mojácar pueblo',
    en: 'Drive up to Mojácar',
    d_es: '25 min. Aparcad abajo en el parking público y subid andando, más fresco al atardecer.',
    d_en: '25 min. Park below in the public lot and walk up, cooler at sunset.'
  }, {
    t: '18:30',
    es: 'Mirador del Castillo',
    en: 'Castle viewpoint',
    d_es: 'Cuesta arriba con escalones, niños mayores de 4 años lo disfrutan. Vistas al mar.',
    d_en: 'Uphill with steps, kids 4+ enjoy it. Sea views.'
  }, {
    t: '19:30',
    es: 'Helado en la Plaza Nueva',
    en: 'Ice cream on Plaza Nueva',
    d_es: 'Sentaos en la plaza con vistas al Mediterráneo. Heladería artesanal.',
    d_en: 'Sit on the square with sea views. Artisan ice cream.'
  }, {
    t: '20:30',
    es: 'Cena en pizzería del pueblo',
    en: 'Dinner at a village pizzeria',
    d_es: 'Cabo Norte tiene menú infantil; otros sitios también. Reservad si es viernes/sábado.',
    d_en: 'Cabo Norte has a kids menu; others too. Book Fri/Sat.'
  }, {
    t: '22:00',
    es: 'Bajada al coche',
    en: 'Walk back down',
    d_es: 'Mojácar de noche es magia con farolillos.',
    d_en: 'Mojácar at night is magic with the lanterns.'
  }],
...
// ── PLANES EXTRA (rutas, trekking, escapadas) ────────────────
{
  ...
  steps: [{
    t: '9:30',
    es: 'Salida hacia Carboneras por la costa',
    en: 'Drive south along the coast to Carboneras',
    d_es: 'AL-5106. Carretera con curvas y miradores espectaculares.',
    d_en: 'AL-5106. Winding road with stunning viewpoints.'
  }, {
    t: '10:30',
    es: 'Mirador de Mesa Roldán y bajada a Los Muertos',
    en: 'Mesa Roldán viewpoint and descent to Los Muertos',
    d_es: 'Aparcas arriba y bajas a la playa por sendero.',
    d_en: 'Park at the top and walk down the trail.'
  }, {
    t: '12:30',
    es: 'Cala del Plomo (Agua Amarga)',
    en: 'Cala del Plomo (Agua Amarga)',
    d_es: 'Pista de tierra · 30 min andando · casi siempre vacía.',
    d_en: 'Dirt road · 30 min walk · almost always empty.'
  }, {
    t: '14:30',
    es: 'Comida en Las Negras o Agua Amarga',
    en: 'Lunch in Las Negras or Agua Amarga',
    d_es: 'Las Negras tiene ambiente bohemio; Agua Amarga más cuidado.',
    d_en: 'Las Negras has bohemian vibe; Agua Amarga is more polished.'
  }, {
    t: '16:30',
    es: 'Playazo de Rodalquilar',
    en: 'Playazo de Rodalquilar',
    d_es: 'Aparcamiento al pie de la playa. Castillo de San Ramón al sur.',
    d_en: 'Park right by the beach. San Ramón castle to the south.'
  }, {
    t: '18:00',
    es: 'La Isleta del Moro: snorkel y aperitivo',
    en: 'La Isleta del Moro: snorkel and aperitif',
    d_es: 'Pueblo pesquero diminuto. Snorkel en el Peñón Blanco. Cerveza al sol.',
    d_en: 'Tiny fishing village. Snorkel at Peñón Blanco. Beer in the sun.'
  }],
  ...
  steps: [{
    t: '8:30',
    es: 'Salida hacia Las Negras',
    en: 'Drive to Las Negras',
    d_es: '1 h en coche. Aparcad en el pueblo, junto a la playa.',
    d_en: '1 h drive. Park in the village, next to the beach.'
  }, {
    t: '10:00',
    es: 'Inicio del sendero costero (PR-A 357)',
    en: 'Start of the coastal trail (PR-A 357)',
    d_es: 'Sale del extremo norte del pueblo. 90 min andando con desnivel moderado.',
    d_en: 'Starts at the north end of the village. 90 min walk with moderate elevation.'
  }, {
    t: '11:30',
    es: 'Llegada a la Cala de San Pedro',
    en: 'Arrival at Cala de San Pedro',
    d_es: 'Cala virgen con fuente natural. Comunidad estable, sin servicios. Agua limpia.',
    d_en: 'Virgin cove with natural spring. Long-time community, no services. Clean water.'
  }, {
    t: '12:00',
    es: 'Baño y bocadillo en la cala',
    en: 'Swim and packed lunch in the cove',
    d_es: 'Llevad la comida, no hay nada que comprar. Sombra escasa.',
    d_en: 'Bring food, nothing to buy. Little shade.'
  }, {
    t: '15:00',
    es: 'Vuelta caminando · 90 min',
    en: 'Walk back · 90 min',
    d_es: 'O vuelta en taxi-barca por unos 10 € por persona si están operando.',
    d_en: 'Or boat-taxi back for ~€10 per person if operating.'
  }, {
    t: '17:30',
    es: 'Cerveza en Las Negras',
    en: 'Beer in Las Negras',
    d_es: 'Premio en alguna terraza con vistas al pedregal.',
    d_en: 'Reward yourselves on a pebble-beach terrace.'
  }],
  ...
  steps: [{
    t: '9:00',
    es: 'Salida hacia Murcia',
    en: 'Drive to Murcia',
    d_es: '1 h 30 min por la A-7. Aparcamiento subterráneo en el centro (Plaza Circular).',
    d_en: '1 h 30 min on the A-7. Underground parking downtown (Plaza Circular).'
  }, {
    t: '11:00',
    es: 'Catedral de Santa María',
    en: 'Cathedral of Santa María',
    d_es: 'Fachada barroca, torre con vistas. Entrada combinada al museo.',
    d_en: 'Baroque façade, bell tower with views. Combined ticket includes the museum.'
  }, {
    t: '12:30',
    es: 'Plaza de las Flores · tapeo',
    en: 'Plaza de las Flores · tapas',
    d_es: 'Pasteles de carne, marineras, michirones, zarangollo. Un poco en cada terraza.',
    d_en: 'Meat pasties, marineras (anchovy on potato salad), michirones, zarangollo. A bite at each terrace.'
  }, {
    t: '14:30',
    es: 'Comida en El Rincón de Pepe o Salzillo',
    en: 'Lunch at El Rincón de Pepe or Salzillo',
    d_es: 'Cocina murciana tradicional. Caldero, arroz a banda, mero al horno.',
    d_en: 'Traditional Murcian cuisine. Caldero, arroz a banda, baked grouper.'
  }, {
    t: '16:30',
    es: 'Real Casino de Murcia',
    en: 'Real Casino de Murcia',
    d_es: 'Edificio único del siglo XIX. Patio árabe, biblioteca inglesa, salón pompeyano.',
    d_en: 'Unique 19th-century building. Arab patio, English library, Pompeian hall.'
  }, {
    t: '17:30',
    es: 'Paseo por Trapería y Platería',
    en: 'Stroll along Trapería and Platería',
    d_es: 'Calles peatonales con tiendas históricas y heladerías.',
    d_en: 'Pedestrian streets with historic shops and gelaterias.'
  }],
  ...
  steps: [{
    ...
    es: 'Salida hacia San José',
    en: 'Drive to San José',
    d_es: '1 h. Aparcamiento gratuito a la entrada del pueblo.',
    d_en: '1 h drive. Free parking at the village entrance.'
  }, {
    t: '11:30',
    es: 'Paseo por el puerto y la playa de San José',
    en: 'Walk the harbour and San José beach',
    d_es: 'Mañana tranquila. Cafés con vista al Mediterráneo.',
    d_en: 'Quiet morning. Cafés with Mediterranean views.'
  }, {
    t: '13:30',
    es: 'Comida en La Gallineta',
    en: 'Lunch at La Gallineta',
    d_es: 'Junto al mar, productos del Cabo de Gata. Reserva.',
    d_en: 'Seaside, Cabo de Gata produce. Book ahead.'
  }, {
    t: '15:30',
    es: 'Subir a Níjar pueblo',
    en: 'Drive up to Níjar village',
    d_es: '30 min. Pueblo blanco colgado en la sierra Alhamilla.',
    d_en: '30 min. White village clinging to the Alhamilla mountains.'
  }, {
    t: '16:30',
    es: 'Talleres de cerámica en la calle Real',
    en: 'Pottery workshops on Calle Real',
    d_es: 'Cerámica Tito · Cerámica Cosano · El Oficio. Cada uno con estilo propio. Compra una pieza.',
    d_en: 'Cerámica Tito · Cerámica Cosano · El Oficio. Each with its own style. Buy a piece.'
  }, {
    t: '18:00',
    es: 'Mirador de la Atalaya',
    en: 'Atalaya viewpoint',
    d_es: 'Vistas al Cabo de Gata y al desierto. Muy bueno al atardecer.',
    d_en: 'Views over Cabo de Gata and the desert. Best at sunset.'
  }, {
    t: '19:00',
    es: 'Café o tapa en la Plaza de la Glorieta',
    en: 'Coffee or tapa at Plaza de la Glorieta',
    d_es: 'Antes de bajar a la N-340.',
    d_en: 'Before heading back down to the N-340.'
  }],
...
// ── PLANES EXTRA · investigación web (kayak, buceo, estrellas, copas, juegos) ─
{
  ...
  steps: [{
    ...
    es: 'Salida hacia Agua Amarga',
    en: 'Drive to Agua Amarga',
    d_es: '1 h por la costa. Aparcad en el pueblo.',
    d_en: '1 h coastal drive. Park in the village.'
  }, {
    t: '10:30',
    es: 'Briefing técnico y kayak doble o individual',
    en: 'Technical briefing + single or double kayak',
    d_es: 'Las empresas ofrecen ruta de 2 h (~30 €/adulto, 20 €/niño). Toyo Aventura, Cabo de Gata Activo, Medialuna.',
    d_en: 'Operators offer 2 h routes (~€30/adult, €20/child). Toyo Aventura, Cabo de Gata Activo, Medialuna.'
  }, {
    t: '11:00',
    es: 'Ruta a la Cala del Plomo y cuevas',
    en: 'Route to Cala del Plomo and sea caves',
    d_es: 'Acantilados, cuevas marinas, parada para snorkel en agua transparente.',
    d_en: 'Cliffs, sea caves, snorkel break in clear water.'
  }, {
    t: '13:00',
    es: 'Comida en Agua Amarga frente al mar',
    en: 'Lunch in Agua Amarga by the sea',
    d_es: 'Cualquier restaurante del paseo: habéis sudado, os lo merecéis.',
    d_en: 'Any seafront restaurant, you earned it.'
  }],
  ...
  steps: [{
    ...
    en: 'Drive to San José',
    d_es: '1 h. Aparcamiento gratuito a la entrada del pueblo.',
    d_en: '1 h. Free parking at the village entrance.'
  }, {
    t: '11:30',
    es: 'Briefing y entrega de equipo neopreno',
    en: 'Briefing and wetsuit gear handout',
    d_es: 'Eco Agata u otras empresas: incluyen gafas, tubo, neopreno y chaleco.',
    d_en: 'Eco Agata and others: mask, snorkel, wetsuit and vest included.'
  }, {
    t: '12:00',
    es: 'Ruta de snorkel en el Arrecife de las Sirenas',
    en: 'Snorkel at Arrecife de las Sirenas',
    d_es: 'Aguas cristalinas, peces de colores, posidonia. Apto desde 6 años (con monitor).',
    d_en: 'Clear water, colourful fish, posidonia meadows. Suitable from age 6.'
  }, {
    t: '13:30',
    es: 'Comida en La Ola junto al mar',
    en: 'Lunch at La Ola by the sea',
    d_es: 'Pescaíto frito y arroces sencillos. Niños menú.',
    d_en: 'Fried fish and simple rice dishes. Kids menu.'
  }],
  ...
  steps: [{
    ...
    es: 'Salida hacia Las Negras',
    en: 'Drive to Las Negras',
    d_es: '55 min. Aparcad en el pueblo.',
    d_en: '55 min. Park in the village.'
  }, {
    t: '10:30',
    es: 'Briefing y bautismo / inmersión guiada',
    en: 'Briefing and dive (try-dive or certified)',
    d_es: 'Buceo Las Negras y otras empresas. Visibilidad de 15-30 m, posidonia, fauna mediterránea.',
    d_en: 'Buceo Las Negras and others. 15-30 m visibility, posidonia, Mediterranean fauna.'
  }, {
    t: '13:30',
    es: 'Comida en una terraza del paseo',
    en: 'Lunch on a promenade terrace',
    d_es: 'Las Negras tiene un par de sitios buenos. Ambiente bohemio.',
    d_en: 'Las Negras has a couple of good spots. Bohemian vibe.'
  }, {
    t: '16:00',
    es: 'Tarde en el Playazo de Rodalquilar',
    en: 'Afternoon at Playazo de Rodalquilar',
    d_es: '10 min en coche. Acceso fácil al pie de la playa, sombra de paragüeros y descanso.',
    d_en: '10 min drive. Easy access at the beach, parasol shade and rest.'
  }, {
    t: '18:00',
    es: 'Café o cerveza en La Isleta del Moro',
    en: 'Coffee or beer in La Isleta del Moro',
    d_es: 'Pueblito pesquero a 5 min. Atardecer relajado antes de volver.',
    d_en: 'Tiny fishing village 5 min away. Relaxed sunset before driving back.'
  }],
  ...
  steps: [{
    t: '17:00',
    es: 'Centro Deportivo Puerto Rey · parque infantil',
    en: 'Puerto Rey sports complex · kids park',
    d_es: 'A 10 min de Hestía. Minigolf, camas elásticas vallada, castillos hinchables, karts de pedales.',
    d_en: '10 min from Hestía. Minigolf, fenced trampolines, bouncy castles, pedal go-karts.'
  }, {
    t: '19:00',
    es: 'Helado o granizado a pie de pista',
    en: 'Ice cream or slushie poolside',
    d_es: 'Mientras los peques siguen quemando energía.',
    d_en: 'While the kids burn off the rest of their energy.'
  }, {
    t: '20:00',
    es: 'Vuelta a Hestía y ducha rápida',
    en: 'Back to Hestía for a quick shower',
    d_es: 'Cambio de ropa antes de salir a cenar.',
    d_en: 'Change before heading out for dinner.'
  }, {
    t: '20:45',
    es: 'Cena en Pizzería Pomodoro a pie de playa',
    en: 'Dinner at Pizzería Pomodoro on the beach',
    d_es: 'Pizza, pasta, niños menú. Andando desde Hestía.',
    d_en: 'Pizza, pasta, kids menu. Walkable from Hestía.'
  }],
  ...
  steps: [{
    ...
    es: 'Salida hacia San José',
    en: 'Drive to San José',
    d_es: '1 h. Aparcad junto al puerto.',
    d_en: '1 h. Park near the harbour.'
  }, {
    t: '20:30',
    es: 'Cena temprana en La Gallineta o La Ola',
    en: 'Early dinner at La Gallineta or La Ola',
    d_es: 'Reservar imprescindible.',
    d_en: 'Book ahead, required.'
  }, {
    t: '22:30',
    es: 'Coche al Faro de Cabo de Gata',
    en: 'Drive to Cabo de Gata lighthouse',
    d_es: '20 min. Aparcamiento del Mirador de las Sirenas.',
    d_en: '20 min. Park at Mirador de las Sirenas.'
  }, {
    t: '23:00',
    es: 'Observación bajo el cielo Starlight',
    en: 'Stargazing under the Starlight sky',
    d_es: 'Cabo de Gata tiene reserva Starlight: la Vía Láctea se ve a simple vista en noches limpias. Llevad mantita y el móvil en modo rojo.',
    d_en: 'Cabo de Gata is a Starlight reserve: the Milky Way is visible to the naked eye on clear nights. Bring a blanket and put your phone on red-light mode.'
  }, {
    t: '0:30',
    es: 'Vuelta tranquila a Hestía',
    en: 'Calm drive back to Hestía',
    d_es: '1 h por carretera vacía. Atentos a los conejos en el arcén.',
    d_en: '1 h on empty road. Watch out for rabbits on the verge.'
  }],
  ...
  steps: [{
    t: '20:00',
    es: 'Salida hacia Mojácar Playa',
    en: 'Drive to Mojácar Beach',
    d_es: '25 min. Aparcad en el paseo del Mediterráneo.',
    d_en: '25 min. Park along Paseo del Mediterráneo.'
  }, {
    t: '21:00',
    es: 'Cena en Cabo Norte o Ristorante Valentino',
    en: 'Dinner at Cabo Norte or Ristorante Valentino',
    d_es: 'Reservad. Mesas con vistas al mar.',
    d_en: 'Book. Sea-view tables.'
  }, {
    t: '23:00',
    es: 'Copa en Mandala Beach Club',
    en: 'Drinks at Mandala Beach Club',
    d_es: 'Club playero con DJ y cócteles. Pista en la arena los fines de semana.',
    d_en: 'Beach club with DJ and cocktails. Dance floor on the sand on weekends.'
  }, {
    t: '0:30',
    es: 'Paseo final por el Paseo del Mediterráneo',
    en: 'Final walk along Paseo del Mediterráneo',
    d_es: 'Mojácar Playa nunca se duerme del todo en verano.',
    d_en: 'Mojácar Beach never fully sleeps in summer.'
  }],
...
// ── PLANES DEPORTIVOS · CRUCERO Y EXTRAS ─────────────────────
{
  ...
  steps: [{
    t: '10:00',
    es: 'Salida hacia el puerto de Carboneras o San José',
    en: 'Drive to Carboneras or San José harbour',
    d_es: 'Compañías como Cabo de Gata Charter, Cala&Bay y otras ofrecen cruceros de medio día y de día completo.',
    d_en: 'Cabo de Gata Charter, Cala&Bay and others offer half-day and full-day cruises.'
  }, {
    t: '11:00',
    es: 'Embarque y briefing de seguridad',
    en: 'Boarding and safety briefing',
    d_es: 'Reservar antes, los grupos son pequeños (10-25 personas).',
    d_en: 'Book ahead, small groups (10-25 people).'
  }, {
    t: '11:30',
    es: 'Ruta por la costa virgen del parque',
    en: 'Cruise along the protected coast',
    d_es: 'Calas inaccesibles por tierra: Cala del Cuervo, Cala Cerrada, San Pedro desde el mar.',
    d_en: 'Coves you can\'t reach by land: Cala del Cuervo, Cala Cerrada, San Pedro from the sea.'
  }, {
    t: '13:00',
    es: 'Parada para snorkel y aperitivo a bordo',
    en: 'Snorkel stop and onboard aperitif',
    d_es: 'Bañito en agua transparente. Algunas compañías incluyen paella o picoteo.',
    d_en: 'Swim in clear water. Some operators include paella or finger food.'
  }, {
    t: '15:30',
    es: 'Vuelta a puerto y comida tardía',
    en: 'Return to port and late lunch',
    d_es: 'Carboneras: marisquerías a pie de puerto. San José: La Ola o La Gallineta.',
    d_en: 'Carboneras: harbour seafood spots. San José: La Ola or La Gallineta.'
  }],
  ...
  steps: [{
    t: '17:00',
    es: 'Salida hacia el Lunar Cable Park',
    en: 'Drive to Lunar Cable Park',
    d_es: 'Wakeboard, kneeboard y esquí acuático sobre un cable que tira en circuito, sin barco. A 20-30 min de Hestía según la sede.',
    d_en: 'Wakeboard, kneeboard and water-ski on a circuit cable, no boat needed. 20-30 min from Hestía depending on the venue.'
  }, {
    t: '18:00',
    es: 'Sesión de cable (1 h) o pase de tarde',
    en: 'Cable session (1 h) or afternoon pass',
    d_es: 'Hay nivel principiante con barra para niños desde 6-7 años. Equipo neopreno y casco incluidos.',
    d_en: 'Beginner setup with bar for kids from 6-7 years old. Wetsuit and helmet included.'
  }, {
    t: '19:30',
    es: 'Ducha y cambio',
    en: 'Shower and change',
    d_es: 'Vestuarios en la propia instalación.',
    d_en: 'Changing rooms on site.'
  }, {
    t: '20:30',
    es: 'Cena en chiringuito a pie de playa',
    en: 'Dinner at a beach bar',
    d_es: 'Vuelta a Hestía + cena en Pomodoro o Marau.',
    d_en: 'Back to Hestía + dinner at Pomodoro or Marau.'
  }],
  ...
  steps: [{
    t: '10:00',
    es: 'Llegada al centro náutico (Vera Playa o Garrucha)',
    en: 'Arrive at the watersports centre (Vera Playa or Garrucha)',
    d_es: 'Hay varias empresas con punto de salida desde la propia playa.',
    d_en: 'Several operators launch directly from the beach.'
  }, {
    t: '10:30',
    es: 'Briefing y entrega del jet ski',
    en: 'Briefing and jet-ski hand-off',
    d_es: 'Sin licencia con monitor a bordo (acompañado). Con licencia, libre.',
    d_en: 'No licence required with a guide on board. With licence, free riding.'
  }, {
    t: '11:00',
    es: 'Ruta de 1-2 h hasta Garrucha o Mojácar',
    en: '1-2 h ride to Garrucha or Mojácar',
    d_es: 'En grupo, paradas para fotos y baño en alguna cala.',
    d_en: 'In group, photo and swim stops at some cove.'
  }, {
    t: '13:00',
    es: 'Comida en Pomodoro o Lúa',
    en: 'Lunch at Pomodoro or Lúa',
    d_es: 'A pie de playa, descanso al sol después del subidón.',
    d_en: 'Right by the sea, sun-lounger relax after the rush.'
  }],
  ...
  steps: [{
    t: '9:00',
    es: 'Recogida de bicis en Vera Playa',
    en: 'Pick up bikes in Vera Playa',
    d_es: 'Hay alquileres en Pueblo Indalo, Garrucha y Mojácar. Bicis para niños y carro para los más peques.',
    d_en: 'Rentals in Pueblo Indalo, Garrucha and Mojácar. Kids bikes and toddler trailers available.'
  }, {
    t: '9:30',
    es: 'Paseo del Almanzora y carril bici a Garrucha',
    en: 'Almanzora promenade and bike lane to Garrucha',
    d_es: 'Asfalto liso y plano. Llano todo el camino.',
    d_en: 'Smooth flat tarmac. Flat all the way.'
  }, {
    t: '11:00',
    es: 'Subida suave hacia Mojácar Playa',
    en: 'Gentle climb to Mojácar Beach',
    d_es: 'Carril bici en el paseo del Mediterráneo. Vistas al mar todo el rato.',
    d_en: 'Bike lane along Paseo del Mediterráneo. Sea views the whole way.'
  }, {
    t: '12:30',
    es: 'Aperitivo en chiringuito de Mojácar',
    en: 'Aperitif at a Mojácar beach bar',
    d_es: 'Cerveza, refresco, helado para los niños.',
    d_en: 'Beer, soft drink, ice cream for the kids.'
  }, {
    t: '13:30',
    es: 'Vuelta tranquila a Hestía',
    en: 'Calm ride back to Hestía',
    d_es: 'Si hay viento del oeste, la vuelta cuesta menos.',
    d_en: 'With a westerly wind, the way back is easier.'
  }],
  ...
  steps: [{
    ...
    es: 'Salida hacia Las Negras',
    en: 'Drive to Las Negras',
    d_es: '1 h. Buceo Las Negras o Isub Almería ofrecen Open Water PADI/SSI en 3-4 días.',
    d_en: '1 h. Buceo Las Negras or Isub Almería run PADI/SSI Open Water in 3-4 days.'
  }, {
    t: '10:00',
    es: 'Teoría y piscina · primer día',
    en: 'Theory and pool · day one',
    d_es: 'Vídeos online previos + repaso presencial. Práctica en aguas confinadas.',
    d_en: 'Online theory before + classroom recap. Confined-water practice.'
  }, {
    t: '14:00',
    es: 'Comida en una terraza del paseo',
    en: 'Lunch on a promenade terrace',
    d_es: 'Pescaíto y un buen vino blanco antes de la siguiente sesión.',
    d_en: 'Fried fish and a good white wine before the next session.'
  }, {
    t: '15:30',
    es: 'Inmersión 1 en aguas abiertas',
    en: 'Open-water dive 1',
    d_es: 'Profundidad limitada (12 m). Visibilidad 15-30 m, posidonia, fauna mediterránea.',
    d_en: 'Limited depth (12 m). Visibility 15-30 m, posidonia, Mediterranean fauna.'
  }, {
    t: '17:30',
    es: 'Debriefing y café',
    en: 'Debrief and coffee',
    d_es: 'Repaso del bitácora antes de volver.',
    d_en: 'Logbook review before driving back.'
  }],
  ...
  steps: [{
    t: '20:30',
    es: 'Aperitivo a pie de playa',
    en: 'Aperitif by the beach',
    d_es: 'Vermut o gin tonic en cualquier chiringuito de la zona: Marau, Las Buganvillas o Playa Turquesa funcionan bien.',
    d_en: 'Vermouth or gin tonic at any local beach bar: Marau, Las Buganvillas or Playa Turquesa all work.'
  }, {
    t: '21:30',
    es: 'Cena en Lúa',
    en: 'Dinner at Lúa',
    d_es: 'Cocina creativa de producto, mar y huerta. Reservad, los fines de semana se llenan. Carta de vinos cuidada.',
    d_en: 'Creative seasonal cuisine, sea and garden produce. Book ahead, weekends fill up. Considered wine list.'
  }, {
    t: '23:00',
    es: 'Paseo por la orilla o por el Paseo del Mediterráneo',
    en: 'Stroll along the shore or the Paseo del Mediterráneo',
    d_es: 'Si la marea está baja, descalzos por la arena hacia el sur. Si no, el paseo iluminado entre palmeras. Brisa de mar y luna llena (si hay suerte).',
    d_en: 'If the tide is low, barefoot along the sand southwards. If not, the lit promenade between palm trees. Sea breeze and full moon (if you are lucky).'
  }, {
    t: '23:45',
    es: 'Última copa en terraza',
    en: 'Nightcap on a terrace',
    d_es: 'Yaho, Lúa mismo o cualquier coctelería del paseo para un destilado tranquilo antes de volver a Hestía.',
    d_en: 'Yaho, Lúa itself or any cocktail bar on the promenade for a quiet last drink before heading back to Hestía.'
  }],
  ...
  steps: [{
    t: '20:00',
    es: 'Llegada a Garrucha y paseo previo',
    en: 'Arrive in Garrucha, pre-dinner stroll',
    d_es: 'Aparcad cerca del puerto. Bajad al malecón para abrir apetito viendo cómo amarra la flota.',
    d_en: 'Park near the harbour. Walk down the malecón to work up an appetite watching the fleet moor.'
  }, {
    t: '20:30',
    es: 'Cena de gambas rojas',
    en: 'Red-prawn dinner',
    d_es: 'La gamba roja de Garrucha es D.O. y se come a pie de puerto. Restaurante El Almejero, Mesón Manolo o cualquier marisquería del paseo. Si vais con niños: arroz a banda, calamares, pescaíto. Para adultos: gamba roja a la plancha + vino blanco frío.',
    d_en: 'Garrucha red prawns are PDO and best at the port. El Almejero, Mesón Manolo or any seafood spot on the promenade. With kids: arroz a banda, calamari, fried fish. Adults: grilled red prawns + cold white wine.'
  }, {
    t: '22:00',
    es: 'Paseo del malecón hasta el faro',
    en: 'Walk the malecón to the lighthouse',
    d_es: 'Tramo iluminado de un kilómetro junto a las barcas. Bancos para parar. Niños felices con las farolas y el ruido de las olas contra el espigón.',
    d_en: 'A lit one-kilometre stretch along the boats. Plenty of benches. Kids love the lamps and the waves against the breakwater.'
  }, {
    t: '22:45',
    es: 'Helado o churros antes de volver',
    en: 'Ice cream or churros before heading back',
    d_es: 'Heladería La Ibense en el paseo (artesanal). Si abre, los churros del puerto son un clásico.',
    d_en: 'La Ibense ice-cream parlour on the promenade (artisanal). If open, the harbour churros are a classic.'
  }],
  ...
  steps: [{
    t: '15:00',
    es: 'Salida hacia Sierra de los Filabres',
    en: 'Drive to Sierra de los Filabres',
    d_es: '2 h por A-7, A-92 y AL-3404. Carretera de montaña al final, sin dificultad pero con curvas. Reservad la visita guiada en calaraltoexperience.com con varias semanas de antelación, las plazas vuelan.',
    d_en: '2 h via A-7, A-92 and AL-3404. Mountain road at the end, no difficulty but winding. Book the guided tour at calaraltoexperience.com several weeks in advance, slots sell out fast.'
  }, {
    t: '17:00',
    es: 'Visita guiada al observatorio (telescopio 3.5m)',
    en: 'Guided tour of the observatory (3.5m telescope)',
    d_es: 'A 2.168 m de altitud. Visita el telescopio español más grande, sala de control, exposición. Astrónomos profesionales explican el trabajo del CAHA.',
    d_en: 'At 2,168 m altitude. Visit Spain\'s largest telescope, the control room, the exhibition. Professional astronomers explain CAHA\'s work.'
  }, {
    t: '19:30',
    es: 'Cena en Bacares o Serón',
    en: 'Dinner in Bacares or Serón',
    d_es: 'Pueblos serranos. En Serón el jamón es de los mejores de España (D.O. Serón). Mesón El Tano o cualquier hostal con menú casero serrano: migas, gachas, choto al ajillo.',
    d_en: 'Mountain villages. Serón ham is among Spain\'s best (PDO Serón). Mesón El Tano or any inn with home-style mountain menu: migas, gachas, kid stew with garlic.'
  }, {
    t: '21:30',
    es: 'Observación de estrellas en mirador',
    en: 'Stargazing at a viewpoint',
    d_es: 'Vuelta hacia el observatorio o cualquier mirador alto de los Filabres. Cielo Starlight certificado: la Vía Láctea se ve a simple vista. Aplicación SkyView o Stellarium en el móvil para identificar.',
    d_en: 'Drive back near the observatory or any high Filabres viewpoint. Starlight-certified sky: Milky Way visible to the naked eye. Use SkyView or Stellarium on your phone to identify.'
  }, {
    t: '22:30',
    es: 'Vuelta a Hestía',
    en: 'Drive back to Hestía',
    d_es: '1h45. Despacio en las curvas, las cabras montesas cruzan de noche. Si vais cansados, dormid en una casa rural de Bacares.',
    d_en: '1h45. Take the curves slowly, wild goats cross at night. If you are tired, stay over at a rural house in Bacares.'
  }],
  ...
  steps: [{
    t: '7:00',
    es: 'Salida temprano hacia Granada',
    en: 'Early drive to Granada',
    d_es: '3 h 30 min por A-7 y A-92. Desayuno rápido en Hestía o parada en gasolinera de Sorbas.',
    d_en: '3 h 30 min via A-7 and A-92. Quick breakfast at Hestía or a stop at the Sorbas service station.'
  }, {
    t: '10:30',
    es: 'Llegada a Granada · aparcamiento Alhambra',
    en: 'Arrive in Granada · Alhambra parking',
    d_es: 'Parking oficial junto al recinto. Si llegáis con margen, café en el Parador antes de entrar.',
    d_en: 'Official car park next to the complex. If you arrive early, coffee at the Parador before entering.'
  }, {
    t: '11:00',
    es: 'Visita a la Alhambra · Nazaríes, Generalife, Alcazaba',
    en: 'Alhambra visit · Nasrid Palaces, Generalife, Alcazaba',
    d_es: 'Entrada con franja horaria, respetad la hora de los Nazaríes. 3 horas de visita sin prisa.',
    d_en: 'Timed-entry ticket, respect the Nasrid Palaces slot. 3 hours unhurried.'
  }, {
    t: '14:30',
    es: 'Comida en el Realejo o cerca de Plaza Nueva',
    en: 'Lunch in Realejo or near Plaza Nueva',
    d_es: 'Tapeo andaluz o un menú tranquilo. Los Diamantes (clásico) o Bar Ávila (tapas con la caña).',
    d_en: 'Andalusian tapas or a relaxed menu. Los Diamantes (classic) or Bar Ávila (free tapa with each drink).'
  }, {
    t: '16:30',
    es: 'Subir al Albaicín por la Cuesta del Chapiz',
    en: 'Walk up to the Albaicín via Cuesta del Chapiz',
    d_es: 'Calles blancas, cármenes, jazmines. Calzado cómodo, las cuestas pinchan.',
    d_en: 'White streets, carmen houses, jasmine. Comfortable shoes, the slopes bite.'
  }, {
    t: '17:30',
    es: 'Mirador de San Nicolás',
    en: 'San Nicolás viewpoint',
    d_es: 'La estampa más famosa de Granada: la Alhambra con Sierra Nevada al fondo. Llegad antes de que llene.',
    d_en: 'Granada\'s most famous view: the Alhambra with Sierra Nevada behind. Arrive before it fills up.'
  }, {
    t: '18:30',
    es: 'Bajada por el Sacromonte (opcional) o vuelta al coche',
    en: 'Down through Sacromonte (optional) or back to the car',
    d_es: 'Si os queda energía, asomaos al Sacromonte y a sus cuevas-flamenco. Si no, directo al coche.',
    d_en: 'If energy allows, peek into Sacromonte and its cave-flamenco venues. Otherwise, straight to the car.'
  }, {
    t: '19:00',
    es: 'Salida hacia Vera Playa',
    en: 'Drive back to Vera Playa',
    d_es: '3 h 30 min. Atardecer entre olivos y el Desierto de Tabernas al cruzar.',
    d_en: '3 h 30 min. Sunset through olive groves and the Tabernas Desert on the way back.'
  }, {
    t: '22:30',
    es: 'Vuelta a Hestía sin trasnochar',
    en: 'Back to Hestía, not too late',
    d_es: 'Día largo pero memorable. Una cerveza en la terraza y a la cama.',
    d_en: 'Long but memorable day. A beer on the terrace and to bed.'
  }],
...

{
  ...
  tags_es: ['jueves', 'mercado', 'desayuno', 'tomate raf'],
  tags_en: ['thursday', 'market', 'breakfast', 'raf tomato'],
  steps: [{
    t: '9:00',
    es: 'Salida hacia Vera pueblo',
    en: 'Drive to Vera town',
    d_es: '10 min en coche por la AL-7107.',
    d_en: '10 min by car on AL-7107.',
    km: 8,
    gmaps: 'https://maps.google.com/?q=Vera+Almeria'
  }, {
    t: '9:15',
    es: 'Desayuno en Bar Manolo',
    en: 'Breakfast at Bar Manolo',
    d_es: 'Tostada con tomate raf y aceite, café con leche. 4€.',
    d_en: 'Raf tomato + olive oil toast, café con leche. €4.',
    km: 0.2,
    gmaps: 'https://maps.google.com/?q=Bar+Manolo+Vera+Almeria',
    rating: {
      v: 4.4,
      src: 'google'
    }
    ...
    t: '10:00',
    es: 'Mercadillo · Plaza Mayor',
    en: 'Market · Plaza Mayor',
    d_es: 'Tomate raf, queso curado de Garrucha, miel de azahar, aceitunas aliñadas, hierbas, ropa.',
    d_en: 'Raf tomato, Garrucha cured cheese, orange-blossom honey, marinated olives, herbs, clothes.',
    km: 0.1,
    gmaps: 'https://maps.google.com/?q=Mercadillo+Vera+Almeria',
    rating: {
      v: 4.5,
      src: 'google'
    }
    ...
    en: 'Back to Hestía',
    km: 8,
    gmaps: 'https://maps.google.com/?q=Vera+Playa'
  }],
  ...
  tags_es: ['termas', 'aguas termales', 'romano', 'silencio'],
  tags_en: ['thermal', 'spa', 'roman', 'silence'],
  steps: [{
    t: '8:30',
    es: 'Salida hacia Pechina',
    en: 'Drive to Pechina',
    d_es: '70 min por la A-7 dirección Almería.',
    d_en: '70 min on the A-7 toward Almería.',
    km: 90,
    gmaps: 'https://maps.google.com/?q=Pechina+Almeria'
  }, {
    t: '9:45',
    es: 'Llegada al Balneario de Sierra Alhamilla',
    en: 'Arrival at Sierra Alhamilla Spa',
    d_es: 'Aguas a 58° desde tiempos romanos. Edificio del s.XVIII.',
    d_en: '58° waters since Roman times. 18th-c. building.',
    km: 0,
    gmaps: 'https://maps.google.com/?q=Balneario+Sierra+Alhamilla',
    rating: {
      v: 4.6,
      src: 'google'
    }
    ...
    t: '10:00',
    es: 'Baños en piscina termal y cuevas',
    en: 'Bath in thermal pool and caves',
    d_es: 'Agua mineralizada con propiedades terapéuticas. ~10€/persona.',
    d_en: 'Mineralized water with therapeutic properties. ~€10/person.',
    km: 0,
    gmaps: 'https://maps.google.com/?q=Balneario+Sierra+Alhamilla'
  }, {
    t: '11:30',
    es: 'Desayuno en el restaurante del balneario',
    en: 'Breakfast at the spa restaurant',
    d_es: 'Tortilla, café, vista al pueblo de Pechina al fondo.',
    d_en: 'Tortilla, coffee, view of Pechina village below.',
    km: 0,
    gmaps: 'https://maps.google.com/?q=Balneario+Sierra+Alhamilla'
  }, {
    t: '12:30',
    es: 'Vuelta a Vera Playa',
    en: 'Back to Vera Playa',
    km: 90,
    gmaps: 'https://maps.google.com/?q=Vera+Playa'
  }],
  ...
  tags_es: ['faro', 'flamencos', 'mirador'],
  tags_en: ['lighthouse', 'flamingos', 'viewpoint'],
  steps: [{
    t: '9:00',
    es: 'Salida hacia Cabo de Gata',
    en: 'Drive to Cabo de Gata',
    d_es: '1 h 15 min, carretera espectacular.',
    d_en: '1 h 15 min, spectacular road.',
    km: 90,
    gmaps: 'https://maps.google.com/?q=Cabo+de+Gata'
  }, {
    t: '10:15',
    es: 'Salinas de Cabo de Gata · flamencos',
    en: 'Cabo de Gata salt flats · flamingos',
    d_es: 'Otra colonia de flamencos diferente a la de Vera. Foto desde el observatorio.',
    d_en: 'Another flamingo colony, different from Vera. Photo from the observatory.',
    km: 5,
    gmaps: 'https://maps.google.com/?q=Salinas+Cabo+de+Gata',
    rating: {
      v: 4.7,
      src: 'google'
    }
    ...
    t: '11:00',
    es: 'Faro y arrecife de las Sirenas',
    en: 'Lighthouse and Sirens reef',
    d_es: 'Mirador con vista a las dos columnas volcánicas saliendo del mar.',
    d_en: 'Lookout with view of the two volcanic columns rising from the sea.',
    km: 5,
    gmaps: 'https://maps.google.com/?q=Faro+Cabo+de+Gata',
    rating: {
      v: 4.6,
      src: 'google'
    }
  ...
  tags_es: ['playa virgen', 'atardecer', 'sin servicios'],
  tags_en: ['virgin beach', 'sunset', 'no services'],
  steps: [{
    t: '17:00',
    es: 'Salida hacia San José',
    en: 'Drive to San José',
    d_es: '1 h 10 min por la N-340 y AL-3115.',
    d_en: '1 h 10 min on N-340 and AL-3115.',
    km: 85,
    gmaps: 'https://maps.google.com/?q=San+Jose+Almeria'
  }, {
    t: '18:15',
    es: 'Aparcar en el parking de Genoveses',
    en: 'Park at the Genoveses car park',
    d_es: 'En verano hay barrera de coches: parking de pago + bus lanzadera o caminar 20 min.',
    d_en: 'In summer cars are restricted: paid parking + shuttle bus, or 20-min walk.',
    km: 6,
    gmaps: 'https://maps.google.com/?q=Playa+de+los+Genoveses',
    rating: {
      v: 4.7,
      src: 'google'
    }
    ...
    t: '18:45',
    es: 'Baño y paseo por la playa virgen',
    en: 'Swim and walk on the virgin beach',
    d_es: '1.300 m de arena dorada sin construcciones. Eucaliptos al borde.',
    d_en: '1,300 m of golden sand with no buildings. Eucalyptus at the edge.',
    km: 0,
    gmaps: 'https://maps.google.com/?q=Playa+de+los+Genoveses'
  }, {
    t: '19:30',
    es: 'Atardecer mirando al cabo',
    en: 'Sunset facing the cape',
    d_es: 'El sol cae detrás del Cerro del Cabrero. Aire fresco al ponerse.',
    d_en: 'Sun drops behind Cerro del Cabrero. Cool air when it sets.',
    km: 0,
    gmaps: 'https://maps.google.com/?q=Playa+de+los+Genoveses'
  }, {
    t: '20:00',
  ...
  tags_es: ['geoda', 'minería', 'cala', 'niños'],
  tags_en: ['geode', 'mining', 'cove', 'kids'],
  steps: [{
    t: '10:00',
    es: 'Salida hacia Pulpí',
    en: 'Drive to Pulpí',
    d_es: '45 min, reserva online imprescindible.',
    d_en: '45 min, online booking required.',
    km: 45,
    gmaps: 'https://maps.google.com/?q=Pulpi+Almeria'
  }, {
    t: '11:00',
    es: 'Visita guiada a la Geoda Gigante',
    en: 'Guided tour of the Giant Geode',
    d_es: '8 m de cristales, la 2ª más grande del mundo. Casco, linterna y arnés incluidos. ~22€ adulto.',
    d_en: '8 m of crystals, the world\'s 2nd largest. Helmet, lamp and harness included. ~€22/adult.',
    km: 0,
    gmaps: 'https://maps.google.com/?q=Geoda+Pulpi',
    rating: {
      v: 4.8,
      src: 'google'
    }
    ...
    t: '13:00',
    es: 'Comida en San Juan de los Terreros',
    en: 'Lunch at San Juan de los Terreros',
    d_es: 'Pueblo costero pequeño. Restaurantes a pie de mar (Mejillonera, La Tasca).',
    d_en: 'Small coastal village. Beachfront restaurants (Mejillonera, La Tasca).',
    km: 13,
    gmaps: 'https://maps.google.com/?q=San+Juan+de+los+Terreros',
    rating: {
      v: 4.3,
      src: 'google'
    }
    ...
    en: 'Cocedores beach',
    d_es: 'Cuevas excavadas en la arenisca, perfectas para que los niños exploren. Aguas turquesas.',
    d_en: 'Caves carved into the sandstone, perfect for kids to explore. Turquoise waters.',
    km: 8,
    gmaps: 'https://maps.google.com/?q=Playa+de+los+Cocedores',
    rating: {
      v: 4.6,
      src: 'google'
    }
  ...
  tags_es: ['romano', 'modernismo', 'puerto', 'tapas'],
  tags_en: ['roman', 'modernism', 'harbour', 'tapas'],
  steps: [{
    t: '8:00',
    es: 'Salida hacia Cartagena',
    en: 'Drive to Cartagena',
    d_es: '1 h 45 min por la A-7 y AP-7.',
    d_en: '1 h 45 min on A-7 and AP-7.',
    km: 160,
    gmaps: 'https://maps.google.com/?q=Cartagena+Spain'
  }, {
    t: '10:00',
    es: 'Teatro Romano de Cartagena',
    en: 'Roman Theatre of Cartagena',
    d_es: 'Reabierto en 2008 tras décadas enterrado. Imprescindible. ~7€.',
    d_en: 'Reopened in 2008 after decades buried. Must-see. ~€7.',
    km: 0,
    gmaps: 'https://maps.google.com/?q=Teatro+Romano+Cartagena',
    rating: {
      v: 4.7,
      src: 'google'
    }
    ...
    t: '12:00',
    es: 'Calle Mayor + Casino + Casas modernistas',
    en: 'Main street + Casino + Modernist houses',
    d_es: 'Joya del modernismo español. Caminad sin prisa.',
    d_en: 'Spanish modernism gem. Walk slowly.',
    km: 0.5,
    gmaps: 'https://maps.google.com/?q=Calle+Mayor+Cartagena',
    rating: {
      v: 4.6,
      src: 'google'
    }
    ...
    t: '13:30',
    es: 'Comida de tapas en La Marquesita',
    en: 'Lunch tapas at La Marquesita',
    d_es: 'Marineras (boquerones en vinagre sobre rosquilla), invento cartagenero. ~25€/persona.',
    d_en: 'Marineras (vinegar anchovy on a rosquilla bagel), Cartagena invention. ~€25/person.',
    km: 0.3,
    gmaps: 'https://maps.google.com/?q=La+Marquesita+Cartagena',
    rating: {
      v: 4.4,
      src: 'google'
    }
    ...
    t: '15:30',
    es: 'Puerto y submarino Peral',
    en: 'Harbour and Peral submarine',
    d_es: '1er submarino con propulsión eléctrica del mundo (1888). Paseo por el muelle.',
    d_en: 'World\'s first electric-powered submarine (1888). Walk along the docks.',
    km: 0.7,
    gmaps: 'https://maps.google.com/?q=Submarino+Peral+Cartagena',
    rating: {
      v: 4.5,
      src: 'google'
    }
    ...
    t: '16:30',
    es: 'Castillo de la Concepción · ascensor panorámico',
    en: 'Concepción Castle · panoramic lift',
    d_es: 'Vistas 360° de la bahía. Ascensor desde el puerto.',
    d_en: '360° bay views. Lift from the harbour.',
    km: 0.5,
    gmaps: 'https://maps.google.com/?q=Castillo+de+la+Concepcion+Cartagena',
    rating: {
      v: 4.5,
      src: 'google'
    }
    ...
    t: '17:30',
    es: 'Café y vuelta',
    en: 'Coffee and drive back',
    d_es: '1 h 45 min de carretera.',
    d_en: '1 h 45 min drive.',
    km: 160,
    gmaps: 'https://maps.google.com/?q=Vera+Playa'
  }],
  ...
  tags_es: ['castillo', 'semana santa', 'judería', 'bordados'],
  tags_en: ['castle', 'holy week', 'jewish quarter', 'embroidery'],
  steps: [{
    t: '9:00',
    es: 'Salida hacia Lorca',
    en: 'Drive to Lorca',
    d_es: '1 h por la A-7.',
    d_en: '1 h on A-7.',
    km: 80,
    gmaps: 'https://maps.google.com/?q=Lorca+Murcia'
  }, {
    t: '10:00',
    es: 'Castillo de Lorca · Fortaleza del Sol',
    en: 'Lorca Castle · Sun Fortress',
    d_es: 'Torre Alfonsina, sinagoga medieval y judería excavada en 2002. Tren turístico desde el casco.',
    d_en: 'Alfonsina Tower, medieval synagogue and Jewish quarter excavated in 2002. Tourist train from old town.',
    km: 1,
    gmaps: 'https://maps.google.com/?q=Castillo+de+Lorca',
    rating: {
      v: 4.5,
      src: 'google'
    }
    ...
    t: '12:00',
    es: 'Casco histórico · Plaza de España y Colegiata',
    en: 'Old town · Plaza España and Colegiata',
    d_es: 'Iglesia de San Patricio (s.XVI), una de las pocas colegiatas extra-catedralicias.',
    d_en: 'San Patricio church (16th c.), one of the few non-cathedral collegiates.',
    km: 1,
    gmaps: 'https://maps.google.com/?q=Plaza+de+Espana+Lorca',
    rating: {
      v: 4.6,
      src: 'google'
    }
    ...
    t: '13:30',
    es: 'Museo del Bordado · Paso Azul o Paso Blanco',
    en: 'Embroidery Museum · Paso Azul or Paso Blanco',
    d_es: 'Bordado en seda único en el mundo, declarado Patrimonio Inmaterial. ~6€.',
    d_en: 'Silk embroidery unique in the world, declared Intangible Heritage. ~€6.',
    km: 0.3,
    gmaps: 'https://maps.google.com/?q=Museo+Bordado+Paso+Azul+Lorca',
    rating: {
      v: 4.7,
      src: 'google'
    }
    ...
    t: '14:30',
    es: 'Comida en El Esquinazo',
    en: 'Lunch at El Esquinazo',
    d_es: 'Cocina lorquina tradicional: migas, michirones, conejo al ajillo. ~30€/persona.',
    d_en: 'Traditional Lorca cuisine: migas, michirones, garlic rabbit. ~€30/person.',
    km: 0.5,
    gmaps: 'https://maps.google.com/?q=El+Esquinazo+Lorca',
    rating: {
      v: 4.4,
      src: 'google'
    }
  ...
  tags_es: ['sierra', 'río', 'parque natural', 'desconexión'],
  tags_en: ['mountains', 'river', 'natural park', 'disconnect'],
  steps: [{
    t: '8:00',
    es: 'Salida hacia Cazorla',
    en: 'Drive to Cazorla',
    d_es: '2 h 45 min por la A-7 y A-92.',
    d_en: '2 h 45 min on A-7 and A-92.',
    km: 230,
    gmaps: 'https://maps.google.com/?q=Cazorla+Jaen'
  }, {
    t: '10:45',
    es: 'Pueblo de Cazorla · Plaza de Santa María',
    en: 'Cazorla town · Plaza Santa María',
    d_es: 'Pueblo blanco encajado entre dos sierras. Café en cualquiera de las terrazas.',
    d_en: 'White village wedged between two ranges. Coffee at any terrace.',
    km: 1,
    gmaps: 'https://maps.google.com/?q=Plaza+de+Santa+Maria+Cazorla',
    rating: {
      v: 4.7,
      src: 'google'
    }
    ...
    t: '11:30',
    es: 'Sendero del Río Borosa (tramo corto, 4 km)',
    en: 'Río Borosa trail (short 4 km section)',
    d_es: 'Pasarelas sobre el río más espectacular del parque. Plano y familiar.',
    d_en: 'Walkways over the park\'s most spectacular river. Flat and family-friendly.',
    km: 25,
    gmaps: 'https://maps.google.com/?q=Sendero+Rio+Borosa',
    rating: {
      v: 4.8,
      src: 'google'
    }
    ...
    t: '14:00',
    es: 'Comida en Mesón Leandro (Burunchel)',
    en: 'Lunch at Mesón Leandro (Burunchel)',
    d_es: 'Cocina serrana: venado, ciervo, gachamigas. ~35€/persona.',
    d_en: 'Mountain cuisine: venison, deer, gachamigas. ~€35/person.',
    km: 15,
    gmaps: 'https://maps.google.com/?q=Meson+Leandro+Burunchel',
    rating: {
      v: 4.6,
      src: 'google'
    }
    ...
    t: '16:00',
    es: 'Mirador Cinco Puertas',
    en: 'Cinco Puertas viewpoint',
    d_es: 'Vista de toda la Sierra de Cazorla con el embalse del Tranco al fondo.',
    d_en: 'Sweeping view of all Sierra de Cazorla with the Tranco reservoir below.',
    km: 10,
    gmaps: 'https://maps.google.com/?q=Mirador+Cinco+Puertas+Cazorla',
    rating: {
      v: 4.7,
      src: 'google'
    }
  ...
  tags_es: ['tapas', 'rutas tapas', 'vino', 'barato'],
  tags_en: ['tapas', 'tapas route', 'wine', 'cheap'],
  steps: [{
    t: '20:00',
    es: 'Salida hacia Vera pueblo',
    en: 'Drive to Vera town',
    d_es: '10 min en coche.',
    d_en: '10 min by car.',
    km: 8,
    gmaps: 'https://maps.google.com/?q=Vera+Almeria'
  }, {
    t: '20:15',
    es: 'Bar Las Vegas · cerveza + tapa de marisco',
    en: 'Bar Las Vegas · beer + seafood tapa',
    d_es: 'Cerveza fría + chocos fritos o gambas, gratis con la consumición. ~3€.',
    d_en: 'Cold beer + fried squid or shrimp, free with the drink. ~€3.',
    km: 0.3,
    gmaps: 'https://maps.google.com/?q=Bar+Las+Vegas+Vera+Almeria',
    rating: {
      v: 4.4,
      src: 'google'
    }
    ...
    t: '21:00',
    es: 'Bodega El Choto · vino + tapa de carne',
    en: 'Bodega El Choto · wine + meat tapa',
    d_es: 'Buena selección de vinos murcianos y andaluces. Ambiente tradicional. ~5€/copa.',
    d_en: 'Good Murcia and Andalusia wine selection. Traditional atmosphere. ~€5/glass.',
    km: 0.2,
    gmaps: 'https://maps.google.com/?q=Bodega+El+Choto+Vera+Almeria',
    rating: {
      v: 4.5,
      src: 'google'
    }
    ...
    t: '21:45',
    es: 'Bar Pasaje · ración para compartir',
    en: 'Bar Pasaje · sharing platter',
    d_es: 'Pulpo a la gallega o jamón ibérico. Mesa fuera en verano. ~12€/ración.',
    d_en: 'Galician octopus or Iberian ham. Outdoor table in summer. ~€12/dish.',
    km: 0.1,
    gmaps: 'https://maps.google.com/?q=Bar+Pasaje+Vera+Almeria',
    rating: {
      v: 4.5,
      src: 'google'
    }
    ...
    t: '22:30',
    es: 'Helado en Heladería La Ibense',
    en: 'Ice cream at La Ibense',
    d_es: 'Heladería artesanal del paseo: turrón, chocolate al ron, mantecado.',
    d_en: 'Artisan ice cream parlour on the promenade: turrón, rum chocolate, mantecado.',
    km: 0.2,
    gmaps: 'https://maps.google.com/?q=Heladeria+La+Ibense+Vera',
    rating: {
      v: 4.6,
      src: 'google'
    }
  ...
  tags_es: ['pesca', 'marisco', 'paella', 'arroz'],
  tags_en: ['fishing', 'seafood', 'paella', 'rice'],
  steps: [{
    t: '10:30',
    es: 'Salida hacia Villaricos',
    en: 'Drive to Villaricos',
    d_es: '15 min por la AL-7.',
    d_en: '15 min on AL-7.',
    km: 13,
    gmaps: 'https://maps.google.com/?q=Villaricos+Almeria'
  }, {
    t: '10:50',
    es: 'Pescadería del puerto · ver llegar las barcas',
    en: 'Port fish market · watch boats arrive',
    d_es: 'Las barcas llegan sobre las 11. Pescado del día: gambas, calamar, sepia. Compradlo y os lo limpian.',
    d_en: 'Boats arrive around 11. Day catch: shrimp, squid, cuttlefish. Buy and they clean it for you.',
    km: 0.5,
    gmaps: 'https://maps.google.com/?q=Lonja+de+Villaricos',
    rating: {
      v: 4.5,
      src: 'google'
    }
    ...
    t: '12:00',
    es: 'Paseo por el puerto y la cala de la Galera',
    en: 'Walk port and Galera cove',
    d_es: 'Pueblo pesquero auténtico, sin turisficar. La cala es de piedra pequeña.',
    d_en: 'Authentic fishing village, untouched by tourism. Cove has small pebbles.',
    km: 0.3,
    gmaps: 'https://maps.google.com/?q=Cala+de+la+Galera+Villaricos'
  }, {
    t: '13:00',
    es: 'Comida en Restaurante Tadeo',
    en: 'Lunch at Restaurant Tadeo',
    d_es: 'Arroz con bogavante: la mejor de la zona, sin excepciones. Reservad. ~35€/persona.',
    d_en: 'Lobster rice: the best in the area, no exceptions. Book ahead. ~€35/person.',
    km: 0.2,
    gmaps: 'https://maps.google.com/?q=Restaurante+Tadeo+Villaricos',
    rating: {
      v: 4.7,
      src: 'google'
    }
  ...
  id: 'plan-monsul-mojacar-mediodia',
  type: 'fullday',
  audience: 'both',
  duration_h: 6,
  ...
  tags_es: ['playa virgen', 'pueblo blanco', 'dos en uno'],
  tags_en: ['virgin beach', 'white village', 'two-in-one'],
  steps: [{
    t: '9:00',
    es: 'Salida hacia San José',
    en: 'Drive to San José',
    d_es: '1 h 10 min, salir temprano para evitar barrera de coches.',
    d_en: '1 h 10 min, leave early to beat car barrier.',
    km: 85,
    gmaps: 'https://maps.google.com/?q=San+Jose+Almeria'
  }, {
    t: '10:15',
    es: 'Subir a la duna de Mónsul',
    en: 'Climb the Mónsul dune',
    d_es: 'Foto desde lo alto. Sentirás Indiana Jones (rodaron aquí La última cruzada).',
    d_en: 'Photo from the top. Indiana Jones moment (Last Crusade was filmed here).',
    km: 6,
    gmaps: 'https://maps.google.com/?q=Playa+de+Monsul',
    rating: {
      v: 4.8,
      src: 'google'
    }
    ...
    es: 'Baño en Mónsul',
    en: 'Swim at Mónsul',
    d_es: 'La roca circular en el agua es la marca de la casa.',
    d_en: 'The circular rock in the water is the trademark.',
    km: 0,
    gmaps: 'https://maps.google.com/?q=Playa+de+Monsul'
  }, {
    t: '13:00',
    es: 'Comida en La Ola (San José)',
    en: 'Lunch at La Ola (San José)',
    d_es: 'A pie de mar. Pulpo, tartar de atún, arroces. ~40€/persona.',
    d_en: 'Beachfront. Octopus, tuna tartare, rices. ~€40/person.',
    km: 6,
    gmaps: 'https://maps.google.com/?q=La+Ola+San+Jose+Almeria',
    rating: {
      v: 4.5,
      src: 'google'
    }
    ...
    t: '15:00',
    es: 'Salida hacia Mojácar pueblo',
    en: 'Drive to Mojácar village',
    d_es: '40 min, carretera por la costa.',
    d_en: '40 min, coast road.',
    km: 50,
    gmaps: 'https://maps.google.com/?q=Mojacar+Pueblo'
  }, {
    t: '15:45',
    es: 'Mojácar pueblo · Plaza Nueva y mirador',
    en: 'Mojácar village · Plaza Nueva and lookout',
    d_es: 'Pueblo blanco encalado en la sierra. Vistas a 360°. Heladería La Veleta para la merienda.',
    d_en: 'White-washed mountain village. 360° views. La Veleta ice-cream stop.',
    km: 1,
    gmaps: 'https://maps.google.com/?q=Plaza+Nueva+Mojacar',
    rating: {
      v: 4.7,
      src: 'google'
    }
  ...
  tags_es: ['cuevas', 'karst', 'geología', 'aventura'],
  tags_en: ['caves', 'karst', 'geology', 'adventure'],
  steps: [{
    t: '10:00',
    es: 'Salida hacia Sorbas',
    en: 'Drive to Sorbas',
    d_es: '45 min por la A-7.',
    d_en: '45 min on A-7.',
    km: 60,
    gmaps: 'https://maps.google.com/?q=Sorbas+Almeria'
  }, {
    t: '11:00',
    es: 'Visita guiada a las Cuevas de Sorbas',
    en: 'Guided tour of Sorbas Caves',
    d_es: 'Karst de yesos único en Europa. 2 h con casco y linterna. ~22€ adulto.',
    d_en: 'Gypsum karst unique in Europe. 2 h with helmet and lamp. ~€22/adult.',
    km: 5,
    gmaps: 'https://maps.google.com/?q=Cuevas+de+Sorbas',
    rating: {
      v: 4.7,
      src: 'google'
    }
    ...
    t: '13:00',
    es: 'Comida en Sorbas pueblo',
    en: 'Lunch in Sorbas town',
    d_es: 'Mesón La Era: cocina serrana, gachas, migas. ~25€/persona.',
    d_en: 'Mesón La Era: mountain cuisine, gachas, migas. ~€25/person.',
    km: 5,
    gmaps: 'https://maps.google.com/?q=Sorbas+Almeria',
    rating: {
      v: 4.4,
    ...
    t: '14:30',
    es: 'Vuelta con parada en mirador del Río Aguas',
    en: 'Drive back via Río Aguas viewpoint',
    d_es: '5 min en la salida del pueblo. El cañón se ve desde arriba.',
    d_en: '5 min from town exit. Canyon seen from above.',
    km: 65,
    gmaps: 'https://maps.google.com/?q=Vera+Playa'
  }],
...
const DayPlanCard = ({
  ...
  return /*#__PURE__*/React.createElement("article", {
    className: `dp-card ${open ? 'is-open' : ''}`
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    return /*#__PURE__*/React.createElement("span", {
      key: th,
      className: "dp-meta-pill dp-meta-theme",
      style: {
        '--theme-color': def.color
      }
  ...
  }, plan.steps.map((s, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    className: "dp-step"
  }, /*#__PURE__*/React.createElement("span", {
    className: "dp-step-time"
  }, s.t), /*#__PURE__*/React.createElement("div", {
    className: "dp-step-body"
  }, /*#__PURE__*/React.createElement("strong", {
    className: "dp-step-what"
  }, s[lang]), s[`d_${lang}`] && /*#__PURE__*/React.createElement("span", {
    className: "dp-step-detail"
  }, s[`d_${lang}`]), (s.km != null || s.gmaps || s.rating) && /*#__PURE__*/React.createElement("div", {
    ...
    target: "_blank",
    rel: "noopener"
  }, lang === 'es' ? 'Cómo llegar →' : 'Directions →')))))), tip && /*#__PURE__*/React.createElement("div", {
    className: "dp-tip"
  }, /*#__PURE__*/React.createElement("span", {
    className: "dp-tip-label"
  }, lang === 'es' ? 'Tip de Alex y Fran' : 'Tip from Alex & Fran'), /*#__PURE__*/React.createElement("span", {
    className: "dp-tip-text"
  }, tip))));
};
const DayPlans = ({
  lang
  ...
  const matches = p => {
    ...
    else if (audience === 'kids' && !(p.audience === 'kids' || p.audience === 'both')) return false;else if (audience === 'adults' && !(p.audience === 'adults' || p.audience === 'both' || !p.audience)) return false;
    if (duration !== 'all') {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "ag-day-plans"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ag-day-plans-head"
  }, /*#__PURE__*/React.createElement("span", {
    className: "eyebrow"
  }, lang === 'es' ? 'Sugerencias de excursiones' : 'Suggested excursions'), /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3",
    style: {
      margin: 0
    }
  }, lang === 'es' ? 'Planes de día por la zona' : 'One-day plans around'), /*#__PURE__*/React.createElement("p", {
    className: "ag-day-plans-disclaimer"
  }, lang === 'es' ? 'Estos son solo ideas, hay innumerables opciones para todos los gustos. Los horarios son orientativos: dependen tanto de vuestras necesidades como de las posibles excursiones o actividades que decidáis contratar. Las puntuaciones son las que aparecen en Google Maps cuando hicimos la guía. Os animamos a descubrir, vivir Vera y Hestía a vuestro propio ritmo.' : 'These are just ideas, there are countless options for every taste. The times are approximate: they depend on your own needs and on any excursions or activities you may book. Ratings are from Google Maps when we wrote this guide. We invite you to discover, to live Vera and Hestía at your own pace.')), /*#__PURE__*/React.createElement("div", {
    className: "dp-filters-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "dp-filter-label"
  }, lang === 'es' ? 'Audiencia' : 'Audience'), /*#__PURE__*/React.createElement("div", {
    className: "dp-tabs",
    role: "tablist"
    ...
    className: "dp-filter-label"
  }, lang === 'es' ? 'Duración' : 'Duration'), /*#__PURE__*/React.createElement("div", {
    className: "dp-tabs",
    role: "tablist"
  }, durationTabs.map(t => /*#__PURE__*/React.createElement("button", {
    key: t.id,
    role: "tab",
    type: "button",
    className: `dp-tab ${duration === t.id ? 'active' : ''}`,
    onClick: () => setDuration(t.id)
  }, t[lang] || t.es)))), /*#__PURE__*/React.createElement("div", {
    className: "dp-filters-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "dp-filter-label"
  }, lang === 'es' ? 'Tema' : 'Theme'), /*#__PURE__*/React.createElement("div", {
    className: "dp-theme-chips"
  ...
  }), themes.length > 0 && /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "dp-group-title"
    }, /*#__PURE__*/React.createElement("span", null, group[lang]), /*#__PURE__*/React.createElement("small", null, group[`sub_${lang}`])), /*#__PURE__*/React.createElement("div", {
      className: "dp-cards"
    }, plans.map(plan => /*#__PURE__*/React.createElement(DayPlanCard, {
      key: plan.id,
      plan: plan,
      lang: lang
    }))));
...
const AptGuideView = ({
  ...
  const getRoomPhotos = roomId => {
    ...
    const fromGallery = idxs.filter(i => i < galleryImgs.length).map(i => ({
      src: galleryImgs[i],
  ...
  return /*#__PURE__*/React.createElement("article", {
  ...
  }, lang === 'es' ? /*#__PURE__*/React.createElement(React.Fragment, null, "Tu Hestía,", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("em", null, "en ", GUIDE_GROUPS.length, " partes y ", GUIDE_SECTIONS.length, " capítulos.")) : /*#__PURE__*/React.createElement(React.Fragment, null, "Your Hestía,", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("em", null, "in ", GUIDE_GROUPS.length, " parts and ", GUIDE_SECTIONS.length, " chapters."))), /*#__PURE__*/React.createElement("ol", {
    ...
    className: "ag-h2"
  }, s.equipo.title), /*#__PURE__*/React.createElement("p", {
    className: "ag-para"
  }, s.equipo.intro), /*#__PURE__*/React.createElement("div", {
    className: "ag-team"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ag-team-grid"
  }, s.equipo.members.map((m, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
  ...
  }, m.body))))), s.equipo.pdNote && /*#__PURE__*/React.createElement("p", {
    className: "ag-welcome-pd"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-welcome-pd-tag"
  }, "P.D."), " ", s.equipo.pdNote, ' ', /*#__PURE__*/React.createElement("a", {
    className: "ag-welcome-pd-link",
    href: s.equipo.pdLinkHref,
    target: "_blank",
    rel: "noopener"
  }, s.equipo.pdLinkLabel, " →")))), /*#__PURE__*/React.createElement("div", {
    className: "ag-part-group"
  }, renderPart('registro'), /*#__PURE__*/React.createElement("section", {
    id: "ag-registro",
    className: "ag-section"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-section-num"
    ...
    className: "ag-h2"
  }, s.registro.title), /*#__PURE__*/React.createElement("p", {
    className: "ag-para ag-para-lead"
  }, s.registro.intro), /*#__PURE__*/React.createElement("a", {
    className: "btn btn-primary",
    href: `registro.html?apt=${apt.id}${(() => {
      try {
        const tk = sessionStorage.getItem('hestia-reg-token');
        return tk ? `&r=${encodeURIComponent(tk)}` : '';
      } catch (_) {
        return '';
      }
    })()}`,
    target: "_blank",
    rel: "noopener"
  }, s.registro.cta, " ", /*#__PURE__*/React.createElement("span", {
    className: "arrow"
  ...
  }, item.d)))))), /*#__PURE__*/React.createElement("section", {
    id: "ag-tiempo",
    className: "ag-section"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-section-num"
    ...
    className: "ag-h2"
  }, s.tiempo.title), /*#__PURE__*/React.createElement(GuideWeather14d, {
    lang: lang
    ...
    className: "ag-h2"
  }, s.expectativas.title), s.expectativas.paras.map((p, i) => /*#__PURE__*/React.createElement("p", {
    key: i,
    className: "ag-para"
  }, p))), s.checkin && /*#__PURE__*/React.createElement("section", {
    id: "ag-llegada",
    ...
    className: "ag-para"
  }, lang === 'es' ? 'En avión, autobús, tren o coche: aquí tienes lo que necesitas saber según cómo vengas. Te enviamos siempre las indicaciones exactas para los últimos kilómetros hasta la puerta.' : 'By plane, bus, train or car: here is what you need to know for each option. We always send you the exact directions for the last few kilometres to the door.'), /*#__PURE__*/React.createElement("div", {
    ...
    name: "plane",
    size: 20
  })), lang === 'es' ? 'En avión' : 'By plane'), /*#__PURE__*/React.createElement("p", {
    className: "ag-para"
  }, s.checkin.airportsIntro), /*#__PURE__*/React.createElement("div", {
    className: "ag-airports"
  }, s.checkin.airports.map((a, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: "ag-airport"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-airport-code"
    ...
    className: "ag-airport-notes"
  }, st.notes))))), s.checkin.stationsAve && /*#__PURE__*/React.createElement("div", {
    className: "ag-ave-curiosity"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, " · ", sp.town)), /*#__PURE__*/React.createElement("span", {
    ...
    className: "ag-para"
  }, s.cleaning.intro), /*#__PURE__*/React.createElement("p", {
    className: "ag-note"
  }, s.cleaning.note), /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3"
  }, lang === 'es' ? 'Recomendaciones' : 'Recommendations'), /*#__PURE__*/React.createElement("ol", {
    className: "ag-recs"
  }, s.cleaning.recs.map((r, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, r)))), s.rules && /*#__PURE__*/React.createElement("section", {
    id: "ag-normas",
    ...
    className: "ag-para"
  }, s.rules.intro), /*#__PURE__*/React.createElement("ul", {
    className: "ag-rules-grid"
  }, s.rules.items.map((rule, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    className: "ag-rule"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-rule-icon",
    "aria-hidden": "true"
  }, iconifyText(rule.icon, 18)), /*#__PURE__*/React.createElement("div", {
    className: "ag-rule-body"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "ag-rule-title"
    ...
    className: "ag-para"
  }, s.pets.intro), /*#__PURE__*/React.createElement("ul", {
    className: "ag-rules-grid"
  }, s.pets.items.map((item, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    className: "ag-rule"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-rule-icon",
    ...
    className: "ag-para"
  }, s.surroundings.intro), s.surroundings.disclaimer && /*#__PURE__*/React.createElement("aside", {
    className: "ag-disclaimer",
    role: "note"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-disclaimer-tag"
  }, s.surroundings.disclaimer_title), Array.isArray(s.surroundings.disclaimer) ? /*#__PURE__*/React.createElement("ul", {
    className: "ag-disclaimer-list"
  }, s.surroundings.disclaimer.map((item, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, item))) : /*#__PURE__*/React.createElement("p", {
    className: "ag-disclaimer-body"
  }, s.surroundings.disclaimer)), /*#__PURE__*/React.createElement(PlaceFinder, {
    lang: lang
  }), /*#__PURE__*/React.createElement(GuideMap, {
    lang: lang,
    apt: apt
  }), /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3"
  }, lang === 'es' ? 'Fuentes recomendadas' : 'Recommended sources'), /*#__PURE__*/React.createElement("ol", {
    className: "ag-recs"
  }, s.surroundings.sources.map((r, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, r))), s.surroundings.sites && /*#__PURE__*/React.createElement("div", {
    className: "ag-sites"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3"
  }, s.surroundings.sites.title), /*#__PURE__*/React.createElement("div", {
    className: "ag-sites-grid"
  }, s.surroundings.sites.groups.map((g, gi) => /*#__PURE__*/React.createElement("div", {
    key: gi,
    className: "ag-sites-group"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "ag-sites-group-title"
  }, g.title), /*#__PURE__*/React.createElement("ul", {
    className: "ag-sites-list"
  }, g.links.map((l, li) => /*#__PURE__*/React.createElement("li", {
    key: li
  }, /*#__PURE__*/React.createElement("a", {
    href: l.url,
    target: "_blank",
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Lleva siempre protección solar, gorra y agua, aquí el sol aprieta incluso en primavera. Para las calas de difícil acceso, calzado cómodo y escarpines. En las noches de costa entra brisa, así que una capa ligera viene bien hasta en verano. Si vienes en invierno, ropa de entretiempo y algo de abrigo para la tarde.' : 'Always bring sun protection, a cap and water, the sun is strong here even in spring. For the hard-access coves, comfortable shoes and water shoes. Coastal evenings get a breeze, so a light layer is welcome even in summer. If you come in winter, bring mid-season clothing and something warmer for the evening.'))), /*#__PURE__*/React.createElement("section", {
    id: "ag-lugares",
    className: "ag-section"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-section-num"
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Estos son los imprescindibles del Levante almeriense y la Región de Murcia, organizados por tipo y con la distancia desde Hestía.' : 'The must-sees of the Almería Levante and Murcia Region, sorted by type and with the distance from Hestía.'), /*#__PURE__*/React.createElement(PlacesOfInterestAtlas, {
    lang: lang
  })), /*#__PURE__*/React.createElement("section", {
    id: "ag-supermercados",
    className: "ag-section"
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Los supermercados más cercanos a Hestía, de menor a mayor distancia.' : 'The nearest supermarkets to Hestía, from closest to furthest.'), SECTION_CATS.supermercados.map(catId => {
    const cat = CATEGORIES.find(c => c.id === catId);
    if (!cat) return null;
    const inCat = PLACES.filter(p => p.cat === catId);
    if (!inCat.length) return null;
    return /*#__PURE__*/React.createElement(CatGroup, {
      key: catId,
      cat: cat,
      places: inCat,
      lang: lang
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Pueblos blancos, castillos, yacimientos y festivales. Cada lugar con sus atractivos principales, recomendaciones y las fiestas con las que merece la pena coincidir.' : 'White villages, castles, archaeological sites and festivals. Each place with its highlights, recommendations and festivals worth timing your visit with.'), /*#__PURE__*/React.createElement(EventsCalendar, {
    lang: lang
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Nuestra selección de playas y calas, desde las más accesibles a las más vírgenes que exigen caminar un rato. Servicios, acceso y la mejor hora para ir en cada época del año.' : 'Our pick of beaches and coves, from the easily accessible to the wild ones that require a walk. Services, access and the best hour to visit in each season.'), /*#__PURE__*/React.createElement(Top5BeachesBand, {
    places: PLACES,
    lang: lang
  ...
  }), /*#__PURE__*/React.createElement(DayPlans, {
    lang: lang
  }), /*#__PURE__*/React.createElement("div", {
    className: "ag-rainy"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3"
  }, lang === 'es' ? 'Plan B si llueve' : 'Plan B if it rains'), /*#__PURE__*/React.createElement("p", {
    className: "ag-para"
    ...
    className: "ag-para"
  }, lang === 'es' ? 'El calendario semanal de mercadillos de la zona y dónde llevarte un buen recuerdo: cerámica de Níjar, jarapas, aceite local.' : 'Weekly street markets in the area and where to pick up a good souvenir: Níjar ceramics, traditional rugs, local olive oil.'), SECTION_CATS.mercados.map(catId => {
    const cat = CATEGORIES.find(c => c.id === catId);
    if (!cat) return null;
    const inCat = PLACES.filter(p => p.cat === catId);
    if (!inCat.length) return null;
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Nada de esto sustituye a un médico: es para reaccionar bien en los primeros minutos ante los percances más típicos de playa y verano. Si tienes dudas de verdad, mejor llamar al 112 y que lo valore alguien.' : 'None of this replaces a doctor: it is here to help you react well in the first few minutes with the most typical beach and summer mishaps. If you have real doubts, better to call 112 and let someone assess it.'), /*#__PURE__*/React.createElement("div", {
    className: "ag-emerg-grid"
  }, EMERGENCY_CARDS.map(card => {
    const t = card[lang];
    return /*#__PURE__*/React.createElement("div", {
      className: "ag-emerg-card",
      key: card.id
    }, /*#__PURE__*/React.createElement("span", {
      className: "ag-emerg-icon",
      "aria-hidden": "true"
    }, /*#__PURE__*/React.createElement(HiIcon, {
      name: card.icon,
      size: 20
    })), /*#__PURE__*/React.createElement("h4", {
      className: "ag-emerg-title"
    }, t.title), /*#__PURE__*/React.createElement("ul", {
      className: "ag-emerg-steps"
    }, t.steps.map((step, i) => /*#__PURE__*/React.createElement("li", {
      key: i
    }, step))), /*#__PURE__*/React.createElement("p", {
      className: "ag-emerg-escalate"
    }, /*#__PURE__*/React.createElement(HiIcon, {
      name: "alert",
      size: 13,
      style: {
    ...
    className: "ag-para"
  }, lang === 'es' ? 'Estaciones de servicio y puntos de carga para coche eléctrico en Vera Playa y alrededores. Cada lugar incluye distancia desde tu Hestía, horario habitual y enlace directo a Google Maps para llegar.' : 'Petrol stations and EV charging points in Vera Playa and surroundings. Each spot includes distance from your Hestía, typical opening hours and a direct Google Maps link.'), /*#__PURE__*/React.createElement("p", {
    className: "ag-para"
  }, lang === 'es' ? 'Los horarios son orientativos (verificados en mayo 2026 mediante Repsol, Cepsa, Plenoil y Electromaps). El enlace de Google Maps siempre lleva al lugar correcto aunque cambie la información.' : 'Hours are approximate (verified in May 2026 via Repsol, Cepsa, Plenoil and Electromaps). The Google Maps link always reaches the correct location even if details change.'), SECTION_CATS.movilidad.map(catId => {
    const cat = CATEGORIES.find(c => c.id === catId);
    if (!cat) return null;
    const inCat = PLACES.filter(p => p.cat === catId);
    if (!inCat.length) return null;
    ...
    scope: "row"
  }, item.label), /*#__PURE__*/React.createElement("td", null, item.value)))))), /*#__PURE__*/React.createElement("section", {
    id: "ag-descuentos",
    className: "ag-section"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ag-section-num"
    ...
    className: "ag-h3"
  }, s.feedback.checkoutTitle), /*#__PURE__*/React.createElement("p", {
    className: "ag-para"
  }, s.feedback.checkoutBody), s.feedback.garbageBody && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3"
  }, s.feedback.garbageTitle), /*#__PURE__*/React.createElement("div", {
    className: "ag-checkin-garbage"
  }, /*#__PURE__*/React.createElement("p", {
    className: "ag-para"
  }, s.feedback.garbageBody))), /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3"
  }, s.feedback.careTitle), /*#__PURE__*/React.createElement("p", {
    className: "ag-para"
  }, s.feedback.careBody), /*#__PURE__*/React.createElement("h3", {
    className: "ag-h3"
...
const AptGuideGate = ({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("section", {
    ...
    className: "ag-modal-desc"
  }, t.desc), /*#__PURE__*/React.createElement("form", {
    onSubmit: submit,
    noValidate: true
  }, /*#__PURE__*/React.createElement("label", {
    htmlFor: "ag-pin",
    className: "ag-modal-label"
    ...
    className: "ag-modal-msg",
    role: "status"
  }, status === 'error' ? t.error : status === 'success' ? t.success : t.helper), /*#__PURE__*/React.createElement("div", {
    className: "ag-modal-actions"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "ag-modal-cancel",
    onClick: () => setOpen(false)
  }, t.cancel), /*#__PURE__*/React.createElement("button", {
    type: "submit",
    className: "ag-modal-submit"
  }, t.submit))))));
};
