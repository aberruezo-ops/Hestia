...
const RatingsMarquee = ({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "rm-item"
  }, it.startsWith('★ ') ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(HiIcon, {
    name: "star-fill",
    size: 13,
    className: "rm-star"
  }), " ", it.slice(2)) : it), /*#__PURE__*/React.createElement("span", {
    className: "rm-dot",
    "aria-hidden": "true"
  }, "✦")))));
};
