...
const LS_COPY = {
  es: {
    ...
    includes: ['WiFi fibra · velocidad simétrica', 'Cocina completamente equipada', 'Ropa de cama y toallas incluidas', 'Terraza privada o con vistas', 'Aire acondicionado y calefacción', 'Parking', 'Sin gastos de agencia · trato directo', 'Contrato de arrendamiento formal', 'Depósito del 20% para confirmar', 'Siempre disponibles para vosotros'],
  ...
  en: {
    ...
    includes: ['Fibre WiFi · symmetric speed', 'Fully equipped kitchen', 'Bed linen and towels included', 'Private terrace or sea views', 'Air conditioning and heating', 'Parking', 'No agency fees · direct deal', 'Formal rental contract', '20% deposit to confirm', 'Always available for you'],
